...
/// <summary>
/// The exception that is thrown when a DotEnv source document contains a structural error that prevents it from
/// being parsed.
/// </summary>
public sealed class DotEnvFormatException : FormatException
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DotEnvFormatException" /> class with the specified message
