...
/// <summary>
/// Identifies the version of the TOML specification a <see cref="TomlReader" /> enforces. The version controls a small
/// number of grammar features that TOML v1.1.0 added relative to TOML v1.0.0.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// The version affects only parsing. The <see cref="TomlWriter" /> always emits output that is valid under both
/// versions, so it does not take a version.
/// </para>
/// </remarks>
