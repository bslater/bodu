// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IniKnownAnswerVector.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Represents a positive Known Answer Test (KAT) vector for the INI file format. A vector pairs a raw INI source string
/// with the expected parsed state — global entries and named sections — so that data-driven tests can verify
/// <see cref="Ini" /> against authoritative references and common-practice inputs.
/// </summary>
...
/// The expected key/value entries in the global section, in source order. Pass an empty array when no global entries
/// are expected.
/// </param>
/// <param name="Sections">
/// The expected named sections in source order. Each element carries the section name and its key/value entries. Pass
/// an empty array when no named sections are expected.
/// </param>
/// <param name="Options">
/// The parse options to apply. <see langword="null" /> indicates that <see cref="IniParseOptions.Default" /> should be
/// used.
/// </param>
/// <param name="Source">
