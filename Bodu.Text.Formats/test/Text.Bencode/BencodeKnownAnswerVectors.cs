// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BencodeKnownAnswerVectors.cs" company="Bodu Pty. Ltd.">
...
public static class BencodeKnownAnswerVectors
{
    ...
    public static IEnumerable<object[]> Bep3PositiveVectors()
    {
        ...
        BencodedList listSpamAndInt = new(
        [
        ...
        BencodedDictionary cowMooSpamEggs = new(
        [
    ...
    public static IEnumerable<object[]> EdgeCasePositiveVectors()
    {
        ...
        BencodedString singleZero = new([0x00]);
