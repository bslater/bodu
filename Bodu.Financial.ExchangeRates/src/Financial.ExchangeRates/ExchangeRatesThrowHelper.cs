// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ExchangeRatesThrowHelper.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Provides <c>ThrowIf</c> guard helpers shared by the web exchange-rate provider machinery in
/// <c>Bodu.Financial.ExchangeRates</c>.
/// </summary>
/// <remarks>
/// <para>
...
/// <c>ExchangeRatesThrowHelper.CallerExpression.cs</c> holds the implementation.
/// </para>
/// </remarks>
[SuppressMessage(
