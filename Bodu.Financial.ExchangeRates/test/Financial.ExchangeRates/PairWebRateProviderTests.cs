// ---------------------------------------------------------------------------------------------------------------
// <copyright file="PairWebRateProviderTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the shared per-pair machinery provided by <see cref="PairWebRateProvider{TSeries}" />: coverage
...
public partial class PairWebRateProviderTests
{
    ...
    {
        StubPairSource source = new(new RateObservation(Known, 0.6828m));
        TestPairWebRateProvider provider = new(source, new TestWebRateProviderOptions());
    ...
    /// <summary>
    /// Verifies that a loaded pair is surfaced through <see cref="PairWebRateProvider{TSeries}.GetAvailablePairs" />.
    /// </summary>
    [TestMethod]
    ...
    public void HistoryAvailability_ShouldForwardOptionsValue()
    {
        ...
        {
            HistoryAvailability = RateHistoryAvailability.RollingDays(90),
        };
        TestPairWebRateProvider provider = new(source, options);
