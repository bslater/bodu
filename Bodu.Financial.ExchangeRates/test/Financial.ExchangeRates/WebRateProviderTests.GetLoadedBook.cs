// ---------------------------------------------------------------------------------------------------------------
// <copyright file="WebRateProviderTests.GetLoadedBook.cs" company="Bodu Pty. Ltd.">
...
public partial class WebRateProviderTests
{
    ...
    public void GetLoadedBook_WhenCold_ShouldReturnEmptyBook()
    {
        ...
        RateBook book = provider.GetLoadedBook();
    ...
    public async Task GetLoadedBook_AfterLoad_ShouldContainLoadedSeries()
    {
        ...
        RateSeries series = book.EnumerateSeries().Single();
    ...
    public async Task GetLoadedBook_WhenLoadedAfterAccess_ShouldNotMutateReturnedBook()
    {
        ...
        RateBook before = provider.GetLoadedBook();
        await provider.LoadPairAsync("AUD", "USD", RangeStart, RangeEnd);
        RateBook after = provider.GetLoadedBook();
