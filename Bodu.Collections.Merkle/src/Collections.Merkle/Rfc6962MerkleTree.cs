...
/// </para>
/// <para>
/// <strong>Relationship to the other Merkle types.</strong> <c>MerkleTreeHash</c> and
/// <c>ParallelMerkleTreeHash</c> share this type's domain separation but reduce level by level with a
