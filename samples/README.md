...
| Security.Cryptography | [`samples/Security.Cryptography/`](Security.Cryptography/README.md) — hashes/MAC/XOF/KDF/OTP, block/stream ciphers and AEAD, asymmetric key agreement/signatures/KEM, the RFC 6962 Merkle-tree family (proofs, length binding, write-time accumulation, diagnostics), RFC 9180 HPKE, the cipher-mode and padding layer, and a custom hash with contract tests |
