...
/// <summary>
/// Entry point for the config-files sample: the INI and DotEnv document formats from
/// <c>Bodu.Text.Formats</c> — reading typed values, mutating and re-emitting an INI document
