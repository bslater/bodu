...
| `Bodu.Financial.Samples.CachedRates` | Read-through caching (`CachingRateProvider`), coverage-based range serving, tiered cache stacking (memory over file), history-availability clamping | `Bodu.Financial`, `Bodu.Financial.ExchangeRates.Caching` |
