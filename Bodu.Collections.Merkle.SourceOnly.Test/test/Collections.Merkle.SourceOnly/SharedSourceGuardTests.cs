...
// Bodu.Security.Cryptography rather than Bodu.Collections.Merkle. That is the point of the guard, not an accident:
// it proves the namespace switch works and keeps these copies from colliding with the real package's types.
using Bodu.Security.Cryptography;

namespace Bodu.Collections.Merkle.SourceOnly;

/// <summary>
/// Holds the source-compiled <c>MerkleTreeCore</c> to the published RFC 6962 vectors, proving that the shared
/// source is usable by an assembly that takes no dependency on <c>Bodu.Collections.Merkle</c>.
/// </summary>
/// <remarks>
/// <para>
