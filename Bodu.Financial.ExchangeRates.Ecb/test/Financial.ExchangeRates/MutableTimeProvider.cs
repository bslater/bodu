...
/// <summary>
/// A <see cref="TimeProvider" /> whose current instant is set explicitly, so tests can control the instant feed
/// selection and the undated lookup surface resolve against deterministically.
/// </summary>
