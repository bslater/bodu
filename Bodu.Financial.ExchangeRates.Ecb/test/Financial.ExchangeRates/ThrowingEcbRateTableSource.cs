// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ThrowingEcbRateTableSource.cs" company="Bodu Pty. Ltd.">
...
/// </summary>
internal sealed class ThrowingEcbRateTableSource
    : IEcbRateTableSource
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ThrowingEcbRateTableSource" /> class.
    /// </summary>
    /// <param name="exception">The exception to throw from every fetch.</param>
    public ThrowingEcbRateTableSource(Exception exception)
    {
