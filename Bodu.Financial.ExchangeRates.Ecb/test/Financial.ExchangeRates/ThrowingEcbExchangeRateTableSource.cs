// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ThrowingEcbExchangeRateTableSource.cs" company="Bodu Pty. Ltd.">
...
/// </summary>
internal sealed class ThrowingEcbExchangeRateTableSource
    : IEcbExchangeRateTableSource
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ThrowingEcbExchangeRateTableSource" /> class.
    /// </summary>
    /// <param name="exception">The exception to throw from every fetch.</param>
    public ThrowingEcbExchangeRateTableSource(Exception exception)
    {
