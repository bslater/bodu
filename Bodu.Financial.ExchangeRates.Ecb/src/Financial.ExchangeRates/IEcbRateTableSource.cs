// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IEcbRateTableSource.cs" company="Bodu Pty. Ltd.">
...
/// provider.
/// </remarks>
internal interface IEcbRateTableSource
{
    /// <summary>
    ...
    /// <returns>A task that yields the parsed <see cref="EcbRateTable" />.</returns>
    ValueTask<EcbRateTable> GetTableAsync(EcbRateFeed feed, CancellationToken cancellationToken = default);
}
