// ---------------------------------------------------------------------------------------------------------------
// <copyright file="YamlSerializerDefaults.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Specifies a base set of defaults applied when a <see cref="YamlSerializerOptions" /> instance is created for a
/// particular usage scenario.
/// </summary>
public enum YamlSerializerDefaults
{
    /// <summary>
