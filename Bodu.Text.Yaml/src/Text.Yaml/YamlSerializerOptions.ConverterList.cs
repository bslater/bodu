// ---------------------------------------------------------------------------------------------------------------
// <copyright file="YamlSerializerOptions.ConverterList.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class YamlSerializerOptions
{
    ...
    /// refuses every mutating operation once the owning <see cref="YamlSerializerOptions" /> have become read-only,
        ...
        : IList<YamlConverter>
    {
        ...
        internal ConverterList(YamlSerializerOptions owner) =>
            _owner = owner;
        ...
        public YamlConverter this[int index]
        {
            get => _items[index];
            set
            {
        ...
        /// </exception>
        /// <exception cref="InvalidOperationException">Thrown when the owning options are read-only.</exception>
        public void Add(YamlConverter item)
        {
            _owner.VerifyMutable();
        ...
        /// </returns>
        public bool Contains(YamlConverter item) =>
        ...
        public void CopyTo(YamlConverter[] array, int arrayIndex) =>
        ...
        public IEnumerator<YamlConverter> GetEnumerator() =>
        ...
        public int IndexOf(YamlConverter item) =>
            _items.IndexOf(item);
        ...
        /// </exception>
        /// <exception cref="InvalidOperationException">Thrown when the owning options are read-only.</exception>
        public void Insert(int index, YamlConverter item)
        {
            _owner.VerifyMutable();
            ThrowHelper.ThrowIfNull(item);
        ...
        /// <exception cref="InvalidOperationException">Thrown when the owning options are read-only.</exception>
        public bool Remove(YamlConverter item)
        {
            _owner.VerifyMutable();
