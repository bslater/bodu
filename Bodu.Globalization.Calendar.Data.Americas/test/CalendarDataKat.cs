...
/// <summary>
/// Represents a known-answer test row that validates a calendar data package through the public calendar service: a
/// (territory, calendar, year, notable-date) query and the expected actual / observed dates the bundled rule provider
/// must surface.
/// </summary>
...
/// The canonical name of the notable date under test, for example <c>"Anzac Day"</c>.
/// </param>
/// <param name="ExpectedDate">The expected actual date.</param>
/// <param name="ExpectedObservedDate">
/// The expected observed date when a weekend-substitute or other adjustment applies; <see langword="null" /> when no
