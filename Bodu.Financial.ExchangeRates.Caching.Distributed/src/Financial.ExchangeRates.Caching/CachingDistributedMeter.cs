// ---------------------------------------------------------------------------------------------------------------
// <copyright file="CachingDistributedMeter.cs" company="Bodu Pty. Ltd.">
...
/// </remarks>
internal static class CachingDistributedMeter
{
    /// <summary>The meter name listeners subscribe to.</summary>
    public const string MeterName = "Bodu.Financial.ExchangeRates.Caching.Distributed";
    ...
    private static readonly Counter<long> s_storageFailures = s_meter.CreateCounter<long>(
        "bodu.financial.rate_cache.distributed.storage_failures",
        unit: "{failure}",
