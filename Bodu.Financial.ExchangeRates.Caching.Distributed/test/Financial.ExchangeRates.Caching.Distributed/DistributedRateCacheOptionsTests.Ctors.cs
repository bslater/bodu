// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DistributedRateCacheOptionsTests.Ctors.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class DistributedRateCacheOptionsTests
{
    ...
    public void Constructor_WhenDistributedCacheIsNull_ShouldThrowArgumentNullException()
    {
        ...
        {
            _ = new DistributedRateCache(null!, new DistributedRateCacheOptions { Provider = "RBA" });
        });
    ...
    public void Constructor_WhenOptionsIsNull_ShouldThrowArgumentNullException()
    {
        ...
        ArgumentNullException ex = Assert.ThrowsExactly<ArgumentNullException>(() =>
        {
            _ = new DistributedRateCache(backingStore, (DistributedRateCacheOptions)null!);
        });
    ...
    public void Constructor_WhenProviderOverload_ShouldBindProvider()
    {
        ...
        var cache = new DistributedRateCache(backingStore, "RBA");
