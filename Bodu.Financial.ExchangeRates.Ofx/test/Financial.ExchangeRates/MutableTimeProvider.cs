...
/// <summary>
/// A <see cref="TimeProvider" /> whose current instant is set explicitly, so tests can control the instant the request
/// end-bound clamp and the undated lookup surface resolve against deterministically.
/// </summary>
