// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OfxExchangeRateOptionsTests.TryValidate.cs" company="Bodu Pty. Ltd.">
...
public partial class OfxExchangeRateOptionsTests
{
    ...
    {
        OfxExchangeRateOptions options = new() { BaseAddress = null! };
    ...
    {
        OfxExchangeRateOptions options = new() { HistoryPath = "PublicSite.ApiService/SpotRateHistory/{from}/{to}" };
    ...
    {
        OfxExchangeRateOptions options = new() { DecimalPlaces = -1 };
    ...
    {
        OfxExchangeRateOptions options = new() { DecimalPlaces = 16 };
    ...
    {
        OfxExchangeRateOptions options = new() { ReportingInterval = "  " };
    ...
    {
        OfxExchangeRateOptions options = new() { HttpTimeout = TimeSpan.Zero };
    ...
    {
        OfxExchangeRateOptions options = new() { DefaultLookback = TimeSpan.Zero };
    ...
    {
        OfxExchangeRateOptions options = new() { CurrencyAliases = null! };
    ...
    {
        OfxExchangeRateOptions options = new() { SynchronousNetworkFetchLogLevel = (LogLevel)999 };
