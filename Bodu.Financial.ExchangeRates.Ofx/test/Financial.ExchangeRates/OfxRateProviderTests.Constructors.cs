// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OfxRateProviderTests.Constructors.cs" company="Bodu Pty. Ltd.">
...
public partial class OfxRateProviderTests
{
    /// <summary>
    ...
    public void Constructor_WhenOptionsIsNull_ShouldThrowArgumentNullException()
    {
        ...
        {
            _ = new OfxRateProvider((OfxRateProviderOptions)null!);
        });
    ...
    {
        OfxRateProviderOptions options = new() { DecimalPlaces = 99 };

        _ = Assert.ThrowsExactly<ArgumentException>(() =>
        {
            _ = new OfxRateProvider(options);
        });
    }
}
