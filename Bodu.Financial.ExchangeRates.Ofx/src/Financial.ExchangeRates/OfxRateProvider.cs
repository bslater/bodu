// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OfxRateProvider.cs" company="Bodu Pty. Ltd.">
...
/// </code>
/// </example>
public sealed class OfxRateProvider
    : PairWebRateProvider<OfxSeriesInfo>
{
    ...
    public OfxRateProvider(OfxRateProviderOptions options, ILogger? logger = null, TimeProvider? timeProvider = null)
    ...
    /// </exception>
    /// <exception cref="ArgumentException">Thrown when <paramref name="options" /> fails validation.</exception>
    internal OfxRateProvider(IPairRateSource<OfxSeriesInfo> source, OfxRateProviderOptions options, ILogger? logger = null, TimeProvider? timeProvider = null)
    ...
    private static HttpClient CreateOwnedClient(OfxRateProviderOptions options)
    {
        ThrowHelper.ThrowIfNull(options);
        options.Validate();
