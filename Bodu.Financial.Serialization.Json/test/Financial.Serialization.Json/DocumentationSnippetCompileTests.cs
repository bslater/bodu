...
public sealed class DocumentationSnippetCompileTests
{
    ...
    [
        "docs/guides/financial/json-serialization.md",
    ];
    ...
    /// <summary>
    /// Verifies that every opted-in Bodu.Financial JSON guide snippet compiles against the current public API, with at least one
    /// snippet marked so the guard is demonstrably wired.
    /// </summary>
    [TestMethod]
    [TestCategory("Regression")]
    public void FinancialJsonGuideSnippets_WhenMarkedForCompile_ShouldCompile()
    {
