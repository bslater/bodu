// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OandaExchangeRateProvider.cs" company="Bodu Pty. Ltd.">
...
/// <see cref="WebExchangeRateProvider.HistoryAvailability" />, so a caller can resolve the earliest date worth
...
/// <see cref="WebExchangeRateProviderOptions.HttpTimeout" /> (the OANDA endpoint rejects requests without a
...
/// </code>
/// </example>
public sealed class OandaExchangeRateProvider
    : PairWebExchangeRateProvider<OandaSeriesInfo>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OandaExchangeRateProvider" /> class backed by an
    ...
    public OandaExchangeRateProvider(OandaExchangeRateOptions options, ILogger? logger = null, TimeProvider? timeProvider = null)
        : this(options, CreateOwnedClient(options), logger, timeProvider)
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="OandaExchangeRateProvider" /> class backed by the OANDA endpoint,
    ...
    /// </exception>
    /// <exception cref="ArgumentException">Thrown when <paramref name="options" /> fails validation.</exception>
    public OandaExchangeRateProvider(HttpClient httpClient, OandaExchangeRateOptions options, ILogger? logger = null, TimeProvider? timeProvider = null)
        : this(CreateSource(httpClient, options), options, ownedHttpClient: null, logger, timeProvider)
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="OandaExchangeRateProvider" /> class backed by an explicit pair
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OandaExchangeRateProvider" /> class from an owned client, building
    ...
    private OandaExchangeRateProvider(OandaExchangeRateOptions options, HttpClient ownedHttpClient, ILogger? logger, TimeProvider? timeProvider)
        : this(new OandaHistorySource(ownedHttpClient, options), options, ownedHttpClient, logger, timeProvider)
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="OandaExchangeRateProvider" /> class, the shared core all public and
    ...
    private static OandaHistorySource CreateSource(HttpClient httpClient, OandaExchangeRateOptions options)
    {
    ...
    private static HttpClient CreateOwnedClient(OandaExchangeRateOptions options)
    {
        ThrowHelper.ThrowIfNull(options);
        options.Validate();
