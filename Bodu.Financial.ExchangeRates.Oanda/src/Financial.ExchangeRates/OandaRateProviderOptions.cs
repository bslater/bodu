...
/// </para>
/// </remarks>
public sealed class OandaRateProviderOptions
    : WebRateProviderOptions
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OandaRateProviderOptions" /> class with the OANDA Historical
    /// Currency Converter host as its base address and a 180-day rolling history window.
    /// </summary>
    public OandaRateProviderOptions()
    {
    ...
    /// <see cref="WebRateProviderOptions.BaseAddress" />.
    /// </value>
