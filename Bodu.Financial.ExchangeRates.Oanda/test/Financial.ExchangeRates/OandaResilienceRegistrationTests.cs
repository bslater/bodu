// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OandaResilienceRegistrationTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the HTTP resilience pipeline attached to the OANDA exchange-rate provider's named client.
/// </summary>
[TestClass]
public partial class OandaResilienceRegistrationTests
{
    ...
    /// </summary>
    private const string ResilienceOptionsName = OandaFinancialServiceBuilderExtensions.HttpClientName + "-standard";
