    ...
    : IExchangeRatePairSource<OandaSeriesInfo>
{
    ...
    /// <inheritdoc />
    public ValueTask<PairRateData<OandaSeriesInfo>> GetPairAsync(ExchangeRatePairRequest request, CancellationToken cancellationToken = default)
    {
        GetPairCallCount++;
        ...
        return ValueTask.FromResult(
            new PairRateData<OandaSeriesInfo>(request.Pair, Array.Empty<ExchangeRateObservation>(), new OandaSeriesInfo(request.Pair, request.Pair.To.ToString(), _options.Price)));
    }
}
