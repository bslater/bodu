// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OandaExchangeRateProviderContractTests.cs" company="Bodu Pty. Ltd.">
...
/// </summary>
[TestClass]
public sealed class OandaExchangeRateProviderContractTests
    : PairWebExchangeRateProviderContractTests<OandaExchangeRateProvider, OandaSeriesInfo>
{
    /// <summary>
    ...
    /// <inheritdoc />
    protected override OandaExchangeRateProvider CreateProvider()
    {
        OandaExchangeRateOptions options = new() { AllowSynchronousNetworkAccess = true };
        FixtureOandaExchangeRateSource source = new(options);

        return new OandaExchangeRateProvider(source, options);
    }
}
