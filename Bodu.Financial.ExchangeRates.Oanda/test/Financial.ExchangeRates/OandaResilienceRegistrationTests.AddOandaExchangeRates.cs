// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OandaResilienceRegistrationTests.AddOandaExchangeRates.cs" company="Bodu Pty. Ltd.">
...
public partial class OandaResilienceRegistrationTests
{
    ...
    public void AddOandaExchangeRates_ShouldRegisterStandardResilienceOptionsForNamedClient()
    {
        ...
        services.AddFinancialService().AddOandaExchangeRates(configure: o => o.HttpTimeout = TimeSpan.FromSeconds(7));
