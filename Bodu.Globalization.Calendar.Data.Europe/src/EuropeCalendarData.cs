...
/// <summary>
/// Provides factory entry points for the Europe region calendar data pack — embedded notable-date rules for Germany, Spain, France,
/// the United Kingdom, Ireland, Italy, the Netherlands, and Sweden — so consumers can compose a <see cref="NotableDateService" />
...
/// </para>
/// <para>
/// Use a country-specific factory (for example <see cref="CreateUnitedKingdomProvider" />) when you only need a single country, or
/// <see cref="CreateProviders" /> when you want every country in the pack at once.
/// </para>
/// </remarks>
/// <example>
/// <code>
