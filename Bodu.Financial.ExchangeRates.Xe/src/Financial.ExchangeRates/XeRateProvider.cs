// ---------------------------------------------------------------------------------------------------------------
// <copyright file="XeRateProvider.cs" company="Bodu Pty. Ltd.">
...
/// </code>
/// </example>
public sealed class XeRateProvider
    : PairWebRateProvider<XeSeriesInfo>
{
    ...
    public XeRateProvider(XeRateProviderOptions options, ILogger? logger = null, TimeProvider? timeProvider = null)
    ...
    /// </exception>
    /// <exception cref="ArgumentException">Thrown when <paramref name="options" /> fails validation.</exception>
    internal XeRateProvider(IPairRateSource<XeSeriesInfo> source, XeRateProviderOptions options, ILogger? logger = null, TimeProvider? timeProvider = null)
    ...
    private static HttpClient CreateOwnedClient(XeRateProviderOptions options)
    {
        ThrowHelper.ThrowIfNull(options);
        options.Validate();
