// ---------------------------------------------------------------------------------------------------------------
// <copyright file="XeSeriesInfo.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Describes one currency series fetched from XE.com: the pair it represents and the quote-currency code reported for
/// it.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="XeSeriesInfo" /> class.
    /// </summary>
