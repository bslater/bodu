// ---------------------------------------------------------------------------------------------------------------
// <copyright file="XeFinancialServiceBuilderExtensions.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Provides the fluent registration of the XE.com exchange-rate provider onto an
/// <see cref="IFinancialServiceBuilder" />.
/// </summary>
public static class XeFinancialServiceBuilderExtensions
{
    /// <summary>The name of the <see cref="HttpClient" /> configured for XE requests.</summary>
    public const string HttpClientName = "Bodu.Financial.ExchangeRates.Xe";

    /// <summary>
    /// Registers the XE.com exchange-rate provider, binding its options and configuring a named
    /// <see cref="HttpClient" /> for charting-rates and token-acquisition requests.
    /// </summary>
    ...
    public static IFinancialServiceBuilder AddXeExchangeRates(
        ...
        => builder.AddWebExchangeRateProvider<XeExchangeRateProvider, XeExchangeRateOptions>(
            ...
            configuration,
            sectionName,
            "XE exchange-rate options are invalid.",
            configure,
            configureResilience,
