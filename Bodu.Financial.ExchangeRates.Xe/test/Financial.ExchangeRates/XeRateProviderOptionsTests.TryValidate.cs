// ---------------------------------------------------------------------------------------------------------------
// <copyright file="XeRateProviderOptionsTests.TryValidate.cs" company="Bodu Pty. Ltd.">
...
public partial class XeRateProviderOptionsTests
{
    ...
    {
        XeRateProviderOptions options = new() { BaseAddress = null! };
    ...
    {
        XeRateProviderOptions options = new() { ChartingRatesPath = "  " };
    ...
    {
        XeRateProviderOptions options = new() { AuthBootstrapUrl = null! };
    ...
    {
        XeRateProviderOptions options = new() { AuthScriptBaseUrl = null! };
    ...
    {
        XeRateProviderOptions options = new() { HttpTimeout = TimeSpan.Zero };
    ...
    {
        XeRateProviderOptions options = new() { DefaultLookback = TimeSpan.Zero };
    ...
    {
        XeRateProviderOptions options = new() { CurrencyAliases = null! };
    ...
    {
        XeRateProviderOptions options = new() { SynchronousNetworkFetchLogLevel = (LogLevel)999 };
