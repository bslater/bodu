...
/// <param name="Sha256">The lowercase hexadecimal SHA-256 of the stream bytes, or <see langword="null" /> for storages.</param>
...
internal static class CompoundReferenceManifest
{
    ...
    /// </summary>
    /// <returns>A sequence of single-element argument arrays, each wrapping a <see cref="CompoundReferenceFixtureKat" />.</returns>
    ...
    /// <summary>The manifest document shape.</summary>
    private sealed class ManifestDto
    {
        /// <summary>Gets or sets the fixture rows.</summary>
        public List<FixtureDto> Fixtures { get; set; } = new();
    }

    /// <summary>A single fixture record in the manifest.</summary>
    private sealed class FixtureDto
    {
        /// <summary>Gets or sets the corpus-relative fixture path.</summary>
        public string RelativePath { get; set; } = string.Empty;

        /// <summary>Gets or sets the regular sector size in bytes.</summary>
        public int SectorSize { get; set; }

        /// <summary>Gets or sets the lowercase root-storage class identifier.</summary>
        public string? RootClsid { get; set; }

        /// <summary>Gets or sets the expected entries.</summary>
        public List<EntryDto> Entries { get; set; } = new();
    }

    /// <summary>A single entry record in the manifest.</summary>
    private sealed class EntryDto
    {
        /// <summary>Gets or sets the storage-qualified entry path.</summary>
        public string Path { get; set; } = string.Empty;

        /// <summary>Gets or sets the entry kind.</summary>
        public string Type { get; set; } = string.Empty;

        /// <summary>Gets or sets the stream size in bytes.</summary>
        public long Size { get; set; }

        /// <summary>Gets or sets the lowercase hexadecimal SHA-256 of the stream bytes.</summary>
