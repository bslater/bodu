...
<xref:Bodu.Text.Serialization.PropertyOrderAttribute> reorders the emitted key/value lines; members without the attribute default to order zero and keep declaration order:
