...
Notable dates observed by each country in the **Americas** data pack, grouped by category. **Territory scope** shows national vs subdivision scoping; **Source** is the direct origin (`inline` or the imported catalogue/hub). See the [comparison matrix](comparison-matrix.md) for a cross-region overview.
...
| Independence Day | Yes | National | inline | Fixed 9 Jul |
...
**Subdivisions:** BR-BA, BR-RJ, BR-SP. A national `BR` query does not return subdivision-only rules.
...
**Subdivisions:** CA-AB, CA-BC, CA-MB, CA-NB, CA-NL, CA-NS, CA-NT, CA-NU, CA-ON, CA-PE, CA-QC, CA-SK, CA-YT. A national `CA` query does not return subdivision-only rules.
...
| St. Patrick's Day (Newfoundland and Labrador) | Yes | NL | inline | Mon nearest 17 Mar |
| St. George's Day (Newfoundland and Labrador) | Yes | NL | inline | Mon nearest 23 Apr |
| National Patriots' Day | Yes | QC | inline | Mon on/before 24 May |
| Victoria Day | Yes | National | inline | Mon on/before 24 May |
| Discovery Day (Newfoundland and Labrador) | Yes | NL | inline | Mon nearest 24 Jun |
...
| Orangemen's Day (Newfoundland and Labrador) | Yes | NL | inline | Mon nearest 12 Jul |
| British Columbia Day | Yes | BC | inline | 1st Mon Aug |
| Civic Holiday | Yes | ON, MB, SK, NU, NT | inline | 1st Mon Aug |
| Discovery Day (Yukon) | Yes | YT | inline | 3rd Mon Aug |
...
| Concept | Non-working | Territory scope | Source | When |
|---|---|---|---|---|
| Memorial Day (Newfoundland and Labrador) | Yes | NL | inline | Fixed 1 Jul |
...
| Concept | Non-working | Territory scope | Source | When |
|---|---|---|---|---|
| Saint Joseph's Day | Yes | National | inline | Fixed 19 Mar |
| Saints Peter and Paul | Yes | National | inline | Fixed 29 Jun |
...
**Subdivisions:** US-AK, US-AL, US-AR, US-CA, US-CO, US-CT, US-DC, US-DE, US-FL, US-GA, US-HI, US-IL, US-IN, US-KY, US-LA, US-MA, US-MD, US-ME, US-MI, US-MO, US-NC, US-NH, US-NM, US-NV, US-NY, US-OK, US-PA, US-RI, US-SC, US-SD, US-TN, US-TX, US-UT, US-VA, US-VT, US-WV. A national `US` query does not return subdivision-only rules.
...
| West Virginia Day | Yes | WV | inline | Fixed 20 Jun |
| Independence Day | Yes | National | inline | Fixed 4 Jul |
| Pioneer Day | Yes | UT | inline | Fixed 24 Jul |
| Statehood Day | Yes | HI | inline | 3rd Fri Aug |
| Victory Day | Yes | RI | inline | 2nd Mon Aug |
| Bennington Battle Day | Yes | VT | inline | Fixed 16 Aug |
| Labor Day | Yes | National | inline | 1st Mon Sep |
| Cabrini Day | Yes | CO | inline | 1st Mon Oct |
| Columbus Day | Yes | National | inline | 2nd Mon Oct |
| Native Americans' Day | Yes | SD | inline | 2nd Mon Oct |
