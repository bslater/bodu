...
| `Bodu.Collections.Specialized` | Specialised structures that are not general-purpose containers — the packed `BitSet`, and the RFC 6962 Merkle tree (`Rfc6962MerkleTree`, `MerkleBlockComputation`, `MerkleBlocks`) with its inclusion and consistency proofs. | [Bit set](bit-set.md) · [RFC 6962 Merkle trees and proofs](rfc6962-merkle-trees.md) |
