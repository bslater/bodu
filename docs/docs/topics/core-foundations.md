...
- **[Bodu.Core introduction](../core/index.md)** — the full namespace map and headline types.
- **[Bodu.Text introduction](../text/index.md)** — the character-encoding surface that ships inside the package.
