...
| Prioritised fallback across multiple FX sources | <xref:Bodu.Financial.CompositeDatedExchangeRateProvider> | Deterministic first-available resolution in construction order. |
