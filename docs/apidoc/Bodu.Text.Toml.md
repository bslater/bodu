...
- <xref:Bodu.Text.Toml.TomlSerializerOptions> — converters, naming policy, ignore conditions, depth, `SpecVersion`, and `ByteArrayHandling`; cached and frozen on first use. The `JsonSerializerOptions` analogue.
