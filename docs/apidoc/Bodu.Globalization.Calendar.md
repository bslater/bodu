...
- <xref:Bodu.Globalization.Calendar.NotableDateCategory> — categorisation: `Holiday`, `Observance`, `Remembrance`, `Cultural`, `Religious`, `Seasonal`, `Civic`, `Bank`, `School`, `Regional`, `Other`, `None`.
