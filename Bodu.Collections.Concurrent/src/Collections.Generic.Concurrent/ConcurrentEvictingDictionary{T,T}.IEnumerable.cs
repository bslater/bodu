// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ConcurrentEvictingDictionary{T,T}.IEnumerable.cs" company="Bodu Pty. Ltd.">
    ...
    IEnumerable<KeyValuePair<TKey, TValue>>
{
    ...
    /// </summary>
    /// <returns>An <see cref="Enumerator" /> over the entries present when the enumerator was created.</returns>
    /// <remarks>
    /// <para>
    /// Enumeration operates on a snapshot captured via <see cref="ToArray" /> at the moment this method is called.
    /// Entries added, removed, or evicted afterward are not reflected in the enumerated sequence.
    /// </para>
    /// <para>
