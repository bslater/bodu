// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ConcurrentEvictingDictionary{T,T}.ICollection.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Gets a value indicating whether access to the <see cref="ConcurrentEvictingDictionary{TKey, TValue}" /> is
    /// synchronized (thread safe).
    /// </summary>
    /// <value>
    /// Always <see langword="false" />. <see cref="ConcurrentEvictingDictionary{TKey, TValue}" /> manages its own
    /// internal synchronization and does not expose a public lock object.
    /// </value>
    /// <remarks>
    ...
    /// <summary>
    /// Copies the live entries of the <see cref="ConcurrentEvictingDictionary{TKey, TValue}" /> to a one-dimensional,
    /// zero-based <see cref="Array" />, starting at the specified index.
    /// </summary>
    /// <param name="array">
    ...
    /// <remarks>
    /// This method takes an atomic snapshot of the dictionary before copying. The destination array reflects the state
    /// of the dictionary at the moment the snapshot was taken and is not affected by concurrent modifications made
    /// afterward.
    /// </remarks>
