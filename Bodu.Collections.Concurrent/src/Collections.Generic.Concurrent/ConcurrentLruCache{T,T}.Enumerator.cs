// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ConcurrentLruCache{T,T}.Enumerator.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Enumerates a point-in-time snapshot of a <see cref="ConcurrentLruCache{TKey, TValue}" />.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The enumerator captures a snapshot of the cache's entries when it is created, by calling
    /// <see cref="ConcurrentLruCache{TKey, TValue}.ToArray" />. All iteration runs over that fixed copy and is
    /// unaffected by concurrent additions, removals, or evictions on the originating cache.
    /// </para>
    /// <para>
    ...
    {
        /// <summary>The point-in-time snapshot of the cache's entries captured when the enumerator was created.</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Enumerator" /> struct by capturing a snapshot of the cache.
        /// </summary>
        /// <param name="owner">The cache to enumerate. Must not be <see langword="null" />.</param>
        /// <exception cref="ArgumentNullException"><paramref name="owner" /> is <see langword="null" />.</exception>
        internal Enumerator(ConcurrentLruCache<TKey, TValue> owner)
        {
