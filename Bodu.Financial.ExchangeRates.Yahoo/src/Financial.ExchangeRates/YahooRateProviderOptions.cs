// ---------------------------------------------------------------------------------------------------------------
// <copyright file="YahooRateProviderOptions.cs" company="Bodu Pty. Ltd.">
...
/// </para>
/// </remarks>
public sealed class YahooRateProviderOptions
    : WebRateProviderOptions
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="YahooRateProviderOptions" /> class with the Yahoo Finance host as
