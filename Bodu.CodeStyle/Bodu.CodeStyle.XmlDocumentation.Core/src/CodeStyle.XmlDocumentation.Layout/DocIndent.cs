// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DocIndent.cs" company="Bodu Pty. Ltd.">
...
internal static class DocIndent
{
    ...
    /// <summary>
    /// Re-applies the documentation prefix to every line of formatted content and joins them with the supplied line
    /// ending.
    /// </summary>
    ...
    /// <returns>
    /// <see langword="true" /> if the line is exactly <c>&lt;![CDATA[</c> or <c>]]&gt;</c>; otherwise
    /// <see langword="false" />.
    /// </returns>
    ...
    /// <summary>
    /// Determines whether a content line begins with the CDATA opener, as happens when a multi-line CDATA body has been
    /// reflowed onto a single line.
    /// </summary>
    /// <param name="content">The content line to test.</param>
    /// <returns>
    /// <see langword="true" /> if the line starts with <c>&lt;![CDATA[</c>; otherwise <see langword="false" />.
    /// </returns>
    ...
    /// <summary>
    /// Removes the base indent and documentation prefix (including a single optional trailing space) from a single
    /// physical line.
    /// </summary>
    /// <param name="line">The physical line to strip.</param>
    /// <param name="expectedIndent">
    /// The expected leading indent; any leading whitespace is tolerated when it does not match.
    /// </param>
