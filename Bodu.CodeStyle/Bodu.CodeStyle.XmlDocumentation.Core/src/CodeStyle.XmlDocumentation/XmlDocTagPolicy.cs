...
/// <summary>
/// Describes per-tag layout policy overrides used by <see cref="XmlDocFormatter" /> to decide whether a tag is emitted
/// block-style, single-line, or inline.
/// </summary>
public sealed class XmlDocTagPolicy
{
    ...
    /// <param name="maxSingleLineLength">
    /// An optional override for the maximum length to keep the tag single-line.
    /// </param>
    /// <param name="allowLineBreakInside">
    /// An optional override controlling whether line breaks may appear inside the tag content.
    /// </param>
    /// <param name="selfClosingTrailingSpace">
    /// An optional override controlling the space before <c>/&gt;</c> on self-closing forms.
    /// </param>
    ...
    /// </summary>
    /// <value>
    /// <see langword="true" /> when wrapping is permitted; <see langword="false" /> when forbidden;
    /// <see langword="null" /> when not overridden.
    /// </value>
    public bool? AllowLineBreakInside { get; }

    /// <summary>
    /// Gets a value indicating whether a single space should appear before the closing <c>/&gt;</c> of a self-closing
    /// form.
    /// </summary>
    /// <value>
    /// <see langword="true" /> to emit the space; <see langword="false" /> to suppress it; <see langword="null" /> to
    /// preserve as-written.
    /// </value>
