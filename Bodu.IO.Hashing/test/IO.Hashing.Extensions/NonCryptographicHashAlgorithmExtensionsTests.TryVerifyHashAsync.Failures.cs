// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NonCryptographicHashAlgorithmExtensionsTests.TryVerifyHashAsync.Failures.cs" company="Bodu Pty. Ltd.">
...
public partial class NonCryptographicHashAlgorithmExtensionsTests
{
    ...
    public async Task TryVerifyHashAsync_WhenByteArrayDoesNotMatchHex_ShouldReturnFalse()
    {
        ...
        bool result = await algorithm.TryVerifyHashAsync(s_sampleData, "00000000");
    ...
    public async Task TryVerifyHashAsync_WhenByteArrayHexIsMalformed_ShouldReturnFalse()
    {
        ...
        bool result = await algorithm.TryVerifyHashAsync(s_sampleData, "NOT-HEX!!");
    ...
    public async Task TryVerifyHashAsync_WhenCancellationIsRequested_ShouldReturnFalse()
    {
        ...
        bool result = await algorithm.TryVerifyHashAsync(stream, s_sampleHash, cts.Token);
