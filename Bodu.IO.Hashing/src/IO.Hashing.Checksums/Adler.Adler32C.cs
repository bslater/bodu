...
/// <summary>
/// Computes a 32-bit Adler-style checksum using the power-of-two modulus 65536 for SIMD-friendly alignment. This class
/// cannot be inherited.
/// </summary>
/// <remarks>
/// <para>
/// This variant maintains two running sums (A and B) and combines them as <c><![CDATA[(B << 16) | A]]></c>, but uses a
/// modulus of 65536 rather than the standard 65521 to enable cheaper modular reductions in vectorized code paths.
/// Outputs differ from standard <see cref="Adler32" /> and are not interchangeable.
/// </para>
/// <para>
...
/// <example>
/// <code language="csharp"> using Bodu.IO.Hashing.Checksums; using Bodu.IO.Hashing.Extensions; // SIMD-friendly Adler
/// variant for high-throughput internal pipelines. var adler = new Adler32C(); byte[] checksum =
/// adler.ComputeHash(largeBlock); </code>
/// </example>
/// </remarks>
/// <seealso cref="Adler{T}"/> <seealso cref="Adler32"/> <seealso cref="Adler64"/>
    ...
    : Adler32Base
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Adler32C" /> class using the SIMD-friendly modulus (65536).
    /// </summary>
    public Adler32C()
        : base(Adler32CModulo)
    {
