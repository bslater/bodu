// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Fletcher.32.cs" company="Bodu Pty. Ltd.">
...
/// <remarks>
/// <para>
/// <see cref="Fletcher32" /> is a lightweight checksum algorithm that produces a 32-bit output by iteratively
/// processing input bytes using two 16-bit rolling sums. It was introduced by Brian Kernighan and Dennis Ritchie and is
/// commonly used in networking, file validation, and embedded systems where error detection is required but
/// cryptographic strength is not.
/// </para>
/// <para>
...
/// </item>
/// <item>
/// <description>Accumulator width: two 16-bit rolling sums (A and B).</description>
/// </item>
/// <item>
/// <description>Modulus: <c>65535</c>.</description>
/// </item>
/// </list>
/// <para>
...
/// </example>
/// </remarks>
/// <seealso cref="Fletcher{T}"/> <seealso cref="Fletcher16"/> <seealso cref="Fletcher64"/>
public sealed class Fletcher32
    : Fletcher<Fletcher32>
{
    /// <summary>The output width, in bits, of the Fletcher-32 algorithm.</summary>
