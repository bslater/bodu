...
{
    /// <summary>The default initial value used to seed the hash algorithm.</summary>
    ...
    /// <summary>The initial seed value applied to the running hash accumulator and restored on reset.</summary>
    private uint _initialValue;

    /// <summary>Indicates whether the algorithm has begun consuming input, used to guard reconfiguration of the seed and variant.</summary>
    private bool _started;

    /// <summary>Indicates whether the XOR-modified (djb2a) recurrence is used; otherwise the original additive djb2 recurrence.</summary>
