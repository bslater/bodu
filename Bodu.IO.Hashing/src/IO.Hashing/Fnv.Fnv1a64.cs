...
/// <example>
/// <code language="csharp"> using Bodu.IO.Hashing; using Bodu.IO.Hashing.Extensions; var fnv = new Fnv1a64(); byte[]
/// digest = fnv.ComputeHash(System.Text.Encoding.UTF8.GetBytes("user@example.com")); </code>
/// </example>
/// </remarks>
