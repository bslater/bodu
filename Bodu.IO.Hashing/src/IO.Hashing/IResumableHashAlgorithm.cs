// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IResumableHashAlgorithm.cs" company="Bodu Pty. Ltd.">
...
/// <description>
/// Returns a freshly allocated digest representing <c>hash(previousInput || newData)</c>. The two array overloads are
/// conveniences for callers without spans.
/// </description>
/// </item>
/// <item>
/// <term>
/// <see cref="TryComputeHashFrom(System.ReadOnlySpan{byte}, System.ReadOnlySpan{byte}, System.Span{byte}, out int)" />
/// </term>
/// <description>
/// The allocation-free variant that writes into a caller-supplied buffer; returns <see langword="false" /> when the
/// destination is too small, leaving <c>bytesWritten</c> at 0.
/// </description>
/// </item>
/// </list>
/// <para>
...
public interface IResumableHashAlgorithm
{
    ...
    /// <returns>
    /// <see langword="true" /> if the resumed and finalized hash was written successfully; otherwise,
