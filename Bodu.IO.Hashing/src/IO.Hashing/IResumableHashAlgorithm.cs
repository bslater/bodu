...
/// reverse any final XOR, reflection, or width mask before resuming; (c) re-apply finalization before returning the
...
/// in this sense — their finalization collapses internal state irreversibly, which is precisely the property that
...
{
    /// <summary>
    /// Resumes a hash computation from a previously finalized hash value, processes additional input, and writes the new
    /// finalized hash to the specified destination span.
    /// </summary>
