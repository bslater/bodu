// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Utf8BencodeReaderTests.Read.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies that <see cref="Utf8BencodeReader.Read" /> advances through the token stream and classifies each Bencode token.
/// </summary>
