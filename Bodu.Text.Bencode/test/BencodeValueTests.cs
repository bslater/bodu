...
public class BencodeValueTests
{
    ...
    {
        var value = BencodeValue.Create(long.MaxValue);
    ...
    {
        var value = BencodeValue.Create(42);
    ...
    {
        var value = BencodeValue.Create("héllo");
    ...
    {
        byte[] source = [1, 2, 3];
        var value = BencodeValue.Create(source);
    ...
    public void Create_WhenSpan_ShouldCopyContent()
    {
        ...
        var value = BencodeValue.Create(source.AsSpan());
    ...
    {
        var value = BencodeValue.Create(42L);
    ...
    {
        var value = BencodeValue.Create(new byte[] { 1, 2, 3 });
    ...
    public void DeepClone_WhenByteString_ShouldCopyPayload()
    {
        ...
        var original = BencodeValue.Create(new byte[] { 1, 2, 3 });
        owner.Add(original);
