// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BencodeThrowHelper.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Provides <c>ThrowIf</c> stream-capability guards used by the Bencode reader and writer that are not covered by
/// <see cref="Bodu.ThrowHelper" />.
/// </summary>
internal static class BencodeThrowHelper
{
    /// <summary>
    ...
    {
        if (!stream.CanRead)
            throw new ArgumentException(BencodeResourceStrings.Arg_Invalid_StreamNotReadable, paramName);
    }
    ...
    {
        if (!stream.CanWrite)
            throw new ArgumentException(BencodeResourceStrings.Arg_Invalid_StreamNotWritable, paramName);
    }
}
