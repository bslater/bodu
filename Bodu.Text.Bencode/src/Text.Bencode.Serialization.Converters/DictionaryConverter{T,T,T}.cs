    ...
    where TKey : notnull
{
    ...
    /// <summary>
    /// Builds a <see cref="BencodeSerializationException" /> reporting that <paramref name="text" /> is not a valid
    ...
    private static BencodeSerializationException KeyParseException(string text, Exception? inner = null) =>
        new(
