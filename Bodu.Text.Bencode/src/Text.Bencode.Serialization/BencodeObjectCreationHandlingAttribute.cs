// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BencodeObjectCreationHandlingAttribute.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BencodeObjectCreationHandlingAttribute" /> class.
    /// </summary>
    /// <param name="handling">The object-creation handling applied to the annotated type or member.</param>
    /// <exception cref="ArgumentOutOfRangeException">
    /// Thrown when <paramref name="handling" /> is not a defined <see cref="BencodeObjectCreationHandling" /> value.
    /// </exception>
    public BencodeObjectCreationHandlingAttribute(BencodeObjectCreationHandling handling)
    {
