...
/// format's native byte-string representation directly, the way <see cref="System.Text.Json.JsonSerializer" />
/// supports memory-of-byte alongside <see cref="byte" /> arrays.
/// </summary>
