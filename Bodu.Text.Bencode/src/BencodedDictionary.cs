// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BencodedDictionary.cs" company="Bodu Pty. Ltd.">
    ...
    : BencodedValue
{
    ...
    public BencodedDictionary(IEnumerable<KeyValuePair<BencodedString, BencodedValue>> items)
    {
        ...
        {
            if (pair.Key is null)
                throw new ArgumentException(BencodeResourceStrings.Arg_Invalid_NullDictionaryKey, nameof(items));

            if (pair.Value is null)
                throw new ArgumentException(BencodeResourceStrings.Arg_Invalid_NullDictionaryValue, nameof(items));

            if (!this._items.TryAdd(pair.Key, pair.Value))
                throw new ArgumentException(BencodeResourceStrings.Arg_Invalid_DuplicateDictionaryKey, nameof(items));
        }
    }
