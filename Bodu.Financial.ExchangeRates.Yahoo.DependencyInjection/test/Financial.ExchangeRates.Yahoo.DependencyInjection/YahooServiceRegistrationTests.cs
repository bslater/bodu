// ---------------------------------------------------------------------------------------------------------------
// <copyright file="YahooServiceRegistrationTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the dependency-injection registration of the Yahoo Finance exchange-rate provider.
/// </summary>
[TestClass]
public class YahooServiceRegistrationTests
{
    /// <summary>
    ...
    public void AddYahooExchangeRates_ShouldRegisterProviderAsSingleton()
    {
        ...
        var concrete = provider.GetService<YahooExchangeRateProvider>();
