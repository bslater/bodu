...
public static class YahooServiceCollectionExtensions
{
    ...
    /// An optional configuration root. When supplied, <see cref="Bodu.Financial.DependencyInjection.FinancialOptions" />
    /// is bound from the <c>Financial</c> section and <see cref="YahooExchangeRateOptions" /> from
