// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RbaResilienceRegistrationTests.AddRbaExchangeRates.cs" company="Bodu Pty. Ltd.">
...
public partial class RbaResilienceRegistrationTests
{
    ...
    /// </summary>
    [TestMethod]
    public void AddRbaExchangeRates_ShouldRegisterStandardResilienceOptionsForNamedClient()
    {
        ServiceCollection services = new();
        services.AddFinancialService().AddRbaExchangeRates(configure: o => o.HttpTimeout = TimeSpan.FromSeconds(7));
