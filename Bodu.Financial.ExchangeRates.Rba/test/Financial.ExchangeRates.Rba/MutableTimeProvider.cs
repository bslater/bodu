...
/// <summary>
/// A <see cref="TimeProvider" /> whose current instant is set explicitly, so tests can control the instant the undated
/// lookup surface resolves against deterministically.
/// </summary>
