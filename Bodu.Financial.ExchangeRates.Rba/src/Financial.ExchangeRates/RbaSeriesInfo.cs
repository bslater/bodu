...
/// </summary>
/// <remarks>
/// Exposed through <see cref="RbaRateProvider.GetAvailablePairs" /> so callers can discover which currency pairs the
/// loaded RBA data supports without hard-coding the list.
/// </remarks>
