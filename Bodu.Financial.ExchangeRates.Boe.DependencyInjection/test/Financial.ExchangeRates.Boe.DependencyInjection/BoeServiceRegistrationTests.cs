// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BoeServiceRegistrationTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the dependency-injection registration of the Bank of England exchange-rate provider.
/// </summary>
[TestClass]
public class BoeServiceRegistrationTests
{
    /// <summary>
    ...
    public void AddBoeReferenceRates_ShouldRegisterProviderAsSingleton()
    {
        ...
        var concrete = provider.GetService<BoeExchangeRateProvider>();
