// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ArrayDequeTests.TryRemoveLast.cs" company="PlaceholderCompany">
...
public partial class ArrayDequeTests
{
    ...
    /// <summary>
    /// Verifies that <see cref="ArrayDeque{T}.TryRemoveLast(out T)"/> returns <see langword="false"/> and the default value when the deque is empty.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="ArrayDeque{T}.TryRemoveLast(out T)"/> does not modify state when it returns <see langword="false"/>.
    /// </summary>
    [TestMethod]
