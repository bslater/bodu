// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OrderedSetTests.Internal.cs" company="Bodu Pty. Ltd.">
...
public partial class OrderedSetTests
{
    ...
    /// <summary>
    /// Verifies that <see cref="OrderedSet{T}.IsProperSubsetOf(System.Collections.Generic.IEnumerable{T})" />
    /// returns <see langword="false" /> when the projection is larger but does not contain every element of
    /// the current set. Exercises the inner-loop early-return branch.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="OrderedSet{T}.IsProperSupersetOf(System.Collections.Generic.IEnumerable{T})" />
    /// returns <see langword="false" /> when the projection is smaller but contains an element absent from the
    /// current set. Exercises the inner-loop early-return branch.
    /// </summary>
    [TestMethod]
        ...
        : IReadOnlyCollection<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderedSetTests.ReadOnlyCollectionOnly{T}" /> class
