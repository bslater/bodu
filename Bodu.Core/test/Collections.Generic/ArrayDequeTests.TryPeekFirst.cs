// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ArrayDequeTests.TryPeekFirst.cs" company="PlaceholderCompany">
...
public partial class ArrayDequeTests
{
    ...
    /// <summary>
    /// Verifies that <see cref="ArrayDeque{T}.TryPeekFirst(out T)"/> returns <see langword="false"/> and the default value when empty.
    /// </summary>
    [TestMethod]
