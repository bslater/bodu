// ---------------------------------------------------------------------------------------------------------------
// <copyright file="LinkedDictionaryTests.First.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Verifies that <see cref="LinkedDictionary{TKey, TValue}.First" /> returns the head entry in iteration order.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="LinkedDictionary{TKey, TValue}.First" /> throws when the dictionary is empty.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="LinkedDictionary{TKey, TValue}.First" /> does not change the iteration order in access-order mode.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="LinkedDictionary{TKey, TValue}.TryGetFirst" /> reports the head entry without removing it.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="LinkedDictionary{TKey, TValue}.TryGetFirst" /> returns <see langword="false" /> when the dictionary is empty.
    /// </summary>
    [TestMethod]
