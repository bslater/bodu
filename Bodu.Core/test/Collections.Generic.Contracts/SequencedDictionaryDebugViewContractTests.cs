// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SequencedDictionaryDebugViewContractTests.cs" company="Bodu Pty. Ltd.">
...
/// <see cref="SequencedDictionary{TKey, TValue}" />. Asserts the standard Bodu debugger-display contract —
/// DebuggerDisplay, DebuggerTypeProxy, and an instance-constructible proxy — is present and wired up correctly.
/// </summary>
[TestClass]
public sealed class SequencedDictionaryDebugViewContractTests
    : DebugViewContractTests<SequencedDictionary<int, string>>
{
    /// <inheritdoc />
