// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ArrayExtensionsTests.ToReversed.cs" company="Bodu Pty. Ltd.">
...
public partial class ArrayExtensionsTests
{
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenCalled_ForNonGenericArray_ShouldNotModifySource()
    {
        int[] original = Ints;
        _ = ((Array)original).ToReversed();
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenCalled_ForNonGenericArray_ShouldReturnNewAllocation()
    {
        Array source = Ints;
        AssertIsNewAllocation(source, source.ToReversed());
    }
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenCalled_ForNonGenericArrayRange_ShouldNotModifySource()
    {
        int[] original = Ints;
        _ = ((Array)original).ToReversed(1..4);
        AssertIntsSourceIsUnmodified(original);
    }
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenCalled_ForTypedArray_ShouldNotModifySource()
    {
        int[] original = Ints;
        _ = original.ToReversed();
        AssertIntsSourceIsUnmodified(original);
    }
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenCalled_ForTypedArray_ShouldReturnNewAllocation()
    {
        int[] original = Ints;
        AssertIsNewAllocation(original, original.ToReversed());
    }
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenCalled_ForTypedArrayIndexCount_ShouldNotModifySource()
    {
        int[] original = Ints;
        _ = original.ToReversed(1, 3);
        AssertIntsSourceIsUnmodified(original);
    }
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenCalled_ForTypedArrayOfReferenceType_ShouldReturnElementsReversed() => CollectionAssert.AreEqual(new[] { "e", "d", "c", "b", "a" }, Strings.ToReversed());
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenCalled_ForTypedArrayOfStructWithReferenceField_ShouldReturnElementsReversed()
    {
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenCalled_ForTypedArrayRange_ShouldNotModifySource()
    {
        int[] original = Ints;
        _ = original.ToReversed(1..4);
        AssertIntsSourceIsUnmodified(original);
    }
    ...
    public void ToReversed_WhenCountIsInvalid_ForNonGenericArrayIndexCount_ShouldThrowExactly(
        int index, int count, string expectedParamName)
    {
        ArgumentOutOfRangeException ex = Assert.ThrowsExactly<ArgumentOutOfRangeException>(() =>
        {
            ((Array)Ints).ToReversed(index, count);
        });
    ...
    [DataRow(0, -1, "count", DisplayName = "Negative count")]
    [DataRow(0, 10, "count", DisplayName = "Count exceeds array length")]
    public void ToReversed_WhenCountIsInvalid_ForTypedArrayIndexCount_ShouldThrowExactly(
        int index, int count, string expectedParamName)
    {
        ArgumentOutOfRangeException ex = Assert.ThrowsExactly<ArgumentOutOfRangeException>(() =>
        {
            Ints.ToReversed(index, count);
        });
        Assert.AreEqual(expectedParamName, ex.ParamName);
    }
    ...
    public void ToReversed_WhenCountIsZeroOrOne_ForNonGenericArrayIndexCount_ShouldReturnStraightCopy(
        int index, int count)
    {
        Array result = ((Array)Ints).ToReversed(index, count);
    ...
    [TestMethod]
    [DynamicData(nameof(DegenerateCountData), typeof(ArrayExtensionsTests))]
    public void ToReversed_WhenCountIsZeroOrOne_ForTypedArrayIndexCount_ShouldReturnStraightCopy(
        int index, int count) => CollectionAssert.AreEqual(Ints, Ints.ToReversed(index, count));
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenIndexAndCountIsInvalid_ForTypedArrayIndexCount_ShouldThrowExactly()
    {
        Assert.ThrowsExactly<ArgumentException>(() =>
        {
            Ints.ToReversed(Ints.Length - 2, 3);
        });
    }
    ...
    public void ToReversed_WhenIndexIsInvalid_ForNonGenericArrayIndexCount_ShouldThrowExactly(
        int index, int count, string expectedParamName)
    {
        ArgumentOutOfRangeException ex = Assert.ThrowsExactly<ArgumentOutOfRangeException>(() =>
        {
    ...
    [DataRow(-1, 2, "index", DisplayName = "Negative index")]
    [DataRow(6, 0, "index", DisplayName = "Index exceeds array length")]
    public void ToReversed_WhenIndexIsInvalid_ForTypedArrayIndexCount_ShouldThrowExactly(
        int index, int count, string expectedParamName)
    {
        ArgumentOutOfRangeException ex = Assert.ThrowsExactly<ArgumentOutOfRangeException>(() =>
        {
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenIndexPlusCountExceedsArrayLength_ForNonGenericArrayIndexCount_ShouldThrowExactly()
    {
        ...
        {
            ((Array)Ints).ToReversed(index: 3, count: 3);
        });
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenRangeExceedsArrayLength_ForNonGenericArrayRange_ShouldThrowExactly()
    {
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() =>
        {
            ((Array)Ints).ToReversed(2..10);
        });
    }
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenRangeExceedsArrayLength_ForTypedArrayRange_ShouldThrowExactly()
    {
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() =>
        {
            Ints.ToReversed(2..10);
        });
    }
    ...
    public void ToReversed_WhenRangeExpressionIsSpecified_ForNonGenericArrayRange_ShouldProduceCorrectResult(
        int start, int end, bool startFromEnd, bool endFromEnd, int[] expected)
    {
        var range = new Range(
            new Index(start, startFromEnd),
            new Index(end, endFromEnd));
        Array result = ((Array)Ints).ToReversed(range);
    ...
    public void ToReversed_WhenRangeExpressionIsSpecified_ForTypedArrayRange_ShouldProduceCorrectResult(
        int start, int end, bool startFromEnd, bool endFromEnd, int[] expected)
    {
        var range = new Range(
            new Index(start, startFromEnd),
            new Index(end, endFromEnd));
        CollectionAssert.AreEqual(expected, Ints.ToReversed(range));
    }
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenRangeIsMiddleSection_ForNonGenericArrayIndexCount_ShouldLeaveOuterElementsUnchanged()
    {
        Array result = ((Array)Ints).ToReversed(index: 1, count: 3);
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenRangeIsMiddleSection_ForTypedArrayIndexCount_ShouldLeaveOuterElementsUnchanged()
    {
        int[] result = Ints.ToReversed(index: 1, count: 3);
    ...
    public void ToReversed_WhenRangeIsValid_ForNonGenericArrayIndexCount_ShouldReverseOnlyNominatedElements(
    ...
    [TestMethod]
    [DynamicData(nameof(PartialReverseIntData), typeof(ArrayExtensionsTests))]
    public void ToReversed_WhenRangeIsValid_ForTypedArrayIndexCount_ShouldReverseOnlyNominatedElements(
    ...
    public void ToReversed_WhenSourceHasDifferentElementTypes_ForNonGenericArray_ShouldReturnAllElementsReversedAndPreserveElementType(
        Array input, Array expected)
    {
        Array result = input.ToReversed();
    ...
    public void ToReversed_WhenSourceHasDifferentLengths_ForTypedArray_ShouldReturnAllElementsReversed(
        int[] input, int[] expected) => CollectionAssert.AreEqual(expected, input.ToReversed());
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenSourceIsMultidimensional_ForNonGenericArray_ShouldThrowExactly()
    {
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenSourceIsMultidimensional_ForNonGenericArrayIndexCount_ShouldThrowExactly()
    {
        Array source = new int[2, 3];
        ArgumentException ex = Assert.ThrowsExactly<ArgumentException>(() =>
        {
            source.ToReversed(0, 1);
        });
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenSourceIsMultidimensional_ForNonGenericArrayRange_ShouldThrowExactly()
    {
        Array source = new int[2, 3];
        ArgumentException ex = Assert.ThrowsExactly<ArgumentException>(() =>
        {
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenSourceIsNull_ForNonGenericArray_ShouldThrowExactly()
    {
        Array? source = null;
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenSourceIsNull_ForNonGenericArrayIndexCount_ShouldThrowExactly()
    {
        Array? source = null;
        ArgumentNullException ex = Assert.ThrowsExactly<ArgumentNullException>(() =>
        {
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenSourceIsNull_ForNonGenericArrayRange_ShouldThrowExactly()
    {
        Array? source = null;
        ArgumentNullException ex = Assert.ThrowsExactly<ArgumentNullException>(() =>
        {
            source!.ToReversed(1..3);
        });
        Assert.AreEqual("source", ex.ParamName);
    }
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenSourceIsNull_ForTypedArray_ShouldThrowExactly()
    {
        int[]? source = null;
        ArgumentNullException ex = Assert.ThrowsExactly<ArgumentNullException>(
            () => source!.ToReversed());
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenSourceIsNull_ForTypedArrayIndexCount_ShouldThrowExactly()
    {
        int[]? source = null;
        ArgumentNullException ex = Assert.ThrowsExactly<ArgumentNullException>(() =>
        {
    ...
    /// </summary>
    [TestMethod]
    public void ToReversed_WhenSourceIsNull_ForTypedArrayRange_ShouldThrowExactly()
    {
        int[]? source = null;
        ArgumentNullException ex = Assert.ThrowsExactly<ArgumentNullException>(() =>
        {
