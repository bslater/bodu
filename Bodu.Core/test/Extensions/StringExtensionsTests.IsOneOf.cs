...
public partial class StringExtensionsTests
{
    ...
    /// </summary>
    [TestMethod]
    public void IsOneOf_WhenValueMatchesACandidate_ShouldReturnTrue() => Assert.IsTrue("beta".IsOneOf("alpha", "beta", "gamma"));
    ...
    /// </summary>
    [TestMethod]
    public void IsOneOf_WhenValueDoesNotMatchAnyCandidate_ShouldReturnFalse() => Assert.IsFalse("delta".IsOneOf("alpha", "beta", "gamma"));
    ...
    /// </summary>
    [TestMethod]
    public void IsOneOf_WhenCandidateArrayContainsNull_ShouldNotMatchNull() => Assert.IsFalse("beta".IsOneOf("alpha", null!, "gamma"));
    ...
    /// </summary>
    [TestMethod]
    public void IsOneOf_WhenComparedOrdinally_ShouldBeCaseSensitive() => Assert.IsFalse("BETA".IsOneOf("alpha", "beta", "gamma"));
    ...
    /// </summary>
    [TestMethod]
    public void IsOneOf_WhenCaseInsensitiveComparerSupplied_ShouldIgnoreCase() => Assert.IsTrue("BETA".IsOneOf(StringComparer.OrdinalIgnoreCase, "alpha", "beta", "gamma"));
    ...
    /// </summary>
    [TestMethod]
    public void IsOneOf_WhenCandidateArrayIsEmpty_ShouldReturnFalse() => Assert.IsFalse("alpha".IsOneOf());
