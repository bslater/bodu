// --------------------------------------------------------------------------------------------------------------- //
// <copyright file="FiscalWeekQuarterProviderTests.cs" company="Bodu Pty. Ltd.">
...
/// </item>
/// <item>
/// <term><see cref="s_saturday52" /></term>
/// <description>
...
public partial class FiscalWeekQuarterProviderTests
{
    ...
    public static IEnumerable<object[]> GetQuarterNumberTestData()
    {
        ...
        yield return new object[] { s_sunday52, new DateTime(2023, 2, 15), 1 }; // mid-Q1
        yield return new object[] { s_sunday52, new DateTime(2023, 1, 1), 1 }; // Q1 first day (Sunday)
        yield return new object[] { s_sunday52, new DateTime(2023, 4, 1), 1 }; // Q1 last day (Saturday)
        yield return new object[] { s_sunday52, new DateTime(2023, 5, 15), 2 }; // mid-Q2
        yield return new object[] { s_sunday52, new DateTime(2023, 4, 2), 2 }; // Q2 first day
        yield return new object[] { s_sunday52, new DateTime(2023, 7, 1), 2 }; // Q2 last day (Saturday)
        yield return new object[] { s_sunday52, new DateTime(2023, 8, 20), 3 }; // mid-Q3
        yield return new object[] { s_sunday52, new DateTime(2023, 7, 2), 3 }; // Q3 first day
        yield return new object[] { s_sunday52, new DateTime(2023, 9, 30), 3 }; // Q3 last day (Saturday)
        yield return new object[] { s_sunday52, new DateTime(2023, 11, 15), 4 }; // mid-Q4
        yield return new object[] { s_sunday52, new DateTime(2023, 10, 1), 4 }; // Q4 first day (Sunday)
        yield return new object[] { s_sunday52, new DateTime(2023, 12, 24), 4 }; // first day of final fiscal week (Sun)
        yield return new object[] { s_sunday52, new DateTime(2023, 12, 30), 4 }; // Q4 last day (Saturday)

        // Monday52Leap — Q1 last day is Sunday (always valid); Q4 uses final week start (Mon 23 Dec)
        yield return new object[] { s_monday52Leap, new DateTime(2024, 2, 29), 1 }; // leap day in Q1
        yield return new object[] { s_monday52Leap, new DateTime(2024, 1, 1), 1 }; // Q1 first day (Monday)
        yield return new object[] { s_monday52Leap, new DateTime(2024, 3, 31), 1 }; // Q1 last day (Sunday)
        yield return new object[] { s_monday52Leap, new DateTime(2024, 5, 15), 2 }; // mid-Q2
        yield return new object[] { s_monday52Leap, new DateTime(2024, 4, 1), 2 }; // Q2 first day
        yield return new object[] { s_monday52Leap, new DateTime(2024, 6, 30), 2 }; // Q2 last day (Sunday)
        yield return new object[] { s_monday52Leap, new DateTime(2024, 8, 10), 3 }; // mid-Q3
        yield return new object[] { s_monday52Leap, new DateTime(2024, 7, 1), 3 }; // Q3 first day
        yield return new object[] { s_monday52Leap, new DateTime(2024, 9, 29), 3 }; // Q3 last day (Sunday)
        yield return new object[] { s_monday52Leap, new DateTime(2024, 11, 5), 4 }; // mid-Q4
        yield return new object[] { s_monday52Leap, new DateTime(2024, 9, 30), 4 }; // Q4 first day (Monday)
        yield return new object[] { s_monday52Leap, new DateTime(2024, 12, 23), 4 }; // first day of final fiscal week (Mon)
        yield return new object[] { s_monday52Leap, new DateTime(2024, 12, 29), 4 }; // Q4 last day (Sunday)

        // Sunday53 — FY spans two calendar years; Dec 27, 2020 is the first day of week 53 (Sunday)
        yield return new object[] { s_sunday53, new DateTime(2019, 12, 29), 1 }; // FY first day (prior calendar year)
        yield return new object[] { s_sunday53, new DateTime(2020, 2, 29), 1 }; // leap day in Q1
        yield return new object[] { s_sunday53, new DateTime(2020, 3, 28), 1 }; // Q1 last day (Saturday)
        yield return new object[] { s_sunday53, new DateTime(2020, 3, 29), 2 }; // Q2 first day
        yield return new object[] { s_sunday53, new DateTime(2020, 5, 10), 2 }; // mid-Q2
        yield return new object[] { s_sunday53, new DateTime(2020, 6, 27), 2 }; // Q2 last day (Saturday)
        yield return new object[] { s_sunday53, new DateTime(2020, 6, 28), 3 }; // Q3 first day
        yield return new object[] { s_sunday53, new DateTime(2020, 8, 15), 3 }; // mid-Q3
        yield return new object[] { s_sunday53, new DateTime(2020, 9, 26), 3 }; // Q3 last day (Saturday)
        yield return new object[] { s_sunday53, new DateTime(2020, 9, 27), 4 }; // Q4 first day (Sunday)
        yield return new object[] { s_sunday53, new DateTime(2020, 12, 25), 4 }; // mid-Q4
        yield return new object[] { s_sunday53, new DateTime(2020, 12, 27), 4 }; // first day of fiscal week 53 (Sunday)
        yield return new object[] { s_sunday53, new DateTime(2021, 1, 2), 4 }; // Q4 last day (Saturday) — 53rd week end

        // Saturday52 — Q4 first day is Dec 30 (Saturday); final week start is Mar 23, 2024 (Saturday)
        yield return new object[] { s_saturday52, new DateTime(2023, 5, 15), 1 }; // mid-Q1
        yield return new object[] { s_saturday52, new DateTime(2023, 4, 1), 1 }; // Q1 first day (Saturday)
        yield return new object[] { s_saturday52, new DateTime(2023, 6, 30), 1 }; // Q1 last day (Friday)
        yield return new object[] { s_saturday52, new DateTime(2023, 7, 1), 2 }; // Q2 first day
        yield return new object[] { s_saturday52, new DateTime(2023, 8, 15), 2 }; // mid-Q2
        yield return new object[] { s_saturday52, new DateTime(2023, 9, 29), 2 }; // Q2 last day (Friday)
        yield return new object[] { s_saturday52, new DateTime(2023, 9, 30), 3 }; // Q3 first day
        yield return new object[] { s_saturday52, new DateTime(2023, 11, 15), 3 }; // mid-Q3
        yield return new object[] { s_saturday52, new DateTime(2023, 12, 29), 3 }; // Q3 last day (Friday)
        yield return new object[] { s_saturday52, new DateTime(2023, 12, 30), 4 }; // Q4 first day (Saturday)
        yield return new object[] { s_saturday52, new DateTime(2024, 1, 15), 4 }; // mid-Q4
        yield return new object[] { s_saturday52, new DateTime(2024, 3, 23), 4 }; // first day of final fiscal week (Sat)
