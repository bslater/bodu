// --------------------------------------------------------------------------------------------------------------- //
// <copyright file="FiscalWeekQuarterProviderTests.GetQuarter.cs" company="Bodu Pty. Ltd.">
...
public partial class FiscalWeekQuarterProviderTests
{
    ...
    /// week 53 in <see cref="s_sunday53" /> (364 days from the FY start).
    /// </summary>
    [TestMethod]
    ...
    public void GetQuarter_WhenDateTimeIsBeforeAnchorFiscalYear_ShouldResolveToPriorFiscalYear() =>
        ...
        Assert.AreEqual(4, s_sunday52.GetQuarter(new DateTime(2022, 12, 31)));
    ...
    public void GetQuarter_WhenDateTimeIsBeforeAnchorFiscalYearAcrossCalendarYear_ShouldResolveToPriorFiscalYear() =>
        ...
        Assert.AreEqual(4, s_sunday53.GetQuarter(new DateTime(2019, 12, 28)));
