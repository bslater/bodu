// ---------------------------------------------------------------------------------------------------------------
// <copyright file="StringExtensionsTests.RemoveTrailingNewLine.cs" company="Bodu Pty. Ltd.">
...
public partial class StringExtensionsTests
{
    ...
    [TestMethod]
    [DynamicData(nameof(GetRemoveTrailingNewLineCases))]
    public void RemoveTrailingNewLine_WhenInvoked_ShouldReturnExpected(string value, string expected) => Assert.AreEqual(expected, value.RemoveTrailingNewLine());
    ...
    /// </summary>
    [TestMethod]
    public void RemoveTrailingNewLine_WhenInputIsNull_ShouldThrowExactly()
    {
