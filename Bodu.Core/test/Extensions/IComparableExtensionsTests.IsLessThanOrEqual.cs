// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IComparableExtensionsTests.IsLessThanOrEqual.cs" company="Bodu Pty. Ltd.">
...
public partial class IComparableExtensionsTests
{
    ...
    /// </summary>
    [TestMethod]
    public void IsLessThanOrEqual_WhenComparerIsNull_ShouldThrowExactly()
    {
