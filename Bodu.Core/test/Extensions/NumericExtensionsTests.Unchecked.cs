...
public partial class NumericExtensionsTests
{
    ...
    public void RotateBitsLeftUnchecked_Byte_ShouldRotateCorrectly(byte value, int count, byte expected)
    {
        Assert.AreEqual(expected, value.RotateBitsLeftUnchecked(count));
    }
    ...
    [DataRow((byte)0b1010_1010, 4, (byte)0b1010_1010)]
    public void RotateBitsRightUnchecked_Byte_ShouldRotateCorrectly(byte value, int count, byte expected)
    {
        Assert.AreEqual(expected, value.RotateBitsRightUnchecked(count));
    }
    ...
    public void RotateBitsLeftUnchecked_UShort_ShouldRotateCorrectly(ushort value, int count, ushort expected)
    {
        Assert.AreEqual(expected, value.RotateBitsLeftUnchecked(count));
    }
    ...
    [DataRow((ushort)0x1234, 8, (ushort)0x3412)]
    public void RotateBitsRightUnchecked_UShort_ShouldRotateCorrectly(ushort value, int count, ushort expected)
    {
        Assert.AreEqual(expected, value.RotateBitsRightUnchecked(count));
    }
    ...
    public void RotateBitsLeftUnchecked_UInt_ShouldRotateCorrectly(uint value, int count, uint expected)
    {
        Assert.AreEqual(expected, value.RotateBitsLeftUnchecked(count));
    }
    ...
    [DataRow(0x12345678u, 16, 0x56781234u)]
    public void RotateBitsRightUnchecked_UInt_ShouldRotateCorrectly(uint value, int count, uint expected)
    {
        Assert.AreEqual(expected, value.RotateBitsRightUnchecked(count));
    }
    ...
    public void RotateBitsLeftUnchecked_ULong_ShouldRotateCorrectly(ulong value, int count, ulong expected)
    {
        Assert.AreEqual(expected, value.RotateBitsLeftUnchecked(count));
    }
    ...
    [DataRow(0x123456789ABCDEF0UL, 32, 0x9ABCDEF012345678UL)]
    public void RotateBitsRightUnchecked_ULong_ShouldRotateCorrectly(ulong value, int count, ulong expected)
    {
        Assert.AreEqual(expected, value.RotateBitsRightUnchecked(count));
    }
    ...
    public void ReverseBytesUnchecked_UShort_ShouldReverseByteOrder(ushort value, ushort expected)
    {
        Assert.AreEqual(expected, value.ReverseBytesUnchecked());
    }
    ...
    [DataRow(0u, 0u)]
    public void ReverseBytesUnchecked_UInt_ShouldReverseByteOrder(uint value, uint expected)
    {
        Assert.AreEqual(expected, value.ReverseBytesUnchecked());
    }
    ...
    [DataRow(0UL, 0UL)]
    public void ReverseBytesUnchecked_ULong_ShouldReverseByteOrder(ulong value, ulong expected)
    {
        Assert.AreEqual(expected, value.ReverseBytesUnchecked());
    }
