// ---------------------------------------------------------------------------------------------------------------
// <copyright file="AsyncThrottlerTests.TimeUntilNext.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Verifies that <see cref="AsyncThrottler.TimeUntilNext" /> reports zero before any invocation has been admitted.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="AsyncThrottler.TimeUntilNext" /> reports the remaining cool-down within the interval.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="AsyncThrottler.TimeUntilNext" /> clamps to zero once the interval has fully elapsed.
    /// </summary>
    [TestMethod]
