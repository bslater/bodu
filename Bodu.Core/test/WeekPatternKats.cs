...
/// <summary>
/// Represents a known-answer test row for a successful <see cref="WeekPattern" /> parse, carrying the input text,
/// optional format specifier, and the expected bitmask result.
/// </summary>
...
/// <summary>
/// Represents a known-answer test row for a <see cref="WeekPattern" /> parse that must fail, carrying the input text,
