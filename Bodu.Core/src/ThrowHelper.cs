...
/// <summary>
/// Provides centralized guard clause methods for argument validation,
/// offering consistent and concise exception throwing across both legacy and modern .NET target frameworks.
/// </summary>
/// <remarks>
/// <para>
...
/// where <see cref="System.Runtime.CompilerServices.CallerArgumentExpressionAttribute" /> is unavailable.
/// Parameter names are resolved at the declaration site using <see langword="nameof" />.
/// </description>
/// </item>
/// <item>
/// <description>
...
/// allowing the compiler to automatically capture argument expressions at the call site.
/// </description>
/// </item>
/// </list>
/// <para>
/// Both files expose an identical public API surface.
/// Consumers use the same method signatures regardless of the target framework;
/// the appropriate implementation is selected at compile time.
/// </para>
/// </remarks>
[SuppressMessage(
