// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeFormatInfoExtensions.cs" company="PlaceholderCompany">
...
/// <see cref="System.Globalization.DateTimeFormatInfo.FirstDayOfWeek"/>, but offers no symmetrical accessor for the last day of
/// the week — yet that value is needed for week-end snapping, weekend predicates, and report headers in any locale-driven
/// calendar code. This class supplies the missing accessors, derived from the same culture data so the result matches whatever
/// the active culture says is the start of the week.
/// </para>
/// <para>
/// The API surface is intentionally small and is shaped around culture-driven derivations rather than free-form formatting:
/// the central helper is <c>LastDayOfWeek</c>, which returns the <see cref="DayOfWeek"/> immediately preceding
/// <see cref="System.Globalization.DateTimeFormatInfo.FirstDayOfWeek"/> in the cyclic week.
/// </para>
/// <para>
