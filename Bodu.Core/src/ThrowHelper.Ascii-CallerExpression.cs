...
public static partial class ThrowHelper
{
    ...
    /// </exception>
    /// <remarks>
    /// Useful for validating inputs to algorithms that operate on decimal digit strings,
    /// such as check-digit algorithms.
    /// </remarks>
    ...
    /// alphanumeric character, that is,
    /// a character in the range <c>'0'</c> (U+0030) to <c>'9'</c> (U+0039) or <c>'A'</c> (U+0041) to <c>'Z'</c>
    /// (U+005A) inclusive.
    /// </summary>
    /// <param name="value">The character to validate.</param>
    /// <param name="paramName">The name of the parameter. Supplied automatically by the compiler.</param>
    ...
    /// </exception>
    /// <remarks>
    /// Useful for validating inputs to algorithms that operate on uppercase alphanumeric identifiers,
    /// such as ISO 7064 MOD 97-10 (IBAN / LEI), ISIN, SEDOL, and CUSIP.
    /// Lowercase letters are <b>not</b> accepted — the caller is expected to normalize before validation.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// digit character — that is, a character in the ranges <c>'0'</c>–<c>'9'</c> (U+0030–U+0039),
    ...
    /// </exception>
    /// <remarks>
    /// Both upper- and lowercase hex letters are accepted.
    /// Useful for validating hex-encoded cryptographic outputs such as hash digests, key material,
    /// or initialization vectors prior to parsing.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
