// ---------------------------------------------------------------------------------------------------------------
// <copyright file="StringExtensions.EnsureStartsWith.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Returns <paramref name="value" /> guaranteed to begin with <paramref name="prefix" />, prepending the
    /// prefix only when it is not already present.
    /// </summary>
    ...
    /// <paramref name="comparison" />; otherwise a new string equal to <paramref name="prefix" /> concatenated
