// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NumericExtensions.GreatestCommonDivisor.cs" company="PlaceholderCompany">
...
public static partial class NumericExtensions
{
    ...
    /// <summary>
    /// Returns the greatest common divisor of every element in the supplied array of non-negative
    ...
    /// <summary>
    /// Returns the greatest common divisor of every element in the supplied array of
    ...
    /// <summary>
    /// Computes the greatest common divisor of two unsigned values using the iterative Euclidean
    /// algorithm.
    /// </summary>
    /// <param name="a">The first value.</param>
    /// <param name="b">The second value.</param>
    /// <returns>
    /// <c>gcd(a, b)</c>. When both arguments are zero the result is zero; otherwise the larger
    /// non-zero argument is returned when the other is zero.
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
