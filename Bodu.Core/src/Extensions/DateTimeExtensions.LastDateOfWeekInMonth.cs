// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.LastDateOfWeekInMonth.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateTimeExtensions
{
    ...
    /// within the same calendar month and year as the specified <paramref name="dateTime" />.
    /// </summary>
    ...
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the last occurrence of the specified <see cref="DayOfWeek" />
    /// within the given calendar month and year.
    /// </summary>
    /// <param name="year">
