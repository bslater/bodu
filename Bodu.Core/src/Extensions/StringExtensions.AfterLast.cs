...
{
    /// <summary>
    /// Returns the substring of <paramref name="value" /> following the last occurrence of
    ...
    /// </param>
    /// <returns>
    /// The characters after the last occurrence of <paramref name="marker" />, or <see langword="null" />
