// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IComparableExtensions.IsLessThan.cs" company="Bodu Pty. Ltd.">
...
public static partial class IComparableExtensions
{
    ...
    /// <returns>
    /// <see langword="true" /> if <paramref name="value" /> is strictly less than <paramref name="other" />; otherwise,
    /// <see langword="false" />.
    /// </returns>
    /// <remarks>
    ...
    /// <summary>
    /// Determines whether a value is strictly less than a specified reference value using a custom
    ...
    /// <returns>
    /// <see langword="true" /> if <paramref name="value" /> is strictly less than <paramref name="other" /> based on
