...
public static partial class DateTimeExtensions
{
    ...
    /// <remarks>
    /// <para>
    /// The result is calculated by comparing the week-of-year for <paramref name="dateTime" /> against the week-of-year
    /// for the first day of its month, plus one.
    /// </para>
    /// <para>
    ...
    /// <para>
    /// The result is calculated by comparing the week-of-year for <paramref name="dateTime" /> against the week-of-year
    /// for the first day of its month, using the supplied rule and start day.
    /// </para>
    /// </remarks>
