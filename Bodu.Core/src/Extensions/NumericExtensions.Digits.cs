// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NumericExtensions.Digits.cs" company="PlaceholderCompany">
...
public static partial class NumericExtensions
{
    ...
    /// <returns>
    /// A <see cref="ushort"/> whose decimal digits appear in the reverse order of those in
    /// <paramref name="value"/>. Leading zeros that emerge in the reversed value are not preserved.
    /// </returns>
    ...
    /// <returns>
    /// A <see cref="uint"/> whose decimal digits appear in the reverse order of those in
    /// <paramref name="value"/>. Leading zeros that emerge in the reversed value are not preserved.
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <returns>
    /// A <see cref="ulong"/> whose decimal digits appear in the reverse order of those in
    /// <paramref name="value"/>. Leading zeros that emerge in the reversed value are not preserved.
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    /// Rotates the decimal digits of a <see cref="ushort"/> value the specified number of places to
    /// the left.
    /// </summary>
    /// <param name="value">The value whose digits are to be rotated.</param>
    ...
    /// <summary>
    /// Rotates the decimal digits of a <see cref="uint"/> value the specified number of places to
    /// the left.
    /// </summary>
    /// <param name="value">The value whose digits are to be rotated.</param>
    /// <param name="count">The non-negative number of positions to rotate.</param>
    ...
    /// <summary>
    /// Rotates the decimal digits of a <see cref="ulong"/> value the specified number of places to
    /// the left.
    /// </summary>
    /// <param name="value">The value whose digits are to be rotated.</param>
    /// <param name="count">The non-negative number of positions to rotate.</param>
    ...
    /// <returns>
    /// A new array containing the digits of <paramref name="value"/>; for <c>0</c> the result is a
    /// single-element array containing <c>0</c>.
    /// </returns>
    ...
    /// <returns>
    /// <c>10^<paramref name="exponent"/></c>. The caller must ensure the result fits in a
    /// <see cref="ulong"/>; values up to <c>10^19</c> are representable.
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <param name="value">The value whose digits are to be rotated.</param>
    /// <param name="count">
    /// The signed number of positions to rotate. Positive values rotate to the right (least
    /// significant digit becomes most significant); negative values rotate to the left.
    /// </param>
    /// <returns>
    /// The rotated value. Returns <paramref name="value"/> unchanged when it has fewer than two
    /// digits or when <paramref name="count"/> is congruent to zero modulo the digit length.
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
