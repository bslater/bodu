...
public static partial class StringExtensions
{
    ...
    /// <returns>
    /// A new string containing only the digit characters from <paramref name="value" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="value" /> is <see langword="null" />.
    /// </exception>
    /// <remarks>
    /// Membership is determined via <see cref="char.IsDigit(char)" />, which recognises every Unicode digit
    /// (Nd) character — not just ASCII <c>0–9</c>.
    /// </remarks>
