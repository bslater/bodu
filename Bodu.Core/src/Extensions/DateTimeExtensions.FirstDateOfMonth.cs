// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.FirstDateOfMonth.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the first day of the same calendar month and year as the
    ...
    /// </param>
    /// <returns>
    /// An object whose value is set to midnight (00:00:00) on the first day of the specified month and year, using
