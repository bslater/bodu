// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.LastDateOfQuarter.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> representing the last day of the calendar quarter that contains the
    ...
    /// <returns>
    /// A <see cref="DateOnly" /> value set to the last day of the quarter that contains <paramref name="date" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </list>
    /// </remarks>
    public static DateOnly LastDateOfQuarter(this DateOnly date) => LastDateOfQuarter(date, CalendarQuarterDefinition.JanuaryToDecember);

    /// <summary>
    /// Returns a new <see cref="DateOnly" /> representing the last day of the quarter that contains the specified
    ...
    /// <see cref="LastDateOfQuarter(DateOnly, IQuarterDefinitionProvider)" /> overload instead.
    /// </para>
    /// </remarks>
    ...
    /// </exception>
    public static DateOnly LastDateOfQuarter(this DateOnly date, CalendarQuarterDefinition definition)
    {
    ...
    /// </param>
    /// <returns>
    /// A <see cref="DateOnly" /> value set to the last day of the quarter containing <paramref name="date" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </exception>
    public static DateOnly LastDateOfQuarter(this DateOnly date, IQuarterDefinitionProvider provider)
    {
    ...
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> representing the last day of the specified calendar
    ...
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> representing the last day of the specified <paramref name="quarter" /> and
    /// <paramref name="year" />, using the supplied calendar quarter definition.
    /// </summary>
    /// <param name="year">
    /// The calendar year of the result. Must be between the <c>Year</c> property values of
    /// <see cref="DateOnly.MinValue" /> and <see cref="DateOnly.MaxValue" />, inclusive. If the quarter ends in the
