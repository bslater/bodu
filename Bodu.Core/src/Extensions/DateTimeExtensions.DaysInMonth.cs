// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.DaysInMonth.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Returns the number of days in the calendar month of the specified <see cref="DateTime" />, using the proleptic
    /// Gregorian calendar.
    /// </summary>
    /// <param name="dateTime">The date and time value whose year and month are used to determine the result.</param>
    /// <returns>
    /// The total number of days in the specified month and year of <paramref name="dateTime" />, based on the
    ...
    /// <see cref="DaysInMonth(DateTime, CultureInfo)" /> or <see cref="DaysInMonth(DateTime, Calendar)" /> overload.
    /// </para>
    /// </remarks>
    public static int DaysInMonth(this DateTime dateTime) => DateTime.DaysInMonth(dateTime.Year, dateTime.Month);

    /// <summary>
    /// Returns the number of days in the calendar month of the specified <see cref="DateTime" />, using the calendar
    ...
    /// </param>
    /// <returns>
    /// The total number of days in the specified month and year of <paramref name="dateTime" />, based on the calendar
    /// of <paramref name="culture" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// the supplied or current calendar.
    /// </returns>
    /// <remarks>
    /// <para>
