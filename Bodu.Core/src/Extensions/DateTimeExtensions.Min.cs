// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.Min.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateTimeExtensions
{
    ...
    /// <returns>
    /// The earlier of the two <see cref="DateTime" /> values. If both values are equal, <paramref name="first" /> is
    /// returned.
    /// </returns>
    /// <remarks>
    /// <para>
    /// This method compares the two values using the less-than-or-equal-to (<c>&lt;=</c>) operator, which is equivalent
    /// to <see cref="DateTime.CompareTo(DateTime)" />. The <see cref="DateTime.Kind" /> of the selected value is
    /// preserved.
    /// </para>
    /// </remarks>
    ...
    /// <returns>
    /// The earlier non-null <see cref="DateTime" /> value, or <see langword="null" /> if both values are
    /// <see langword="null" />.
    /// </returns>
    /// <remarks>
    /// <para>
