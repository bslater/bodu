...
{
    /// <summary>
    /// Returns <paramref name="value" /> with a single leading occurrence of <paramref name="prefix" />
    ...
    /// The comparison rule used to detect <paramref name="prefix" /> at the start of
    /// <paramref name="value" />. Defaults to <see cref="StringComparison.Ordinal" />.
    /// </param>
    /// <returns>
    /// <paramref name="value" /> without the leading <paramref name="prefix" /> when present; otherwise the
    /// original instance.
    /// </returns>
    ...
    /// </exception>
    /// <remarks>
    /// Removes at most one occurrence of <paramref name="prefix" />. Use the BCL <see cref="string.TrimStart(char[])" />
    /// when greedy removal of character-level prefixes is required.
    /// </remarks>
