// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.FirstDateOfQuarter.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the first day of the calendar quarter that contains the
    /// specified <paramref name="dateTime" />, using the standard calendar quarter definition.
    /// </summary>
    ...
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the first day of the quarter that contains the specified
    /// <paramref name="dateTime" />, using the specified calendar quarter definition.
    /// </summary>
    /// <param name="dateTime">The date and time value used to determine the containing quarter.</param>
    ...
    /// </param>
    /// <returns>
    /// An object whose value is set to midnight (00:00:00) on the first day of the corresponding quarter, with the
    ...
    /// <see cref="FirstDateOfQuarter(DateTime, IQuarterDefinitionProvider)" /> overload instead.
    /// </para>
    /// <para>
    /// The returned value has its time component normalized to midnight (00:00:00), and the original
    /// <see cref="DateTime.Kind" /> is retained.
    ...
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the first day of the quarter that contains the specified
    /// <paramref name="dateTime" />, using a custom <see cref="IQuarterDefinitionProvider" />.
    /// </summary>
    /// <param name="dateTime">The date and time value used to determine the containing quarter.</param>
    /// <param name="provider">
    ...
    /// </exception>
    /// <exception cref="ArgumentOutOfRangeException">
    /// Thrown if the <paramref name="provider" /> returns a date outside the range of <see cref="DateTime.MinValue" />
    /// and <see cref="DateTime.MaxValue" />.
    /// </exception>
    ...
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the first day of the specified calendar
    ...
    /// <returns>
    /// An object whose value is set to midnight (00:00:00) on the first day of the specified quarter and year, using
    ...
    /// 4.
    /// </exception>
    public static DateTime GetFirstDateOfQuarter(int year, int quarter) => GetFirstDateOfQuarter(year, quarter, CalendarQuarterDefinition.JanuaryToDecember);

    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the first day of the specified <paramref name="quarter" />
    ...
    /// </param>
    /// <returns>
    /// An object whose value is set to midnight (00:00:00) on the first day of the specified quarter, using
    /// <see cref="DateTimeKind.Unspecified" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// <summary>
    /// Returns the first day of the quarter that contains the specified <paramref name="dateTime" />, using a
    /// prevalidated calendar quarter <paramref name="definition" />.
    /// </summary>
    /// <param name="dateTime">The date and time value used to determine the containing quarter.</param>
    /// <param name="definition">
    ...
    /// </param>
    /// <returns>
    /// An object whose value is set to midnight (00:00:00) on the first day of the quarter, with the original
    /// <see cref="DateTime.Kind" /> preserved.
    /// </returns>
    /// <remarks>
    /// This helper performs no validation and is intended for internal use where the <paramref name="definition" /> is
    /// known to be valid.
    /// </remarks>
