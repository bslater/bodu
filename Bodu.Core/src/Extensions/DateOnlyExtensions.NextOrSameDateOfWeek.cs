// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.NextOrSameDateOfWeek.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateOnlyExtensions
{
    ...
    /// <see cref="DayOfWeek" /> at or after the given <paramref name="date" />.
    /// </summary>
    ...
    /// or after <paramref name="date" />.
    /// </param>
    /// <returns>
    /// A <see cref="DateOnly" /> value set to the next occurrence of <paramref name="dayOfWeek" /> at or after
    /// <paramref name="date" />.
    /// </returns>
    /// <remarks>
    /// <para>
    /// If <paramref name="date" /> already falls on the specified <paramref name="dayOfWeek" />, the result is
    /// <paramref name="date" /> itself. This is the on-or-after counterpart of
    /// <see cref="NextDateOfWeek(DateOnly, DayOfWeek)" />, which always advances by at least one day.
    /// </para>
    /// </remarks>
    /// <exception cref="ArgumentOutOfRangeException">
    /// Thrown if <paramref name="dayOfWeek" /> is not a defined value of the <see cref="DayOfWeek" /> enumeration.
    /// </exception>
    public static DateOnly NextOrSameDateOfWeek(this DateOnly date, DayOfWeek dayOfWeek)
    {
