...
public static partial class DateTimeExtensions
{
    ...
    /// <remarks>
    /// <para>This method is functionally equivalent to <see cref="Midnight(DateTime)"/> and to accessing <see cref="DateTime.Date"/>. It normalizes the time component to midnight while retaining the date and <see cref="DateTime.Kind"/> of the input.</para>
