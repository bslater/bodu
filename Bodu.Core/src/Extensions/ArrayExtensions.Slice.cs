// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ArrayExtensions.Slice.cs" company="Bodu Pty. Ltd.">
...
public static partial class ArrayExtensions
{
    ...
    /// <returns>
    /// A new array containing elements from the <paramref name="array" /> starting from <paramref name="index" /> to
    /// the end.
    /// </returns>
    ...
    /// <returns>
    /// A new array containing the sliced elements from the <paramref name="array" /> starting at
    /// <paramref name="index" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="array" /> is <see langword="null" />.
    ...
    /// Thrown when <paramref name="index" /> and <paramref name="count" /> describe an invalid range within
    /// <paramref name="array" />.
    /// </exception>
    ...
    /// <returns>
    /// A new array containing the copied elements from the <paramref name="array" /> starting from
    /// <paramref name="index" />.
    /// </returns>
    /// <remarks>
