// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.MonthName.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Returns the full name of the month for the specified <see cref="DateOnly" />, using the formatting rules of
    ...
    /// retrieve the month name. For culture-specific results, use the <see cref="MonthName(DateOnly, CultureInfo?)" />
    /// overload.
    /// </para>
    /// </remarks>
    ...
    /// <summary>
    /// Returns the full name of the month for the specified <see cref="DateOnly" />, using the formatting rules of the
    ...
    /// </param>
    /// <returns>
    /// A <see cref="string" /> containing the localized full month name for <paramref name="date" />, formatted using
