...
{
    /// <summary>
    /// Returns the <see cref="WeekOrdinal" /> represented by the specified <see cref="DateTime" />, indicating
    ...
    /// <returns>
    /// A <see cref="WeekOrdinal" /> value indicating which occurrence of the weekday
    ...
    /// enumeration.
    /// </exception>
    public static WeekOrdinal OrdinalWeekOfMonth(this DateTime dateTime)
    {
