// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NumericExtensions.ReverseBits.cs" company="Bodu Pty. Ltd.">
...
public static partial class NumericExtensions
{
    ...
    /// The number of least significant bits to reverse. Must be in the range [0, 8]. Bits above the reflected window
    /// are discarded.
    /// </param>
    /// <returns>
    ...
    /// <param name="bitLength">
    /// The number of least significant bits to reverse. Must be in the range [0, 16]. Bits above the reflected window
    /// are discarded.
    /// </param>
    /// <returns>
    ...
    /// <param name="bitLength">
    /// The number of least significant bits to reverse. Must be in the range [0, 32]. Bits above the reflected window
    /// are discarded.
    /// </param>
    /// <returns>
    ...
    /// <param name="bitLength">
    /// The number of least significant bits to reverse. Must be in the range [0, 64]. Bits above the reflected window
    /// are discarded.
    /// </param>
    /// <returns>
    ...
    /// </exception>
    /// <remarks>
    /// Commonly used by CRC and other checksum primitives to implement the <c>reflect-in</c> / <c>reflect-out</c>
    /// transformations where <paramref name="bitLength" /> matches the hash width.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <returns>
    /// A new byte array in which the bits of each element have been reversed. The original array is not modified.
    /// </returns>
    /// <remarks>
    /// <para>
    /// Each byte is reversed independently using <see cref="ReverseBits(byte)" />. The relative order of bytes within
