...
{
    /// <summary>
    /// Returns the substring of <paramref name="value" /> preceding the last occurrence of
    ...
    /// </param>
    /// <returns>
    /// The characters before the last occurrence of <paramref name="marker" />, or <see langword="null" />
