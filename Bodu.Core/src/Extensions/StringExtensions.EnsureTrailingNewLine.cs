...
{
    /// <summary>
    /// Returns <paramref name="value" /> guaranteed to end with <paramref name="newline" />, appending the
    /// terminator only when it is not already present.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    /// <paramref name="value" /> when it already ends with <paramref name="newline" />; otherwise a new
    /// string equal to <paramref name="value" /> with <paramref name="newline" /> appended.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="value" /> or <paramref name="newline" /> is <see langword="null" />.
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Thrown when <paramref name="newline" /> is the empty string.
    /// </exception>
    /// <remarks>
    /// Comparison is ordinal — only the exact byte sequence specified by <paramref name="newline" /> counts
    /// as already terminated. A value ending in <c>"\r\n"</c> is not considered to end in <c>"\n"</c> for
