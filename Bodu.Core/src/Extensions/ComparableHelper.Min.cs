// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ComparableHelper.Min.cs" company="Bodu Pty. Ltd.">
...
public static partial class ComparableHelper
{
    ...
    /// <returns>
    /// The smaller of the two values. If one value is <see langword="null" />, the non-null value is returned. If both
    ...
    /// <returns>
    /// The smaller of the two values based on the specified comparer. If one value is <see langword="null" />, the
    ...
    /// </exception>
    /// <remarks>
    /// Use this overload to apply custom comparison logic, such as culture-specific string comparisons.
    /// </remarks>
