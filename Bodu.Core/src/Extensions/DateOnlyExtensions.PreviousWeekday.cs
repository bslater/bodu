// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.PreviousWeekday.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateOnlyExtensions
{
    ...
    /// </param>
    /// <returns>
    /// A <see cref="DateOnly" /> value set to the first calendar day before <paramref name="date" /> that is a working
    ...
    /// <remarks>
    /// <para>
    /// The method evaluates each preceding day prior to <paramref name="date" /> until it finds one that is a working
    ...
    /// </param>
    /// <returns>
    /// The first calendar day strictly before <paramref name="date" /> whose day-of-week is selected in
