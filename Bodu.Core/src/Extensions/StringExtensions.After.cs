// ---------------------------------------------------------------------------------------------------------------
// <copyright file="StringExtensions.After.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Returns the substring of <paramref name="value" /> following the first occurrence of
    ...
    /// </param>
    /// <returns>
    /// The characters after the first occurrence of <paramref name="marker" />, or <see langword="null" />
