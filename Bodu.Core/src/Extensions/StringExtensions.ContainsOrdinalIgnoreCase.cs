// ---------------------------------------------------------------------------------------------------------------
// <copyright file="StringExtensions.ContainsOrdinalIgnoreCase.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Returns a value indicating whether <paramref name="value" /> contains <paramref name="valueToFind" />
