// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.ToIsoString.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Returns a string representation of the specified <paramref name="dateTime" /> in ISO 8601 format, using its
    /// <see cref="DateTime.Kind" /> to determine the appropriate format suffix.
    /// </summary>
    ...
    /// <item>
    /// <description>
    /// ends with <c>'Z'</c> if <see cref="DateTime.Kind" /> is <see cref="DateTimeKind.Utc" />;
    /// </description>
    /// </item>
    /// <item>
    /// <description>
    /// includes the local time zone offset if <see cref="DateTime.Kind" /> is <see cref="DateTimeKind.Local" />;
    /// </description>
    /// </item>
    /// <item>
    /// <description>
    /// omits any offset if <see cref="DateTime.Kind" /> is <see cref="DateTimeKind.Unspecified" />.
    /// </description>
    /// </item>
    /// </list>
    /// </returns>
    /// <remarks>
    /// <para>
    /// Uses the <c>"o"</c> (round-trip) format for <see cref="DateTimeKind.Local" /> and
    /// <see cref="DateTimeKind.Unspecified" />, and a custom UTC format (<c>"yyyy-MM-ddTHH:mm:ss.fffffffZ"</c>) for
    ...
    /// <summary>
    /// Returns a string representation of the specified <paramref name="dateTime" /> in ISO 8601 format, optionally
    /// omitting fractional seconds.
    /// </summary>
    /// <param name="dateTime">The date and time value to convert.</param>
    /// <param name="includeFractionalSeconds">
    /// Indicates whether to include fractional seconds (7 digits) in the output.
    /// </param>
    /// <returns>
    /// A <see cref="string" /> representation of <paramref name="dateTime" /> in ISO 8601 format, with or without
    /// fractional seconds.
    /// </returns>
    /// <remarks>
    /// <para>
    /// Uses the <c>"o"</c> (round-trip) format when <paramref name="includeFractionalSeconds" /> is
    /// <see langword="true" />; otherwise uses <c>"yyyy-MM-ddTHH:mm:ss"</c>.
    /// </para>
    /// </remarks>
    ...
    /// <summary>
    /// Returns a string representation of the specified <paramref name="dateTime" /> in ISO 8601 format, using an
    /// explicit <see cref="DateTimeKind" /> override.
    /// </summary>
    /// <param name="dateTime">The date and time value to convert.</param>
    ...
    /// Thrown if <paramref name="kind" /> is not a defined value of the <see cref="DateTimeKind" /> enumeration.
    /// </exception>
    ...
    /// <summary>
    /// Returns a string representation of the specified <paramref name="dateTime" /> using a custom format and an
    /// optional culture.
    /// </summary>
    /// <param name="dateTime">The date and time value to format.</param>
    /// <param name="format">
    /// A valid date-time format string (e.g. <c>"yyyy-MM-ddTHH:mm:ss"</c>). Must not be <see langword="null" /> or
    /// whitespace.
    /// </param>
    /// <param name="culture">
    /// An optional <see cref="CultureInfo" /> used for culture-specific formatting. If <see langword="null" />,
    /// <see cref="CultureInfo.InvariantCulture" /> is used.
    /// </param>
    /// <returns>
    /// A formatted <see cref="string" /> representation of <paramref name="dateTime" /> using the supplied format and
    /// culture.
    /// </returns>
