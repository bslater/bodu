// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.IsWeekend.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateOnlyExtensions
{
    ...
    /// <returns>
    /// <see langword="true" /> if <paramref name="date" /> falls on Saturday or Sunday; otherwise,
    /// <see langword="false" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// <summary>
    /// Determines whether the specified <see cref="DateOnly" /> falls on a weekend, using the supplied
    ...
    /// </param>
    /// <returns>
    /// <see langword="true" /> if <paramref name="date" /> falls on a weekend day as defined by the supplied
