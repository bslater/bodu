...
public static partial class StringExtensions
{
    ...
    /// </param>
    /// <returns>
    /// A new string with all replacements applied. When <paramref name="replacements" /> is empty, the
    /// original instance is returned.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="value" /> or <paramref name="replacements" /> is <see langword="null" />,
    /// or when any key in <paramref name="replacements" /> is <see langword="null" />.
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Thrown when any key in <paramref name="replacements" /> is the empty string.
    /// </exception>
    /// <remarks>
    /// Replacements are applied sequentially — output of an earlier replacement is visible to a later one.
    /// Pre-order keys to avoid cascading substitutions when independence is required.
    /// </remarks>
