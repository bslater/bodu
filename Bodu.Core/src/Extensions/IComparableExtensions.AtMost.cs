...
public static partial class IComparableExtensions
{
    ...
    /// <returns>
    /// <paramref name="value" /> if it compares less than or equal to <paramref name="max" />; otherwise,
    /// <paramref name="max" />.
    /// </returns>
    /// <remarks>
    ...
    /// <returns>
    /// <paramref name="value" /> if it compares less than or equal to <paramref name="max" /> under the specified
    /// comparer; otherwise, <paramref name="max" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="comparer" /> is <see langword="null" />.
    /// </exception>
    /// <remarks>
    /// This is a one-sided form of <see cref="Clamp{T}(T, T?, T?, IComparer{T})" /> for cases where only a ceiling is
    /// required.
    /// </remarks>
