...
public static partial class DateOnlyExtensions
{
    ...
    /// within the calendar quarter that contains the specified <paramref name="date" />, using the standard calendar
    /// quarter definition.
    /// </summary>
    ...
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> representing the last occurrence of the specified <see cref="DayOfWeek" />
    /// within the quarter that contains the specified <paramref name="date" />, using a custom
    ...
    public static DateOnly LastDateOfWeekInQuarter(this DateOnly date, DayOfWeek dayOfWeek, IQuarterDefinitionProvider provider)
    {
        ...
        int dayNumber = provider.GetQuarterEndDate(date).DayNumber;
        dayNumber -= (GetDayOfWeekFromDayNumber(dayNumber) - dayOfWeek + 7) % 7;
    ...
    public static DateOnly GetLastDateOfWeekInQuarter(int year, int quarter, DayOfWeek dayOfWeek, CalendarQuarterDefinition definition)
    {
        ...
        return definition == CalendarQuarterDefinition.Custom
            ...
            : GetLastDateOfWeekInQuarterInternal(year, quarter, dayOfWeek, definition);
    }
