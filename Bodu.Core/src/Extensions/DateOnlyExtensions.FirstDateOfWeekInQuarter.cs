// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.FirstDateOfWeekInQuarter.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateOnlyExtensions
{
    ...
    /// <see cref="DayOfWeek" /> within the calendar quarter that contains the specified <paramref name="date" />, using
    ...
    /// </param>
    /// <returns>
    /// A <see cref="DateOnly" /> value set to the first occurrence of <paramref name="dayOfWeek" /> within the quarter
    ...
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> representing the first occurrence of the specified
    /// <see cref="DayOfWeek" /> within the quarter that contains the specified <paramref name="date" />, using the
    ...
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> representing the first occurrence of the specified
    /// <see cref="DayOfWeek" /> within the quarter that contains the specified <paramref name="date" />, using a custom
    ...
    public static DateOnly FirstDateOfWeekInQuarter(this DateOnly date, DayOfWeek dayOfWeek, IQuarterDefinitionProvider provider)
    {
        ...
        int dayNumber = provider.GetQuarterStartDate(date).DayNumber;
        return DateOnly.FromDayNumber(dayNumber + GetNextDayOfWeekFromDayNumber(dayNumber, dayOfWeek));
    }
    ...
    /// than that of <see cref="DateOnly.MaxValue" />, -or- <paramref name="quarter" /> is less than 1 or greater than
    ...
    public static DateOnly GetFirstDateOfWeekInQuarter(int year, int quarter, DayOfWeek dayOfWeek, CalendarQuarterDefinition definition)
    {
        ...
        return definition == CalendarQuarterDefinition.Custom
            ...
            : GetFirstDateOfWeekInQuarterInternal(year, quarter, dayOfWeek, definition);
    }
    ...
    {
        int dayNumber = ComputeQuarterStartDayNumber(year, quarter, GetQuarterDefinition(definition));
