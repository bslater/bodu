// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IComparableExtensions.IsEqualTo.cs" company="Bodu Pty. Ltd.">
...
public static partial class IComparableExtensions
{
    ...
    /// <returns>
    /// <see langword="true" /> if <paramref name="comparer" /> compares <paramref name="value" /> and
    /// <paramref name="other" /> as equal (that is, <see cref="IComparer{T}.Compare(T, T)" /> returns zero); otherwise,
    /// <see langword="false" />.
    /// </returns>
