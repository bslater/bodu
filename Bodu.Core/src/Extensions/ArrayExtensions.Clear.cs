// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ArrayExtensions.Clear.cs" company="Bodu Pty. Ltd.">
...
public static partial class ArrayExtensions
{
    ...
    /// <summary>
    /// Sets all elements in a one-dimensional array to the default value of the element type, starting from the
    /// specified index to the end of the array.
    /// </summary>
    /// <typeparam name="T">The type of the elements of the array.</typeparam>
    /// <param name="array">The one-dimensional array to clear.</param>
    ...
    /// </exception>
    /// <remarks>
    /// This method clears elements starting from <paramref name="index" /> to the end of the array. The number of
    /// elements cleared is <c>array.Length - index</c>.
    /// </remarks>
    ...
    /// <summary>
    /// Sets a specified number of elements in a one-dimensional array to the default value of the element type,
    ...
    /// <exception cref="ArgumentNullException"><paramref name="array" /> is <see langword="null" />.</exception>
    /// <exception cref="ArgumentOutOfRangeException">
    /// <paramref name="index" /> is less than 0 or greater than the length of <paramref name="array" />. <br /> -or-
    /// <br /><paramref name="count" /> is less than 0 or extends beyond the end of the array.
    /// </exception>
    /// <remarks>
    ...
    /// <paramref name="array" /> is not a single-dimensional array. <br /> -or- <br /><paramref name="array" /> does
    /// not have a zero-based index.
    /// </exception>
    /// <remarks>
    ...
    /// <summary>
    /// Sets all elements in an <see cref="Array" /> to the default value of each element type, starting from the
    /// specified index to the end of the array.
    /// </summary>
    /// <param name="array">The array whose elements to clear.</param>
    /// <param name="index">The zero-based index at which to begin clearing elements.</param>
    ...
    /// </exception>
    /// <remarks>
    /// Clears elements from <paramref name="index" /> to the end of the array.
    /// </remarks>
    ...
    /// <summary>
    /// Sets a specified number of elements in an <see cref="Array" /> to the default value of each element type,
    /// starting from a given index.
    /// </summary>
    /// <param name="array">The array whose elements to clear.</param>
    /// <param name="index">The zero-based index at which to begin clearing elements.</param>
    ...
    /// </exception>
    /// <remarks>
    /// Clears <paramref name="count" /> elements starting at <paramref name="index" />.
    /// </remarks>
