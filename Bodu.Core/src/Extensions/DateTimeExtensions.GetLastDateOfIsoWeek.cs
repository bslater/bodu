// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.GetLastDateOfIsoWeek.cs" company="PlaceholderCompany">
...
public static partial class DateTimeExtensions
{
    ...
    /// </list>
    /// <para>The returned value is normalized to midnight (00:00:00) and uses <see cref="DateTimeKind.Unspecified"/>. For the corresponding start of the week, use <see cref="GetFirstDateOfIsoWeek(int, int)"/>.</para>
    /// </remarks>
