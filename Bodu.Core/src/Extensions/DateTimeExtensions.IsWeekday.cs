...
{
    /// <summary>
    /// Determines whether the specified <see cref="DateTime"/> falls on a weekday, using the default <see cref="WorkingDaysOfWeek.MondayToFriday"/> rule.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether the specified <see cref="DateTime"/> falls on a weekday, using the supplied <see cref="WorkingDaysOfWeek"/> and an optional custom <paramref name="provider"/>.
    /// </summary>
    /// <param name="dateTime">The date and time value to evaluate.</param>
    ...
    /// <remarks>
    /// <para>The method evaluates whether the <see cref="DateTime.DayOfWeek"/> of <paramref name="dateTime"/> is included in the working-week pattern supplied by <paramref name="workingWeek"/> and optionally refined by <paramref name="provider"/>.</para>
    /// </remarks>
    ...
    /// <summary>
    /// Determines whether the specified <see cref="DayOfWeek"/> is considered a weekday, using the supplied <see cref="WorkingDaysOfWeek"/> and an optional custom <paramref name="provider"/>.
    /// </summary>
    ...
    /// <remarks>
    /// <para>This method is equivalent to <c>!IsWeekend(dayOfWeek, workingWeek, provider)</c>.</para>
    /// </remarks>
    /// <exception cref="ArgumentOutOfRangeException">
    /// Thrown if <paramref name="workingWeek"/> is not a defined value of the <see cref="WorkingDaysOfWeek"/> enumeration,
    /// -or- <paramref name="workingWeek"/> is <see cref="WorkingDaysOfWeek.Custom"/> and <paramref name="provider"/> is <see langword="null"/>.
