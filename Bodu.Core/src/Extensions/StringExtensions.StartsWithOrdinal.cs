// ---------------------------------------------------------------------------------------------------------------
// <copyright file="StringExtensions.StartsWithOrdinal.cs" company="PlaceholderCompany">
...
public static partial class StringExtensions
{
    ...
    /// </exception>
    /// <remarks>
    /// Provides an explicit-Ordinal alternative to the BCL <see cref="string.StartsWith(string)" /> overload,
    /// which defaults to <see cref="StringComparison.CurrentCulture" /> and can produce surprising results
    /// across locales.
    /// </remarks>
