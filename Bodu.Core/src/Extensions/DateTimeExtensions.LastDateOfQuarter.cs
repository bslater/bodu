// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.LastDateOfQuarter.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the last day of the calendar quarter that contains the
    ...
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the last day of the quarter that contains the specified
    ...
    /// </param>
    /// <returns>
    /// An object whose value is set to midnight (00:00:00) on the last day of the corresponding quarter, with the
    ...
    /// <see cref="LastDateOfQuarter(DateTime, IQuarterDefinitionProvider)" /> overload instead.
    /// </para>
    /// <para>
    /// The returned value has its time component normalized to midnight (00:00:00), and the original
    /// <see cref="DateTime.Kind" /> is retained.
    ...
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the last day of the specified calendar
    ...
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the last day of the specified <paramref name="quarter" /> and
    /// <paramref name="year" />, using the supplied calendar quarter definition.
    /// </summary>
    /// <param name="year">
    /// The calendar year of the result. Must be between the <c>Year</c> property values of
    /// <see cref="DateTime.MinValue" /> and <see cref="DateTime.MaxValue" />, inclusive.
    ...
    /// </param>
    /// <returns>
    /// An object whose value is set to midnight (00:00:00) on the last day of the specified quarter, using
    /// <see cref="DateTimeKind.Unspecified" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// <summary>
    /// Returns the last day of the quarter that contains the specified <paramref name="dateTime" />, using a
    ...
    /// </param>
    /// <returns>
    /// An object whose value is set to midnight (00:00:00) on the last day of the quarter, with the original
