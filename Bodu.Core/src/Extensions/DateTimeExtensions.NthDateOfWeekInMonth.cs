// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.NthDateOfWeekInMonth.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the specified ordinal occurrence of a
    /// <see cref="DayOfWeek" /> within the same calendar month and year as the specified <paramref name="dateTime" />.
    /// </summary>
    /// <param name="dateTime">
    /// The date and time value whose month and year are used to determine the result. The day component is ignored.
    /// </param>
    ...
    /// within the same calendar month and year as <paramref name="dateTime" />, with the original
    ...
    /// <returns>
    /// An object whose value is set to midnight (00:00:00) on the requested occurrence of <paramref name="dayOfWeek" />
    /// within the specified <paramref name="year" /> and <paramref name="month" />, using
