...
public static partial class StringExtensions
{
    ...
    /// <returns>
    /// A new string containing only the letter characters from <paramref name="value" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="value" /> is <see langword="null" />.
    /// </exception>
    /// <remarks>
    /// Membership is determined via <see cref="char.IsLetter(char)" />, which recognises every Unicode letter
    /// category (Lu, Ll, Lt, Lm, Lo). ASCII digits, punctuation, whitespace, and control characters are
    /// stripped.
    /// </remarks>
