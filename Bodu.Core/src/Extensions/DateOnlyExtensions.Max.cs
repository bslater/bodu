// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.Max.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateOnlyExtensions
{
    ...
    /// <returns>
    /// The later of the two <see cref="DateOnly" /> values. If both values are equal, <paramref name="first" /> is
    /// returned.
    /// </returns>
    /// <remarks>
    /// <para>
    /// This method compares the two values using the greater-than-or-equal-to (<c>&gt;=</c>) operator, which is
    /// equivalent to <see cref="DateOnly.CompareTo(DateOnly)" />.
    /// </para>
    /// </remarks>
    ...
    /// <returns>
    /// The later non-null <see cref="DateOnly" /> value, or <see langword="null" /> if both values are
    /// <see langword="null" />.
    /// </returns>
    /// <remarks>
    /// <para>
