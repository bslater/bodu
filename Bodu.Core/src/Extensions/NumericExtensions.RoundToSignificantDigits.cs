...
public static partial class NumericExtensions
{
    ...
    /// <param name="digits">
    /// The number of significant digits to retain. Must be between <c>1</c> and <c>15</c>, inclusive
    /// (the practical precision limit of <see cref="double"/>).
    /// </param>
    /// <returns>
    ...
    /// </exception>
    /// <remarks>
    /// Unlike <see cref="Math.Round(double, int)"/>, which rounds to a fixed number of fractional
    /// digits, this method scales the rounding magnitude to the order of magnitude of
    /// <paramref name="value"/>. Negative values are handled symmetrically.
    /// </remarks>
    /// <example>
    ...
    /// <param name="value">The value to round.</param>
    /// <param name="digits">
    /// The number of significant digits to retain. Must be between <c>1</c> and <c>28</c>, inclusive
    /// (the precision limit of <see cref="decimal"/>).
    /// </param>
    /// <returns>
    /// <paramref name="value"/> rounded to <paramref name="digits"/> significant digits. Returns
