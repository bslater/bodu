// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IComparableExtensions.Max.cs" company="Bodu Pty. Ltd.">
...
public static partial class IComparableExtensions
{
    ...
    /// <returns>
    /// <paramref name="value" /> if it compares greater than or equal to <paramref name="other" />; otherwise,
    /// <paramref name="other" />.
    /// </returns>
    /// <remarks>
    ...
    /// <returns>
    /// <paramref name="value" /> if it compares greater than or equal to <paramref name="other" /> under the specified
