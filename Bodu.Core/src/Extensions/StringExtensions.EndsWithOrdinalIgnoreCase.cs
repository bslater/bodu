// ---------------------------------------------------------------------------------------------------------------
// <copyright file="StringExtensions.EndsWithOrdinalIgnoreCase.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Returns a value indicating whether <paramref name="value" /> ends with <paramref name="valueToFind" />
