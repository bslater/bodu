// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NumericExtensions.LeastCommonMultiple.cs" company="Bodu Pty. Ltd.">
...
public static partial class NumericExtensions
{
    ...
    /// <returns>
    /// The least common multiple of <paramref name="value" /> and <paramref name="other" />; <c>0</c> when either
    /// argument is <c>0</c>.
    /// </returns>
    /// <exception cref="ArgumentOutOfRangeException">
    /// <paramref name="value" /> or <paramref name="other" /> is negative.
    /// </exception>
    /// <exception cref="OverflowException">The result does not fit in a <see cref="short" />.</exception>
    ...
    /// <summary>
    /// Returns the least common multiple of every element in the supplied array of non-negative <see cref="short" />
    /// values.
    /// </summary>
    ...
    /// <summary>
    /// Returns the least common multiple of every element in the supplied array of non-negative <see cref="int" />
    /// values.
    /// </summary>
    /// <param name="values">The values whose common multiple is to be computed.</param>
    /// <returns>The least common multiple of every element in <paramref name="values" />.</returns>
    ...
    /// <summary>
    /// Returns the least common multiple of every element in the supplied array of non-negative <see cref="long" />
    /// values.
    /// </summary>
    /// <param name="values">The values whose common multiple is to be computed.</param>
    /// <returns>The least common multiple of every element in <paramref name="values" />.</returns>
    ...
    /// <summary>
    /// Returns the least common multiple of every element in the supplied array of <see cref="ushort" /> values.
    /// </summary>
    /// <param name="values">The values whose common multiple is to be computed.</param>
    /// <returns>The least common multiple of every element in <paramref name="values" />.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="values" /> is <see langword="null" />.</exception>
    ...
    /// <summary>
    /// Returns the least common multiple of every element in the supplied array of <see cref="ulong" /> values.
    /// </summary>
    /// <param name="values">The values whose common multiple is to be computed.</param>
    /// <returns>The least common multiple of every element in <paramref name="values" />.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="values" /> is <see langword="null" />.</exception>
    ...
    /// <returns>
    /// <c>lcm(a, b)</c>. Returns <c>0</c> when either argument is <c>0</c>. Performs the GCD division before
    /// multiplication to reduce overflow risk.
    /// </returns>
    /// <exception cref="OverflowException">
    /// The product of <c>a / gcd(a, b)</c> and <c>b</c> exceeds the range of <see cref="ulong" />.
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static ulong Lcm(ulong a, ulong b) => a == 0 || b == 0 ? 0 : checked(a / Gcd(a, b) * b);
}
