// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.FirstDateOfWeekInYear.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateTimeExtensions
{
    ...
    /// <see cref="DayOfWeek" /> within the same calendar year as the specified <paramref name="dateTime" />.
    /// </summary>
