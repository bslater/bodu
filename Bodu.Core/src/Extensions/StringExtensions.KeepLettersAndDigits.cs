// ---------------------------------------------------------------------------------------------------------------
// <copyright file="StringExtensions.KeepLettersAndDigits.cs" company="Bodu Pty. Ltd.">
...
public static partial class StringExtensions
{
    ...
    /// <returns>A new string containing only the letter and digit characters from <paramref name="value" />.</returns>
