...
public static partial class NumericExtensions
{
    ...
    /// </exception>
    /// <remarks>
    /// Delegates to <see cref="BitOperations.RotateRight(uint, int)"/> after validation, allowing
    ...
    /// </exception>
    /// <remarks>
    /// Delegates to <see cref="BitOperations.RotateRight(ulong, int)"/> after validation, allowing
    /// the JIT to lower the rotation to a single CPU instruction on supported platforms.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
