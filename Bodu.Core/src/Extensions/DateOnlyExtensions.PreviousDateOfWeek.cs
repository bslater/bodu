// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.PreviousDateOfWeek.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateOnlyExtensions
{
    ...
    /// <see cref="DayOfWeek" /> before the given <paramref name="date" />.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    /// A <see cref="DateOnly" /> value set to the previous occurrence of <paramref name="dayOfWeek" /> preceding
    /// <paramref name="date" />.
    /// </returns>
    /// <remarks>
    /// <para>
    /// If <paramref name="date" /> already falls on the specified <paramref name="dayOfWeek" />, the result is exactly
    /// seven days earlier. The method moves backward in time and never returns the original date.
    /// </para>
    /// </remarks>
