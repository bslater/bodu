...
public static partial class SpanExtensions
{
    ...
    /// </remarks>
    /// <example>
    /// <code><![CDATA[ int[] data = { 1, 2, 3, 4, 5 }; // Reverse a middle section; first and last elements are untouched.
    ...
    /// </remarks>
    /// <example>
    /// <code><![CDATA[ int[] data = { 1, 2, 3, 4, 5 }; Span&lt;int&gt; fromStart = data.AsSpan().Reverse(1..4); // [ 1, 4, 3, 2,
