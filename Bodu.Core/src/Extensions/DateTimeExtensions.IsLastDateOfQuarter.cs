// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.IsLastDateOfQuarter.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Determines whether the specified <see cref="DateTime" /> falls on the last day of its calendar quarter, using
    /// the standard calendar quarter definition.
    /// </summary>
    /// <param name="dateTime">The date and time value to evaluate.</param>
    /// <returns>
    /// <see langword="true" /> if <paramref name="dateTime" /> represents the last day of its quarter; otherwise,
    /// <see langword="false" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true" /> if <paramref name="dateTime" /> represents the last day of its quarter under
    ...
    /// <summary>
    /// Determines whether the specified <see cref="DateTime" /> falls on the last day of its calendar quarter, using a
    ...
    /// </param>
    /// <returns>
    /// <see langword="true" /> if <paramref name="dateTime" /> represents the last day of its quarter as defined by
