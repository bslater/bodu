// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.PreviousWeekday.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateTimeExtensions
{
    ...
    /// </param>
    /// <returns>
    /// An object whose value is set to the first calendar day before <paramref name="dateTime" /> that is a working day
    ...
    /// <remarks>
    /// <para>
    /// The method evaluates each preceding day prior to <paramref name="dateTime" /> until it finds one that is a
    ...
    /// </param>
    /// <returns>
    /// The first calendar day strictly before <paramref name="dateTime" /> whose day-of-week is selected in
