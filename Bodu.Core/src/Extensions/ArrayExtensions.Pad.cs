// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ArrayExtensions.Pad.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Returns a new array of length <paramref name="totalLength"/> whose trailing elements are the
    /// contents of <paramref name="array"/> and whose leading positions are filled with
    /// <paramref name="padValue"/>.
    /// </summary>
    ...
    /// <returns>
    /// A new array of length <paramref name="totalLength"/>. When
    /// <paramref name="totalLength"/> equals <c>array.Length</c> the result is a fresh copy of
    /// <paramref name="array"/> with no padding.
    /// </returns>
    ...
    /// <summary>
    /// Returns a new array of length <paramref name="totalLength"/> whose leading elements are the
    /// contents of <paramref name="array"/> and whose trailing positions are filled with
    /// <paramref name="padValue"/>.
    /// </summary>
    /// <typeparam name="T">The element type of the array.</typeparam>
