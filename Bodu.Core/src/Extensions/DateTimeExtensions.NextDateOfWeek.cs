// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeExtensions.NextDateOfWeek.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateTimeExtensions
{
    ...
    /// <see cref="DayOfWeek" /> after the given <paramref name="dateTime" />.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    /// An object whose value is set to the next occurrence of <paramref name="dayOfWeek" /> following
