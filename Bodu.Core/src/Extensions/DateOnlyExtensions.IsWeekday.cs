// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.IsWeekday.cs" company="Bodu Pty. Ltd.">
...
public static partial class DateOnlyExtensions
{
    ...
    /// <returns>
    /// <see langword="true" /> if <paramref name="date" /> does not fall on Saturday or Sunday; otherwise,
    /// <see langword="false" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// <summary>
    /// Determines whether the specified <see cref="DateOnly" /> falls on a weekday, using the supplied
    ...
    /// </param>
    /// <returns>
    /// <see langword="true" /> if <paramref name="date" /> is not a weekend under the supplied rule or provider;
    /// otherwise, <see langword="false" />.
    /// </returns>
    /// <remarks>
    /// <para>
    /// The method evaluates whether the <see cref="DateOnly.DayOfWeek" /> of <paramref name="date" /> is included in
    /// the working-week pattern supplied by <paramref name="workingWeek" /> and optionally refined by
