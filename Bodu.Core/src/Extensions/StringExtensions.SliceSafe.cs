...
{
    /// <summary>
    /// Returns the substring of <paramref name="value" /> starting at <paramref name="startIndex" />,
    /// clamping out-of-range indices instead of throwing.
    /// </summary>
    ...
    /// <returns>
    /// The substring beginning at the clamped <paramref name="startIndex" />. Returns the original instance
    /// when <paramref name="startIndex" /> is zero or negative; returns <see cref="string.Empty" /> when
    ...
    /// <summary>
    /// Returns a substring of <paramref name="value" /> starting at <paramref name="startIndex" /> with the
    /// requested <paramref name="length" />, clamping out-of-range arguments instead of throwing.
    /// </summary>
    /// <param name="value">The source string. Must not be <see langword="null" />.</param>
    /// <param name="startIndex">The zero-based starting index. Negative values clamp to zero.</param>
    /// <param name="length">
    /// The maximum number of characters to take. Negative values produce an empty string. The actual length
    /// returned is clamped to the remaining characters in <paramref name="value" />.
    /// </param>
    /// <returns>
    /// The substring starting at the clamped <paramref name="startIndex" /> of at most
