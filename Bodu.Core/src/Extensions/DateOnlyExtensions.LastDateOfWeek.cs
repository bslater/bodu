// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.LastDateOfWeek.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> representing the last day of the week that contains the specified
    /// <paramref name="date" />, using the last day of the week defined by <see cref="CultureInfo.CurrentCulture" />.
    /// </summary>
    /// <param name="date">The date value used to determine the containing week.</param>
    /// <returns>
    /// A <see cref="DateOnly" /> value set to the culturally defined last day of the week containing
    /// <paramref name="date" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> representing the last day of the week that contains the specified
    /// <paramref name="date" />, using the last day of the week defined by the supplied or current culture.
    /// </summary>
    /// <param name="date">The date value used to determine the containing week.</param>
    /// <param name="culture">
    ...
    /// <remarks>
    /// <para>
    /// This method computes the day offset between <paramref name="date" /> and the culture-specific last day of the
    /// week, and adds that offset.
    /// </para>
    /// </remarks>
    /// <exception cref="ArgumentOutOfRangeException">
    /// Thrown if the resulting date is later than <see cref="DateOnly.MaxValue" />.
    /// </exception>
    ...
    /// </param>
    /// <returns>
    /// A <see cref="DateOnly" /> value set to the last day of the week containing <paramref name="date" />.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// resulting date is later than <see cref="DateOnly.MaxValue" />.
    /// </exception>
