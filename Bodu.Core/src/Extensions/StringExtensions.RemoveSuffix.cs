...
{
    /// <summary>
    /// Returns <paramref name="value" /> with a single trailing occurrence of <paramref name="suffix" />
    ...
    /// The comparison rule used to detect <paramref name="suffix" /> at the end of
    /// <paramref name="value" />. Defaults to <see cref="StringComparison.Ordinal" />.
    /// </param>
    /// <returns>
    /// <paramref name="value" /> without the trailing <paramref name="suffix" /> when present; otherwise the
    /// original instance.
    /// </returns>
