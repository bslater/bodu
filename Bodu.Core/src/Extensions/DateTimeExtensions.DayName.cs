...
public static partial class DateTimeExtensions
{
    ...
    /// <returns>A <see cref="string"/> containing the localized full day name, formatted using <see cref="CultureInfo.CurrentCulture"/>.</returns>
    /// <remarks>
    ...
    /// <returns>A <see cref="string"/> containing the localized full day name for <paramref name="dateTime"/>, formatted using the supplied or current culture.</returns>
    /// <remarks>
