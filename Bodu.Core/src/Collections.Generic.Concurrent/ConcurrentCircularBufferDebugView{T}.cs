// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ConcurrentCircularBufferDebugView{T}.cs" company="Bodu Pty. Ltd.">
...
/// <see cref="ConcurrentCircularBuffer{T}.ToArray" /> each time the debugger expands the items. The snapshot is stable
/// for inspection but is not synchronized with concurrent producers or consumers.
/// </remarks>
