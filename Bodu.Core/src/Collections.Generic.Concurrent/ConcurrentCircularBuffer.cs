// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ConcurrentCircularBuffer.cs" company="Bodu Pty. Ltd.">
...
/// Subscribers that need to react to a throwing handler should perform their own catch/log in the handler body.
/// </para>
/// <para>
