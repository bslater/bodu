...
public static partial class SequenceGenerator
{
    ...
    /// </remarks>
    /// <example>
    /// <code language="csharp"> // Generate the first five powers of two by zipping a counter against a constant feed.
    ...
    /// </remarks>
    /// <example>
    /// <code language="csharp"> var dashes = string.Concat(SequenceGenerator.Repeat('-', 5)); // => "-----" var padding
