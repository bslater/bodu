...
public static partial class SequenceGenerator
{
    ...
    /// </remarks>
    /// <example>
    /// <code language="csharp"> foreach (int n in SequenceGenerator.Range(10, 14)) Console.Write($"{n} "); // => 10 11
    ...
    /// </remarks>
    /// <example>
    /// <code language="csharp"> foreach (int n in SequenceGenerator.Range(0, 20, 5)) Console.Write($"{n} "); // => 0 5
    ...
    /// </remarks>
    /// <example>
    /// <code language="csharp"> foreach (long n in SequenceGenerator.Range(1_000_000_000_000L, 4)) Console.Write($"{n}
