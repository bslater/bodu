...
public static partial class SequenceGenerator
{
    ...
    /// </remarks>
    /// <example>
    /// <code language="csharp"> // Halving sequence — terminates when the value drops to zero. var halves =
    ...
    /// </remarks>
    /// <example>
    /// <code language="csharp"> // Triangular numbers up to 100: 0, 1, 3, 6, 10, 15, 21, 28, 36, 45, 55, 66, 78, 91.
    ...
    /// </remarks>
    /// <example>
    /// <code language="csharp"> // Fibonacci numbers below 100, tracked through a (prev, curr) state record. var fib =
