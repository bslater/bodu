// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OrderedSetStorageDebugView.cs" company="PlaceholderCompany">
    ...
    where T : notnull
{
    ...
    /// </summary>
    /// <remarks>
    /// This property is hidden from the debugger display root to directly expand the ordered items for quick inspection.
    /// </remarks>
