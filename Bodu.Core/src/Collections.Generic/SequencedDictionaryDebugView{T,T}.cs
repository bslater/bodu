...
/// <summary>
/// Provides a debugger view for <see cref="SequencedDictionary{TKey, TValue}" /> that displays the dictionary's
/// key/value pairs, in iteration order, directly in the debugger.
/// </summary>
    ...
    where TKey : notnull
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SequencedDictionaryDebugView{TKey, TValue}" /> class for the
