    ...
    where T : IComparable<T>
{
    ...
    internal static void ValidateRange(T startInclusive, T endExclusive, IComparer<T> comparer)
    {
        ...
        if (comparer.Compare(startInclusive, endExclusive) >= 0) throw new ArgumentException(ResourceStrings.Arg_Invalid_RangeStartNotLessThanEnd, nameof(startInclusive));
    }
}
