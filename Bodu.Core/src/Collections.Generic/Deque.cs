// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Deque.cs" company="Bodu Pty. Ltd.">
    ...
    : RingBackedCollection<T>
{
    ...
    public void AddFirst(T item)
    {
        if (Count == Capacity)
        {
            if (!AllowGrow) throw new InvalidOperationException(ResourceStrings.Op_Invalid_CapacityExhausted);
    ...
    public T RemoveFirst() => Count == 0 ? throw new InvalidOperationException(ResourceStrings.Op_Invalid_EmptySequence) : RemoveHead();
    ...
    /// <exception cref="InvalidOperationException">The deque is empty.</exception>
    public T RemoveLast() => Count == 0 ? throw new InvalidOperationException(ResourceStrings.Op_Invalid_EmptySequence) : RemoveTail();
    ...
    /// <exception cref="InvalidOperationException">The deque is empty.</exception>
    public T PeekFirst() => Count == 0 ? throw new InvalidOperationException(ResourceStrings.Op_Invalid_CollectionEmpty) : PeekHead();
    ...
    /// <exception cref="InvalidOperationException">The deque is empty.</exception>
    public T PeekLast() => Count == 0 ? throw new InvalidOperationException(ResourceStrings.Op_Invalid_CollectionEmpty) : PeekTail();
