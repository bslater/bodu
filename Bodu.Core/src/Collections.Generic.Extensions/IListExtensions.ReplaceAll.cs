...
public static partial class IListExtensions
{
    ...
    /// </exception>
    /// <remarks>
    /// Elements are assigned in place through the list's indexer; no insertions or removals are
    /// performed, so the list size and the relative position of every element are preserved.
    /// </remarks>
    ...
    /// <summary>
    /// Replaces every occurrence of <paramref name="oldItem"/> in the <see cref="IList{T}"/> with
    /// <paramref name="newItem"/>, using the supplied <see cref="IEqualityComparer{T}"/> to compare
    /// elements.
    /// </summary>
    /// <typeparam name="TSource">The type of the elements in the list.</typeparam>
    /// <param name="list">The list to modify in place. Must not be <see langword="null"/>.</param>
    ...
    /// <param name="newItem">The replacement value.</param>
    /// <param name="comparer">
    /// The equality comparer used to locate occurrences of <paramref name="oldItem"/>. When
    /// <see langword="null"/>, <see cref="EqualityComparer{T}.Default"/> is used.
    /// </param>
    /// <returns>The number of elements that were replaced.</returns>
    /// <exception cref="ArgumentNullException">
    /// <paramref name="list"/> is <see langword="null"/>.
    ...
    /// <summary>
    /// Replaces every element in the <see cref="IList{T}"/> that satisfies the specified predicate
    /// with <paramref name="newItem"/>.
    /// </summary>
    /// <typeparam name="TSource">The type of the elements in the list.</typeparam>
    /// <param name="list">The list to modify in place. Must not be <see langword="null"/>.</param>
    ...
    /// </exception>
    /// <remarks>
    /// The list is walked once with a fixed length captured before iteration begins. Predicate matches
    /// against <paramref name="newItem"/> do not cause additional passes or infinite recursion: a slot
