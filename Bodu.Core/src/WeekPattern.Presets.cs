// ---------------------------------------------------------------------------------------------------------------
// <copyright file="WeekPattern.Presets.cs" company="Bodu Pty. Ltd.">
...
#pragma warning disable IDE1006
    ...
    /// <summary>Represents a working-week <see cref="WeekPattern" /> with Monday through Friday selected.</summary>
    /// <remarks>
    ...
    /// <summary>Represents a working-week <see cref="WeekPattern" /> with Monday through Saturday selected.</summary>
    /// <remarks>
    ...
    /// <summary>Represents a working-week <see cref="WeekPattern" /> with Monday through Thursday and Saturday selected.</summary>
    /// <remarks>
    ...
    /// <summary>Represents a working-week <see cref="WeekPattern" /> with Saturday through Thursday selected.</summary>
    /// <remarks>
    ...
    /// <summary>Represents a working-week <see cref="WeekPattern" /> with Saturday through Wednesday selected.</summary>
    /// <remarks>
    ...
    /// <summary>Represents a working-week <see cref="WeekPattern" /> with Sunday through Friday selected.</summary>
    /// <remarks>
    ...
    /// <summary>Represents a working-week <see cref="WeekPattern" /> with Sunday through Thursday selected.</summary>
    /// <remarks>
    ...
    /// <summary>Represents a working-week <see cref="WeekPattern" /> with every day of the week selected.</summary>
    /// <remarks>
