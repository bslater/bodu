// ---------------------------------------------------------------------------------------------------------------
// <copyright file="WeekPattern.Formatting.cs" company="PlaceholderCompany">
...
public partial struct WeekPattern : System.IFormattable
{
    ...
    /// </summary>
    /// <returns>
    /// A seven-character string in Sunday-to-Saturday order where each selected day is represented by its
    /// initial letter and each unselected day by <c>'_'</c>.
    /// </returns>
    ...
    /// <list type="bullet">
    /// <item><description><c>'S'</c> or <c>'s'</c> — Sunday-to-Saturday; unselected = <c>'_'</c>.</description></item>
    /// <item><description><c>'M'</c> or <c>'m'</c> — Monday-to-Sunday; unselected = <c>'_'</c>.</description></item>
    /// <item>
    /// <description>
    /// <c>'E'</c>, <c>'U'</c>, <c>'D'</c>, <c>'A'</c> — Sunday-to-Saturday with space, underscore, dash,
    /// or asterisk for unselected days respectively.
    /// </description>
    /// </item>
    /// <item><description><c>'0'</c>, <c>'1'</c>, <c>'B'</c>, or <c>"01"</c> — Binary: <c>'1'</c> selected, <c>'0'</c> unselected.</description></item>
    /// <item>
    /// <description>
    /// Two-character format: first character <c>'S'</c> or <c>'M'</c> for day ordering; second character
    /// <c>'E'</c>, <c>'U'</c>, <c>'D'</c>, or <c>'A'</c> for the unselected placeholder.
    /// </description>
    /// </item>
    /// </list>
    /// </param>
