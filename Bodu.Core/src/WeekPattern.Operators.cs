// --------------------------------------------------------------------------------------------------------------- //
// <copyright file="WeekPattern.Operators.cs" company="PlaceholderCompany">
...
public partial struct WeekPattern
{
    ...
    /// <summary>
    /// Returns a new <see cref="WeekPattern"/> containing only the days selected in exactly one of the
    /// two operands (symmetric difference).
    /// </summary>
    /// <param name="left">The first operand.</param>
    /// <param name="right">The second operand.</param>
    /// <returns>A <see cref="WeekPattern"/> whose selected days are those that differ between the two operands.</returns>
    public static WeekPattern operator ^(WeekPattern left, WeekPattern right) =>
        new WeekPattern(left._selectedDays ^ right._selectedDays);
