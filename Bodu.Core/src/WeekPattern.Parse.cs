...
public partial struct WeekPattern
{
    ...
    /// </exception>
    /// <remarks>
    /// The format is inferred from the length and character patterns of the input. For unambiguous parsing, use
    /// <see cref="ParseExact(string, string)" /> with an explicit format string.
    /// </remarks>
