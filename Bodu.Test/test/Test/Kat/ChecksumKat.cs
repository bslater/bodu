...
/// <param name="ExpectedValue">The expected checksum value, widened to <see cref="ulong" /> so the same record fits 8/16/32/64-bit checksums.</param>
/// <param name="Width">The checksum width in bits.</param>
/// <param name="Parameters">An optional opaque payload describing variant parameters (polynomial, initial value, refIn/refOut flags) consumed by the test runner.</param>
