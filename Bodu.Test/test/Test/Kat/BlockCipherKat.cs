...
/// <summary>
/// Represents a single known-answer test row for a symmetric block cipher in its raw block-encryption
/// shape (no mode, no padding): the key, the plaintext block, and the ciphertext the cipher must produce.
/// </summary>
