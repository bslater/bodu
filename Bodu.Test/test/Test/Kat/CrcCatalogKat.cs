...
/// <summary>
/// Represents a RevEng-style CRC catalogue row carrying every parameter required to fully describe a CRC
/// variant: width, polynomial, initial value, reflect-in/reflect-out flags, final XOR mask, and the
/// reference <see cref="Check" /> value computed for the canonical input <c>"123456789"</c>.
/// </summary>
...
/// <param name="Check">The reference CRC value over the ASCII string <c>"123456789"</c>, used as the canonical conformance vector for every catalogue entry.</param>
