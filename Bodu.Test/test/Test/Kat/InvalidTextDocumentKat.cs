...
/// <summary>
/// Represents a negative-vector known-answer test row for a parse/format text-document format: a raw
/// source string that the parser must reject, paired with the exception type the throwing overload must
/// raise.
/// </summary>
