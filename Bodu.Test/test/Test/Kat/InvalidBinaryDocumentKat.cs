...
/// <summary>
/// Represents a known-failure row for a binary-document decoder. The decoder must reject
/// <see cref="Payload" /> by throwing <see cref="ExceptionType" />; the optional
/// <see cref="MessageContains" /> substring lets tests assert a specific diagnostic phrase.
/// </summary>
...
/// <param name="MessageContains">An optional substring the exception message must contain; <see langword="null" /> skips the message check.</param>
