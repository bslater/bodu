...
/// <summary>
/// Represents a known-answer test row for a calendar range-resolution scenario: a date range, a territory and calendar
/// identifier, the rule names to evaluate, and the expected actual-date and optional observed-date sequences the
...
/// <param name="ExpectedObservedDates">
/// The expected observed dates when an adjustment rule applies. <see langword="null" /> when no adjustments are
/// expected; otherwise matches <see cref="ExpectedDates" /> in length.
/// </param>
