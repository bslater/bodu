// ---------------------------------------------------------------------------------------------------------------
// <copyright file="GuardInvalidKat{T}.cs" company="Bodu Pty. Ltd.">
...
/// <c>ThrowHelper.ThrowIfEqual&lt;T&gt;(value, other)</c>) where the operand pair is expected to cause the guard to
/// throw <see cref="ExceptionType" />, optionally with a specific <see cref="ParamName" />.
/// </summary>
