// ---------------------------------------------------------------------------------------------------------------
// <copyright file="InvalidKat{T}.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Represents a known-answer test row whose <see cref="Input" /> is expected to cause the system under test to throw
/// <see cref="ExceptionType" />, optionally with a specific <see cref="ParamName" /> or message substring.
/// </summary>
