// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ExchangeRateBookExtensionsTests.ToFixedProvider.cs" company="Bodu Pty. Ltd.">
...
public partial class ExchangeRateBookExtensionsTests
{
    ...
    public void ToFixedProvider_WhenBookIsNull_ShouldThrowArgumentNullException()
    {
        ExceptionAssert.ThrowsExactlyWithParamName<ArgumentNullException>(
            () =>
            {
                _ = ((ExchangeRateBook)null!).ToFixedProvider();
            },
            "book");
        ...
        ExceptionAssert.ThrowsExactlyWithParamName<ArgumentNullException>(
            () =>
            {
                _ = ((ExchangeRateBook)null!).ToFixedProvider(["RBA"]);
            },
            "book");
    }
    ...
    public void ToFixedProvider_WhenSingleProviderBook_ShouldResolveRates()
    {
        ...
        FixedDatedExchangeRateProvider provider = book.ToFixedProvider();

        Assert.IsTrue(provider.TryGetRate("USD", "AUD", new DateOnly(2024, 1, 1), null, out ExchangeRateLookupResult result));
    ...
    {
        ExchangeRateBook book = new([Series("RBA", 1.5m), Series("ECB", 1.51m)]);
    ...
    public void ToFixedProvider_WhenPrioritySupplied_ShouldResolveFromFirstMatchingProvider()
    {
        ...
        FixedDatedExchangeRateProvider provider = book.ToFixedProvider(["ECB", "RBA"]);
