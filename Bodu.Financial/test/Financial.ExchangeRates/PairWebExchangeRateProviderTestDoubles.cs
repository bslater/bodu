    ...
    : PairWebExchangeRateProvider<string>
{
    ...
    public TestPairWebExchangeRateProvider(IPairRateSource<string> source, WebExchangeRateProviderOptions options, Microsoft.Extensions.Logging.ILogger? logger = null)
