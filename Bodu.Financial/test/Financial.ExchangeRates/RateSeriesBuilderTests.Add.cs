// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateSeriesBuilderTests.Add.cs" company="Bodu Pty. Ltd.">
...
public partial class RateSeriesBuilderTests
{
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuilder.TryAdd" /> reports success and inserts when the date is new.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuilder.TryAdd" /> reports failure and leaves the existing rate
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuilder.TryAdd" /> validates the rate before checking the date.
    /// </summary>
    [TestMethod]
