// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateSeriesBufferTests.AddRange.cs" company="Bodu Pty. Ltd.">
...
public partial class RateSeriesBufferTests
{
    ...
    public void AddRange_WhenIncomingEmptyOnEmptyBuffer_ShouldRemainEmpty()
    {
        ...
        buffer.AddRange(Array.Empty<RateObservation>(), ObservationsParam);
    ...
    public void AddRange_WhenIncomingEmptyOnPopulatedBuffer_ShouldLeaveBufferUnchanged()
    {
        ...
        RateObservation[] before = buffer.Enumerate().ToArray();
    ...
    {
        RateSeriesBuffer buffer = NewBufferWith((1000, 1.4m), (1020, 1.6m), (1040, 1.8m));
        RateObservation[] batch =
        [
            new(DateOnly.FromDayNumber(1010), 1.5m),
    ...
    {
        RateSeriesBuffer buffer = NewBufferWith((1020, 1.6m), (1030, 1.7m));
        RateObservation[] batch =
        [
            new(DateOnly.FromDayNumber(1000), 1.4m),
            new(DateOnly.FromDayNumber(1010), 1.5m),
