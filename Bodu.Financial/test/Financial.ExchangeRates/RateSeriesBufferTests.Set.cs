// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateSeriesBufferTests.Set.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuffer.Set" /> overwrites the rate for a present day number.
    /// </summary>
    [TestMethod]
    public void Set_WhenDayExists_ShouldReplaceRate()
    {
        RateSeriesBuffer buffer = NewBufferWith((1000, 1.5m), (1010, 1.6m));
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuffer.Set" /> on a missing day number throws
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuffer.TrySet" /> updates and returns <see langword="true" /> for
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuffer.TrySet" /> returns <see langword="false" /> for a missing
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuffer.TrySet" /> validates the rate before checking the day
    /// number.
    /// </summary>
    [TestMethod]
