// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateSeriesBufferTests.Remove.cs" company="Bodu Pty. Ltd.">
...
public partial class RateSeriesBufferTests
{
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuffer.Contains" /> reports <see langword="true" /> for a present
