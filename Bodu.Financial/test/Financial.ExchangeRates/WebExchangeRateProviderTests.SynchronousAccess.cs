// ---------------------------------------------------------------------------------------------------------------
// <copyright file="WebExchangeRateProviderTests.SynchronousAccess.cs" company="Bodu Pty. Ltd.">
...
public partial class WebExchangeRateProviderTests
{
    ...
    public void GetRates_WhenSynchronousAccessOnCapturedContext_ShouldThrowInvalidOperationException()
    {
        ...
        try
        {
            ...
            using var provider = new TestSyncEnabledWebExchangeRateProvider();
    ...
    /// <summary>
    /// A <see cref="WebExchangeRateProvider" /> test double with opt-in synchronous network access enabled and an
    ...
    /// </summary>
    private sealed class TestSyncEnabledWebExchangeRateProvider
        : WebExchangeRateProvider
    {
        ...
        public TestSyncEnabledWebExchangeRateProvider()
