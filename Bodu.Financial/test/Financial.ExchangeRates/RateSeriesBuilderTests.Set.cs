// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateSeriesBuilderTests.Set.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuilder.Set" /> overwrites the rate for an existing date.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuilder.Set" /> on an unknown date throws
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuilder.Set" /> validates the rate.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuilder.TrySet" /> overwrites and returns <see langword="true" />
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuilder.TrySet" /> returns <see langword="false" /> when the date
    ...
    /// <summary>
    /// Verifies that <see cref="RateSeriesBuilder.TrySet" /> validates the rate.
    /// </summary>
    [TestMethod]
