// ---------------------------------------------------------------------------------------------------------------
// <copyright file="FixedDatedRateProviderTests.GetRatesAsync.cs" company="Bodu Pty. Ltd.">
...
public partial class FixedDatedRateProviderTests
{
    ...
    public void GetRates_WhenObservationsInRange_ShouldReportRequestedWindowAndObservedSpan()
    {
        ...
        RateRangeResult result = table.GetRates("USD", "AUD", new DateOnly(2024, 1, 1), new DateOnly(2024, 1, 8));
    ...
    public void GetRates_WhenPairAbsent_ShouldReportEmptyWithNullObservedSpan()
    {
        ...
        RateRangeResult result = table.GetRates("EUR", "JPY", new DateOnly(2024, 1, 1), new DateOnly(2024, 1, 31));
