// ---------------------------------------------------------------------------------------------------------------
// <copyright file="FixedDatedRateProviderTests.Inverse.cs" company="Bodu Pty. Ltd.">
...
public partial class FixedDatedRateProviderTests
{
    ...
    public void TryGetRate_WhenInverseFallbackTaken_ShouldReportInvertedDirectionAndReciprocalRate()
    {
        ...
        FixedDatedRateProvider table = new(direct);
    ...
    public void TryGetRate_WhenDirectFailsToleranceButInversePasses_ShouldUseInverse()
    {
        ...
        var previousTwoDays = RateLookupOptions.PreviousWithin(2);
