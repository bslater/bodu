// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ExchangeRateDateResolutionKat.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Represents a single known-answer test row exercising <see cref="ExchangeRateSeries.TryGetRate" /> over a synthetic
...
/// <param name="ToleranceDays">The tolerance value supplied through <see cref="ExchangeRateLookupOptions" />.</param>
/// <param name="AvailableDates">The observation dates in the series under test.</param>
/// <param name="ExpectedDate">The expected resolved date, or <see langword="null" /> when <paramref name="ExpectedSuccess" /> is <see langword="false" />.</param>
/// <param name="ExpectedSuccess"><see langword="true" /> when the lookup should succeed; otherwise <see langword="false" />.</param>
public sealed record ExchangeRateDateResolutionKat(
    string Name,
