// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateSeriesKat.cs" company="Bodu Pty. Ltd.">
...
/// <param name="Options">The lookup options supplied to <see cref="RateSeries.TryGetRate" />.</param>
...
/// </param>
public sealed record RateSeriesKat(
    string Name,
    CurrencyPair Pair,
    string Provider,
