// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateLookupKat.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Represents a known-answer test row exercising a full <see cref="FixedDatedRateProvider.TryGetRate" /> call,
...
public sealed record RateLookupKat(
    string Name,
    string FromIsoCode,
    string ToIsoCode,
