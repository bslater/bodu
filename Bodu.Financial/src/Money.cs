...
/// the shipped tag types in <c>Bodu.Financial.Currencies</c> (for example, <c>Money&lt;Bodu.Financial.Currencies.USD&gt;</c>).
/// </typeparam>
/// <remarks>
/// <para>
...
/// calculation in <see cref="Bodu.Numerics.Fraction{T}" /> via <see cref="ToFraction" />, then snap to
