...
/// <see cref="RateSeriesBuilder" />; the type itself does not validate the value because it is also used as a
...
/// invariants; values constructed in isolation (including <see langword="default" /><c>(RateObservation)</c>)
