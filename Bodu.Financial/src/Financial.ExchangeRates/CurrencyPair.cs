// ---------------------------------------------------------------------------------------------------------------
// <copyright file="CurrencyPair.cs" company="Bodu Pty. Ltd.">
...
public readonly record struct CurrencyPair
{
    ...
    /// </summary>
    /// <returns>A new <see cref="CurrencyPair" /> describing the reverse-direction quotation.</returns>
    public CurrencyPair Inverse() => new(To, From);
}
