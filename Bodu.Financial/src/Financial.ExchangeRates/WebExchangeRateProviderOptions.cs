// ---------------------------------------------------------------------------------------------------------------
// <copyright file="WebExchangeRateProviderOptions.cs" company="Bodu Pty. Ltd.">
...
/// </para>
/// </remarks>
public abstract class WebExchangeRateProviderOptions
{
    /// <summary>
    ...
    public bool TryValidate(out string? error)
    {
        ...
        {
            error = FinancialResourceStrings.Arg_Invalid_WebExchangeRateOptionsBaseAddress;
            return false;
        }

        if (HttpTimeout <= TimeSpan.Zero)
        {
            error = FinancialResourceStrings.Arg_Invalid_WebExchangeRateOptionsHttpTimeout;
            return false;
        }

        if (DefaultLookback <= TimeSpan.Zero)
        {
            error = FinancialResourceStrings.Arg_Invalid_WebExchangeRateOptionsDefaultLookback;
            return false;
        }

        if (CurrencyAliases is null)
        {
            error = FinancialResourceStrings.Arg_Invalid_WebExchangeRateOptionsCurrencyAliases;
            return false;
        }

        if (!AreLogLevelsDefined())
        {
            error = FinancialResourceStrings.Arg_Invalid_WebExchangeRateOptionsLogLevel;
            return false;
        }
