// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateRangeResult.cs" company="Bodu Pty. Ltd.">
...
/// </para>
/// </remarks>
public sealed class RateRangeResult
    : IReadOnlyList<ExchangeRate>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RateRangeResult" /> class.
    /// </summary>
