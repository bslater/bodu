// ---------------------------------------------------------------------------------------------------------------
// <copyright file="WebExchangeRateProviderLog.cs" company="Bodu Pty. Ltd.">
...
/// <see cref="PairWebExchangeRateProvider{TSeries}" /> while fetching and serving exchange rates.
/// </summary>
/// <remarks>
...
/// formatted.
/// </remarks>
internal static partial class WebExchangeRateProviderLog
{
    /// <summary>
