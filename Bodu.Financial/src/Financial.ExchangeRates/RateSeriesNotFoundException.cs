...
/// </remarks>
public sealed class RateSeriesNotFoundException
    : KeyNotFoundException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RateSeriesNotFoundException" /> class.
    /// </summary>
    public RateSeriesNotFoundException()
    {
    }
    ...
    public RateSeriesNotFoundException(string message, Exception innerException)
