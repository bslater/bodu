// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IHistoryAwareExchangeRateProvider.cs" company="Bodu Pty. Ltd.">
...
/// <remarks>
/// <para>
/// This is an optional capability interface layered over <see cref="IDatedExchangeRateProvider" />, following the same
/// probe-at-runtime idiom as <see cref="IExchangeRatePairLoader" />: consumers test a provider with
/// <see langword="is" /> and treat one that does not implement the interface as
/// <see cref="ExchangeRateHistoryAvailability.Unbounded" /> — never skipped and never clamped. Implementing the
...
/// <see cref="IExchangeRateProvider" /> latest-rate surface is unaffected.
/// </para>
/// </remarks>
public interface IHistoryAwareExchangeRateProvider
{
    /// <summary>
    /// Gets the history depth this provider advertises: how far back it can serve rates.
    /// </summary>
    /// <value>
    /// The advertised availability. <see cref="ExchangeRateHistoryAvailability.Unbounded" /> declares no known floor.
    /// </value>
    ExchangeRateHistoryAvailability HistoryAvailability { get; }
}
