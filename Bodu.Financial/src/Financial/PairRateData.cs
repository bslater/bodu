// ---------------------------------------------------------------------------------------------------------------
// <copyright file="PairRateData.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Represents the normalized result an <see cref="IExchangeRatePairSource{TSeries}" /> produces for one fetch: the
