// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ExchangeRatePairRequest.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Describes a single pair-based fetch request issued to an <see cref="IExchangeRatePairSource{TSeries}" />: the
...
/// </remarks>
public readonly record struct ExchangeRatePairRequest(ExchangeRatePair Pair, DateOnly StartDate, DateOnly EndDate);
