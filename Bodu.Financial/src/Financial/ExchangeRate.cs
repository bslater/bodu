...
public readonly record struct ExchangeRate
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ExchangeRate" /> class. Initializes a new instance of the
    /// <see cref="ExchangeRate" /> struct.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ExchangeRate" /> class. Initializes a new instance of the
    /// <see cref="ExchangeRate" /> struct from fully resolved field values, including the underlying observed rate.
    /// </summary>
    /// <param name="from">The source currency.</param>
    /// <param name="to">The destination currency.</param>
    /// <param name="date">The calendar date on which the rate was observed.</param>
