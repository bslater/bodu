...
public enum MoneyBagConversionRoundingPolicy
{
    ...
    /// <summary>
    /// Round each converted per-currency balance to the destination currency's minor-unit precision before adding it
    /// into the total. Use this for ledger and tax workflows where each settled line must be representable at the
    /// destination precision before aggregation.
    /// </summary>
