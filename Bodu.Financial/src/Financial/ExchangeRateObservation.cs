...
/// <see cref="ExchangeRateSeriesBuilder" />; the type itself does not validate the value because it is also used as a
/// transport record in scenarios that produce default instances.
/// </param>
/// <remarks>
/// <para>
...
/// invariants; values constructed in isolation (including <see langword="default" /><c>(ExchangeRateObservation)</c>)
/// carry no validation guarantees.
/// </para>
/// </remarks>
