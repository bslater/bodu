    ...
    : IDatedExchangeRateProvider, IExchangeRateProvider, IExchangeRatePairLoader, IHistoryAwareExchangeRateProvider, IDisposable
{
    ...
    /// </summary>
    /// <returns>The current immutable <see cref="ExchangeRateBook" />; empty until the first fetch completes.</returns>
    ...
    /// <see cref="FixedDatedExchangeRateProvider(ExchangeRateBook, IEnumerable{string})" /> to apply a custom
    /// provider-priority policy, or use <see cref="ExchangeRateBook.ToBuilder" /> to edit a copy. For the
    /// ready-to-query equivalent see <see cref="GetLoadedSnapshot" />.
    /// </para>
    /// </remarks>
    public ExchangeRateBook GetLoadedBook()
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
    ...
    /// </summary>
    /// <returns>
    /// The current immutable <see cref="FixedDatedExchangeRateProvider" /> snapshot; it resolves no rates until the
    ...
    /// Its <see cref="FixedDatedExchangeRateProvider.Book" /> is the same instance <see cref="GetLoadedBook" /> returns
    /// at the same moment.
    /// </remarks>
    public FixedDatedExchangeRateProvider GetLoadedSnapshot()
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
