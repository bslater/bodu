// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Money.OfTCurrency.Properties.cs" company="Bodu Pty. Ltd.">
...
public readonly partial struct Money<TCurrency>
{
    ...
    /// </summary>
    /// <returns>
    /// <see langword="true" /> when <see cref="Amount" /> is positive; <see langword="false" /> when it is zero or
    /// negative.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    /// <see langword="true" /> when <see cref="Amount" /> is negative; <see langword="false" /> when it is zero or
    /// positive.
    /// </returns>
