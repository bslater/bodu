...
public sealed class VUV : ICurrency
{
    ...
    public static string EnglishName => "Vatu";

    /// <summary>
    /// Prevents instantiation of the <see cref="VUV" /> tag type.
    /// </summary>
    private VUV()
    {
    }
