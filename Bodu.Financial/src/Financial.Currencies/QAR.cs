...
public sealed class QAR : ICurrency
{
    ...
    public static string EnglishName => "Qatari Rial";

    /// <summary>
    /// Prevents instantiation of the <see cref="QAR" /> tag type.
    /// </summary>
    private QAR()
    {
    }
