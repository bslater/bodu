...
public sealed class NAD : ICurrency
{
    ...
    public static string EnglishName => "Namibia Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="NAD" /> tag type.
    /// </summary>
    private NAD()
    {
    }
