...
public sealed class RUB : ICurrency
{
    ...
    public static string EnglishName => "Russian Ruble";

    /// <summary>
    /// Prevents instantiation of the <see cref="RUB" /> tag type.
    /// </summary>
    private RUB()
    {
    }
