...
public sealed class HNL : ICurrency
{
    ...
    public static string EnglishName => "Lempira";

    /// <summary>
    /// Prevents instantiation of the <see cref="HNL" /> tag type.
    /// </summary>
    private HNL()
    {
    }
