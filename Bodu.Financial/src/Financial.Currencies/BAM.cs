...
public sealed class BAM : ICurrency
{
    ...
    public static string EnglishName => "Convertible Mark";

    /// <summary>
    /// Prevents instantiation of the <see cref="BAM" /> tag type.
    /// </summary>
    private BAM()
    {
    }
