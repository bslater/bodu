...
public sealed class BOB : ICurrency
{
    ...
    public static string EnglishName => "Boliviano";

    /// <summary>
    /// Prevents instantiation of the <see cref="BOB" /> tag type.
    /// </summary>
    private BOB()
    {
    }
