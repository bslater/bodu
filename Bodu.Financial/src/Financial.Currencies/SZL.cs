...
public sealed class SZL : ICurrency
{
    ...
    public static string EnglishName => "Lilangeni";

    /// <summary>
    /// Prevents instantiation of the <see cref="SZL" /> tag type.
    /// </summary>
    private SZL()
    {
    }
