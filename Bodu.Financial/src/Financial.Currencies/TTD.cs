...
public sealed class TTD : ICurrency
{
    ...
    public static string EnglishName => "Trinidad and Tobago Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="TTD" /> tag type.
    /// </summary>
    private TTD()
    {
    }
