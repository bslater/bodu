...
public sealed class KZT : ICurrency
{
    ...
    public static string EnglishName => "Tenge";

    /// <summary>
    /// Prevents instantiation of the <see cref="KZT" /> tag type.
    /// </summary>
    private KZT()
    {
    }
