...
public sealed class KRW : ICurrency
{
    ...
    public static string EnglishName => "Won";

    /// <summary>
    /// Prevents instantiation of the <see cref="KRW" /> tag type.
    /// </summary>
    private KRW()
    {
    }
