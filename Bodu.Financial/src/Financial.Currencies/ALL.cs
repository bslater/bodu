...
public sealed class ALL : ICurrency
{
    ...
    public static string EnglishName => "Lek";

    /// <summary>
    /// Prevents instantiation of the <see cref="ALL" /> tag type.
    /// </summary>
    private ALL()
    {
    }
