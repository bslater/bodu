...
public sealed class ILS : ICurrency
{
    ...
    public static string EnglishName => "New Israeli Sheqel";

    /// <summary>
    /// Prevents instantiation of the <see cref="ILS" /> tag type.
    /// </summary>
    private ILS()
    {
    }
