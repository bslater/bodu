...
public sealed class PKR : ICurrency
{
    ...
    public static string EnglishName => "Pakistan Rupee";

    /// <summary>
    /// Prevents instantiation of the <see cref="PKR" /> tag type.
    /// </summary>
    private PKR()
    {
    }
