...
public sealed class CNY : ICurrency
{
    ...
    public static string EnglishName => "Yuan Renminbi";

    /// <summary>
    /// Prevents instantiation of the <see cref="CNY" /> tag type.
    /// </summary>
    private CNY()
    {
    }
