...
public sealed class RSD : ICurrency
{
    ...
    public static string EnglishName => "Serbian Dinar";

    /// <summary>
    /// Prevents instantiation of the <see cref="RSD" /> tag type.
    /// </summary>
    private RSD()
    {
    }
