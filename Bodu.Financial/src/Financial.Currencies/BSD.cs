...
public sealed class BSD : ICurrency
{
    ...
    public static string EnglishName => "Bahamian Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="BSD" /> tag type.
    /// </summary>
    private BSD()
    {
    }
