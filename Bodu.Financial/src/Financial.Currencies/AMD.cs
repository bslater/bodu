...
public sealed class AMD : ICurrency
{
    ...
    public static string EnglishName => "Armenian Dram";

    /// <summary>
    /// Prevents instantiation of the <see cref="AMD" /> tag type.
    /// </summary>
    private AMD()
    {
    }
