...
public sealed class FKP : ICurrency
{
    ...
    public static string EnglishName => "Falkland Islands Pound";

    /// <summary>
    /// Prevents instantiation of the <see cref="FKP" /> tag type.
    /// </summary>
    private FKP()
    {
    }
