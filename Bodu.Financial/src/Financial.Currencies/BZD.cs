...
public sealed class BZD : ICurrency
{
    ...
    public static string EnglishName => "Belize Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="BZD" /> tag type.
    /// </summary>
    private BZD()
    {
    }
