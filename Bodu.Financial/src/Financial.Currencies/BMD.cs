...
public sealed class BMD : ICurrency
{
    ...
    public static string EnglishName => "Bermudian Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="BMD" /> tag type.
    /// </summary>
    private BMD()
    {
    }
