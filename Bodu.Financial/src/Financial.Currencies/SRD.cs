...
public sealed class SRD : ICurrency
{
    ...
    public static string EnglishName => "Surinam Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="SRD" /> tag type.
    /// </summary>
    private SRD()
    {
    }
