...
public sealed class MMK : ICurrency
{
    ...
    public static string EnglishName => "Kyat";

    /// <summary>
    /// Prevents instantiation of the <see cref="MMK" /> tag type.
    /// </summary>
    private MMK()
    {
    }
