...
public sealed class COP : ICurrency
{
    ...
    public static string EnglishName => "Colombian Peso";

    /// <summary>
    /// Prevents instantiation of the <see cref="COP" /> tag type.
    /// </summary>
    private COP()
    {
    }
