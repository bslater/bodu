...
public sealed class MXN : ICurrency
{
    ...
    public static string EnglishName => "Mexican Peso";

    /// <summary>
    /// Prevents instantiation of the <see cref="MXN" /> tag type.
    /// </summary>
    private MXN()
    {
    }
