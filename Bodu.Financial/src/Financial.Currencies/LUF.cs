...
public sealed class LUF : ICurrency
{
    ...
    public static string EnglishName => "Luxembourg Franc";

    /// <summary>
    /// Prevents instantiation of the <see cref="LUF" /> tag type.
    /// </summary>
    private LUF()
    {
    }
