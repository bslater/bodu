...
public sealed class KGS : ICurrency
{
    ...
    public static string EnglishName => "Som";

    /// <summary>
    /// Prevents instantiation of the <see cref="KGS" /> tag type.
    /// </summary>
    private KGS()
    {
    }
