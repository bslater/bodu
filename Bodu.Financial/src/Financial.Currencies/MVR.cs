...
public sealed class MVR : ICurrency
{
    ...
    public static string EnglishName => "Rufiyaa";

    /// <summary>
    /// Prevents instantiation of the <see cref="MVR" /> tag type.
    /// </summary>
    private MVR()
    {
    }
