...
public sealed class STN : ICurrency
{
    ...
    public static string EnglishName => "Dobra";

    /// <summary>
    /// Prevents instantiation of the <see cref="STN" /> tag type.
    /// </summary>
    private STN()
    {
    }
