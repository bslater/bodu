...
public sealed class MYR : ICurrency
{
    ...
    public static string EnglishName => "Malaysian Ringgit";

    /// <summary>
    /// Prevents instantiation of the <see cref="MYR" /> tag type.
    /// </summary>
    private MYR()
    {
    }
