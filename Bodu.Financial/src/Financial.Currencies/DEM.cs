...
/// </summary>
/// <remarks>
/// ISO 4217 numeric code <c>276</c>; minor-unit precision <c>2</c>.
...
public sealed class DEM : ICurrency
{
    ...
    public static int NumericCode => 276;
    ...
    public static string EnglishName => "Deutsche Mark";

    /// <summary>
    /// Prevents instantiation of the <see cref="DEM" /> tag type.
    /// </summary>
    private DEM()
    {
    }
