...
public sealed class KMF : ICurrency
{
    ...
    public static string EnglishName => "Comorian Franc";

    /// <summary>
    /// Prevents instantiation of the <see cref="KMF" /> tag type.
    /// </summary>
    private KMF()
    {
    }
