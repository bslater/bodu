...
public sealed class GTQ : ICurrency
{
    ...
    public static string EnglishName => "Quetzal";

    /// <summary>
    /// Prevents instantiation of the <see cref="GTQ" /> tag type.
    /// </summary>
    private GTQ()
    {
    }
