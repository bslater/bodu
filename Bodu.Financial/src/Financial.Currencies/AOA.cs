...
public sealed class AOA : ICurrency
{
    ...
    public static string EnglishName => "Kwanza";

    /// <summary>
    /// Prevents instantiation of the <see cref="AOA" /> tag type.
    /// </summary>
    private AOA()
    {
    }
