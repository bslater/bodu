...
public sealed class BBD : ICurrency
{
    ...
    public static string EnglishName => "Barbados Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="BBD" /> tag type.
    /// </summary>
    private BBD()
    {
    }
