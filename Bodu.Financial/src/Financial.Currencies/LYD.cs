...
public sealed class LYD : ICurrency
{
    ...
    public static string EnglishName => "Libyan Dinar";

    /// <summary>
    /// Prevents instantiation of the <see cref="LYD" /> tag type.
    /// </summary>
    private LYD()
    {
    }
