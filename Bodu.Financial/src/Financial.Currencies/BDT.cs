...
public sealed class BDT : ICurrency
{
    ...
    public static string EnglishName => "Taka";

    /// <summary>
    /// Prevents instantiation of the <see cref="BDT" /> tag type.
    /// </summary>
    private BDT()
    {
    }
