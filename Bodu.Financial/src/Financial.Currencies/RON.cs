...
public sealed class RON : ICurrency
{
    ...
    public static string EnglishName => "Romanian Leu";

    /// <summary>
    /// Prevents instantiation of the <see cref="RON" /> tag type.
    /// </summary>
    private RON()
    {
    }
