...
public sealed class SLE : ICurrency
{
    ...
    public static string EnglishName => "Leone";

    /// <summary>
    /// Prevents instantiation of the <see cref="SLE" /> tag type.
    /// </summary>
    private SLE()
    {
    }
