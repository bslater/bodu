...
public sealed class ESP : ICurrency
{
    ...
    public static string EnglishName => "Spanish Peseta";

    /// <summary>
    /// Prevents instantiation of the <see cref="ESP" /> tag type.
    /// </summary>
    private ESP()
    {
    }
