...
public sealed class KPW : ICurrency
{
    ...
    public static string EnglishName => "North Korean Won";

    /// <summary>
    /// Prevents instantiation of the <see cref="KPW" /> tag type.
    /// </summary>
    private KPW()
    {
    }
