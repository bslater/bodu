...
public sealed class ANG : ICurrency
{
    ...
    public static string EnglishName => "Netherlands Antillean Guilder";

    /// <summary>
    /// Prevents instantiation of the <see cref="ANG" /> tag type.
    /// </summary>
    private ANG()
    {
    }
