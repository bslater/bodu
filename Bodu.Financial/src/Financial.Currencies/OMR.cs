...
public sealed class OMR : ICurrency
{
    ...
    public static string EnglishName => "Rial Omani";

    /// <summary>
    /// Prevents instantiation of the <see cref="OMR" /> tag type.
    /// </summary>
    private OMR()
    {
    }
