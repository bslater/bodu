...
public sealed class AZN : ICurrency
{
    ...
    public static string EnglishName => "Azerbaijan Manat";

    /// <summary>
    /// Prevents instantiation of the <see cref="AZN" /> tag type.
    /// </summary>
    private AZN()
    {
    }
