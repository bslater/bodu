...
/// </summary>
/// <remarks>
/// ISO 4217 numeric code <c>978</c>; minor-unit precision <c>2</c>.
/// </remarks>
public sealed class EUR : ICurrency
{
    /// <summary>
    ...
    public static int NumericCode => 978;
    ...
    public static string EnglishName => "Euro";

    /// <summary>
    /// Prevents instantiation of the <see cref="EUR" /> tag type.
    /// </summary>
    private EUR()
    {
    }
