...
/// </summary>
/// <remarks>
/// ISO 4217 numeric code <c>192</c>; minor-unit precision <c>2</c>.
/// </remarks>
public sealed class CUP : ICurrency
{
    /// <summary>
    ...
    public static string EnglishName => "Cuban Peso";

    /// <summary>
    /// Prevents instantiation of the <see cref="CUP" /> tag type.
    /// </summary>
    private CUP()
    {
    }
