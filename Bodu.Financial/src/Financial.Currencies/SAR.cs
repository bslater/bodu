...
public sealed class SAR : ICurrency
{
    ...
    public static string EnglishName => "Saudi Riyal";

    /// <summary>
    /// Prevents instantiation of the <see cref="SAR" /> tag type.
    /// </summary>
    private SAR()
    {
    }
