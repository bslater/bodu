...
public sealed class FJD : ICurrency
{
    ...
    public static string EnglishName => "Fiji Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="FJD" /> tag type.
    /// </summary>
    private FJD()
    {
    }
