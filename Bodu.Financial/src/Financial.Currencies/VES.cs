...
public sealed class VES : ICurrency
{
    ...
    public static string EnglishName => "Bolivar Soberano";

    /// <summary>
    /// Prevents instantiation of the <see cref="VES" /> tag type.
    /// </summary>
    private VES()
    {
    }
