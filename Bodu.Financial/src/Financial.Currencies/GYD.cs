...
public sealed class GYD : ICurrency
{
    ...
    public static string EnglishName => "Guyana Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="GYD" /> tag type.
    /// </summary>
    private GYD()
    {
    }
