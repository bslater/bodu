...
public sealed class PHP : ICurrency
{
    ...
    public static string EnglishName => "Philippine Peso";

    /// <summary>
    /// Prevents instantiation of the <see cref="PHP" /> tag type.
    /// </summary>
    private PHP()
    {
    }
