...
public sealed class PAB : ICurrency
{
    ...
    public static string EnglishName => "Balboa";

    /// <summary>
    /// Prevents instantiation of the <see cref="PAB" /> tag type.
    /// </summary>
    private PAB()
    {
    }
