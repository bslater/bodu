...
public sealed class ITL : ICurrency
{
    ...
    public static string EnglishName => "Italian Lira";

    /// <summary>
    /// Prevents instantiation of the <see cref="ITL" /> tag type.
    /// </summary>
    private ITL()
    {
    }
