...
public sealed class LRD : ICurrency
{
    ...
    public static string EnglishName => "Liberian Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="LRD" /> tag type.
    /// </summary>
    private LRD()
    {
    }
