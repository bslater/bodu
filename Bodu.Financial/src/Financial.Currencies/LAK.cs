...
public sealed class LAK : ICurrency
{
    ...
    public static string EnglishName => "Lao Kip";

    /// <summary>
    /// Prevents instantiation of the <see cref="LAK" /> tag type.
    /// </summary>
    private LAK()
    {
    }
