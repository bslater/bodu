...
public sealed class JMD : ICurrency
{
    ...
    public static string EnglishName => "Jamaican Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="JMD" /> tag type.
    /// </summary>
    private JMD()
    {
    }
