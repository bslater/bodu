...
public sealed class NPR : ICurrency
{
    ...
    public static string EnglishName => "Nepalese Rupee";

    /// <summary>
    /// Prevents instantiation of the <see cref="NPR" /> tag type.
    /// </summary>
    private NPR()
    {
    }
