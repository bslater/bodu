...
public sealed class TWD : ICurrency
{
    ...
    public static string EnglishName => "New Taiwan Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="TWD" /> tag type.
    /// </summary>
    private TWD()
    {
    }
