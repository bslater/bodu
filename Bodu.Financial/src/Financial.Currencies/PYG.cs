...
public sealed class PYG : ICurrency
{
    ...
    public static string EnglishName => "Guarani";

    /// <summary>
    /// Prevents instantiation of the <see cref="PYG" /> tag type.
    /// </summary>
    private PYG()
    {
    }
