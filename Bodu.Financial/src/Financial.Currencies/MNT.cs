...
public sealed class MNT : ICurrency
{
    ...
    public static string EnglishName => "Tugrik";

    /// <summary>
    /// Prevents instantiation of the <see cref="MNT" /> tag type.
    /// </summary>
    private MNT()
    {
    }
