...
public sealed class UZS : ICurrency
{
    ...
    public static string EnglishName => "Uzbekistan Sum";

    /// <summary>
    /// Prevents instantiation of the <see cref="UZS" /> tag type.
    /// </summary>
    private UZS()
    {
    }
