...
public sealed class SDG : ICurrency
{
    ...
    public static string EnglishName => "Sudanese Pound";

    /// <summary>
    /// Prevents instantiation of the <see cref="SDG" /> tag type.
    /// </summary>
    private SDG()
    {
    }
