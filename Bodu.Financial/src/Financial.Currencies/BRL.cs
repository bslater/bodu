...
public sealed class BRL : ICurrency
{
    ...
    public static string EnglishName => "Brazilian Real";

    /// <summary>
    /// Prevents instantiation of the <see cref="BRL" /> tag type.
    /// </summary>
    private BRL()
    {
    }
