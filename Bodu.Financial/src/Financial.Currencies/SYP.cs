...
public sealed class SYP : ICurrency
{
    ...
    public static string EnglishName => "Syrian Pound";

    /// <summary>
    /// Prevents instantiation of the <see cref="SYP" /> tag type.
    /// </summary>
    private SYP()
    {
    }
