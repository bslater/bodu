...
public sealed class BTN : ICurrency
{
    ...
    public static string EnglishName => "Ngultrum";

    /// <summary>
    /// Prevents instantiation of the <see cref="BTN" /> tag type.
    /// </summary>
    private BTN()
    {
    }
