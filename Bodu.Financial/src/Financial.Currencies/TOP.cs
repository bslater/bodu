...
public sealed class TOP : ICurrency
{
    ...
    public static string EnglishName => "Pa’anga";

    /// <summary>
    /// Prevents instantiation of the <see cref="TOP" /> tag type.
    /// </summary>
    private TOP()
    {
    }
