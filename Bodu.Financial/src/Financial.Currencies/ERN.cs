...
public sealed class ERN : ICurrency
{
    ...
    public static string EnglishName => "Nakfa";

    /// <summary>
    /// Prevents instantiation of the <see cref="ERN" /> tag type.
    /// </summary>
    private ERN()
    {
    }
