...
public sealed class LKR : ICurrency
{
    ...
    public static string EnglishName => "Sri Lanka Rupee";

    /// <summary>
    /// Prevents instantiation of the <see cref="LKR" /> tag type.
    /// </summary>
    private LKR()
    {
    }
