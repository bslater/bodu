...
public sealed class XAF : ICurrency
{
    ...
    public static string EnglishName => "CFA Franc BEAC";

    /// <summary>
    /// Prevents instantiation of the <see cref="XAF" /> tag type.
    /// </summary>
    private XAF()
    {
    }
