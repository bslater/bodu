...
public sealed class HTG : ICurrency
{
    ...
    public static string EnglishName => "Gourde";

    /// <summary>
    /// Prevents instantiation of the <see cref="HTG" /> tag type.
    /// </summary>
    private HTG()
    {
    }
