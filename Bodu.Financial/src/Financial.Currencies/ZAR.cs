...
public sealed class ZAR : ICurrency
{
    ...
    public static string EnglishName => "Rand";

    /// <summary>
    /// Prevents instantiation of the <see cref="ZAR" /> tag type.
    /// </summary>
    private ZAR()
    {
    }
