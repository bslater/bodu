...
public sealed class GMD : ICurrency
{
    ...
    public static string EnglishName => "Dalasi";

    /// <summary>
    /// Prevents instantiation of the <see cref="GMD" /> tag type.
    /// </summary>
    private GMD()
    {
    }
