...
public sealed class IDR : ICurrency
{
    ...
    public static string EnglishName => "Rupiah";

    /// <summary>
    /// Prevents instantiation of the <see cref="IDR" /> tag type.
    /// </summary>
    private IDR()
    {
    }
