...
public sealed class EGP : ICurrency
{
    ...
    public static string EnglishName => "Egyptian Pound";

    /// <summary>
    /// Prevents instantiation of the <see cref="EGP" /> tag type.
    /// </summary>
    private EGP()
    {
    }
