...
public sealed class TMT : ICurrency
{
    ...
    public static string EnglishName => "Turkmenistan New Manat";

    /// <summary>
    /// Prevents instantiation of the <see cref="TMT" /> tag type.
    /// </summary>
    private TMT()
    {
    }
