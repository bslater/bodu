...
public sealed class MAD : ICurrency
{
    ...
    public static string EnglishName => "Moroccan Dirham";

    /// <summary>
    /// Prevents instantiation of the <see cref="MAD" /> tag type.
    /// </summary>
    private MAD()
    {
    }
