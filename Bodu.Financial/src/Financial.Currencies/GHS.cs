...
public sealed class GHS : ICurrency
{
    ...
    public static string EnglishName => "Ghana Cedi";

    /// <summary>
    /// Prevents instantiation of the <see cref="GHS" /> tag type.
    /// </summary>
    private GHS()
    {
    }
