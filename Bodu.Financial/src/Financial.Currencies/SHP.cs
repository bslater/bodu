...
public sealed class SHP : ICurrency
{
    ...
    public static string EnglishName => "Saint Helena Pound";

    /// <summary>
    /// Prevents instantiation of the <see cref="SHP" /> tag type.
    /// </summary>
    private SHP()
    {
    }
