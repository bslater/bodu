...
public sealed class WST : ICurrency
{
    ...
    public static string EnglishName => "Tala";

    /// <summary>
    /// Prevents instantiation of the <see cref="WST" /> tag type.
    /// </summary>
    private WST()
    {
    }
