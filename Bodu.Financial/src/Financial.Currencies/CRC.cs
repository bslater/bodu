...
public sealed class CRC : ICurrency
{
    ...
    public static string EnglishName => "Costa Rican Colon";

    /// <summary>
    /// Prevents instantiation of the <see cref="CRC" /> tag type.
    /// </summary>
    private CRC()
    {
    }
