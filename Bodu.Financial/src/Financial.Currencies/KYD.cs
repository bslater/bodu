...
public sealed class KYD : ICurrency
{
    ...
    public static string EnglishName => "Cayman Islands Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="KYD" /> tag type.
    /// </summary>
    private KYD()
    {
    }
