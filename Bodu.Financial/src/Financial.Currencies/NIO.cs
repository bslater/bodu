...
public sealed class NIO : ICurrency
{
    ...
    public static string EnglishName => "Cordoba Oro";

    /// <summary>
    /// Prevents instantiation of the <see cref="NIO" /> tag type.
    /// </summary>
    private NIO()
    {
    }
