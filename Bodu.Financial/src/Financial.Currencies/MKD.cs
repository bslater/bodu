...
public sealed class MKD : ICurrency
{
    ...
    public static string EnglishName => "Denar";

    /// <summary>
    /// Prevents instantiation of the <see cref="MKD" /> tag type.
    /// </summary>
    private MKD()
    {
    }
