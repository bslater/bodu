...
public sealed class MRU : ICurrency
{
    ...
    public static string EnglishName => "Ouguiya";

    /// <summary>
    /// Prevents instantiation of the <see cref="MRU" /> tag type.
    /// </summary>
    private MRU()
    {
    }
