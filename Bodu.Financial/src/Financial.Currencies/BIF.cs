...
public sealed class BIF : ICurrency
{
    ...
    public static string EnglishName => "Burundi Franc";

    /// <summary>
    /// Prevents instantiation of the <see cref="BIF" /> tag type.
    /// </summary>
    private BIF()
    {
    }
