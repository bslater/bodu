...
public sealed class HUF : ICurrency
{
    ...
    public static string EnglishName => "Forint";

    /// <summary>
    /// Prevents instantiation of the <see cref="HUF" /> tag type.
    /// </summary>
    private HUF()
    {
    }
