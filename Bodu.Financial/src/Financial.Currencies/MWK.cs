...
public sealed class MWK : ICurrency
{
    ...
    public static string EnglishName => "Malawi Kwacha";

    /// <summary>
    /// Prevents instantiation of the <see cref="MWK" /> tag type.
    /// </summary>
    private MWK()
    {
    }
