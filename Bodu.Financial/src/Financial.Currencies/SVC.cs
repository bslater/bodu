...
public sealed class SVC : ICurrency
{
    ...
    public static string EnglishName => "El Salvador Colon";

    /// <summary>
    /// Prevents instantiation of the <see cref="SVC" /> tag type.
    /// </summary>
    private SVC()
    {
    }
