...
public sealed class XCD : ICurrency
{
    ...
    public static string EnglishName => "East Caribbean Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="XCD" /> tag type.
    /// </summary>
    private XCD()
    {
    }
