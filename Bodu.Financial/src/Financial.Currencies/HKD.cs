...
public sealed class HKD : ICurrency
{
    ...
    public static string EnglishName => "Hong Kong Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="HKD" /> tag type.
    /// </summary>
    private HKD()
    {
    }
