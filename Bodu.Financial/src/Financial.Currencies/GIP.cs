...
public sealed class GIP : ICurrency
{
    ...
    public static string EnglishName => "Gibraltar Pound";

    /// <summary>
    /// Prevents instantiation of the <see cref="GIP" /> tag type.
    /// </summary>
    private GIP()
    {
    }
