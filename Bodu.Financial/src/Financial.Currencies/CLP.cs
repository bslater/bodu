...
public sealed class CLP : ICurrency
{
    ...
    public static string EnglishName => "Chilean Peso";

    /// <summary>
    /// Prevents instantiation of the <see cref="CLP" /> tag type.
    /// </summary>
    private CLP()
    {
    }
