...
public sealed class UAH : ICurrency
{
    ...
    public static string EnglishName => "Hryvnia";

    /// <summary>
    /// Prevents instantiation of the <see cref="UAH" /> tag type.
    /// </summary>
    private UAH()
    {
    }
