...
public sealed class SCR : ICurrency
{
    ...
    public static string EnglishName => "Seychelles Rupee";

    /// <summary>
    /// Prevents instantiation of the <see cref="SCR" /> tag type.
    /// </summary>
    private SCR()
    {
    }
