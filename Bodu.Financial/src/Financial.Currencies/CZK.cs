...
public sealed class CZK : ICurrency
{
    ...
    public static string EnglishName => "Czech Koruna";

    /// <summary>
    /// Prevents instantiation of the <see cref="CZK" /> tag type.
    /// </summary>
    private CZK()
    {
    }
