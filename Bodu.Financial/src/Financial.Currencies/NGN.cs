...
public sealed class NGN : ICurrency
{
    ...
    public static string EnglishName => "Naira";

    /// <summary>
    /// Prevents instantiation of the <see cref="NGN" /> tag type.
    /// </summary>
    private NGN()
    {
    }
