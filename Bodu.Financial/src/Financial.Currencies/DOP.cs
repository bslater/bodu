...
public sealed class DOP : ICurrency
{
    ...
    public static string EnglishName => "Dominican Peso";

    /// <summary>
    /// Prevents instantiation of the <see cref="DOP" /> tag type.
    /// </summary>
    private DOP()
    {
    }
