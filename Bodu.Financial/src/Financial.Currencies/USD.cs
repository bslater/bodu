...
/// </summary>
/// <remarks>
/// ISO 4217 numeric code <c>840</c>; minor-unit precision <c>2</c>.
/// </remarks>
public sealed class USD : ICurrency
{
    ...
    public static int NumericCode => 840;
    ...
    public static string EnglishName => "US Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="USD" /> tag type.
    /// </summary>
    private USD()
    {
    }
