...
public sealed class RWF : ICurrency
{
    ...
    public static string EnglishName => "Rwanda Franc";

    /// <summary>
    /// Prevents instantiation of the <see cref="RWF" /> tag type.
    /// </summary>
    private RWF()
    {
    }
