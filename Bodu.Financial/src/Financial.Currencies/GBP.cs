...
/// </summary>
/// <remarks>
/// ISO 4217 numeric code <c>826</c>; minor-unit precision <c>2</c>.
/// </remarks>
public sealed class GBP : ICurrency
{
    ...
    public static int NumericCode => 826;
    ...
    public static string EnglishName => "Pound Sterling";

    /// <summary>
    /// Prevents instantiation of the <see cref="GBP" /> tag type.
    /// </summary>
    private GBP()
    {
    }
