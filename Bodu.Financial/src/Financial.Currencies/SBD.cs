...
public sealed class SBD : ICurrency
{
    ...
    public static string EnglishName => "Solomon Islands Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="SBD" /> tag type.
    /// </summary>
    private SBD()
    {
    }
