...
public sealed class MOP : ICurrency
{
    ...
    public static string EnglishName => "Pataca";

    /// <summary>
    /// Prevents instantiation of the <see cref="MOP" /> tag type.
    /// </summary>
    private MOP()
    {
    }
