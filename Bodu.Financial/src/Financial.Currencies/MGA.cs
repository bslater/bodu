...
public sealed class MGA : ICurrency
{
    ...
    public static string EnglishName => "Malagasy Ariary";

    /// <summary>
    /// Prevents instantiation of the <see cref="MGA" /> tag type.
    /// </summary>
    private MGA()
    {
    }
