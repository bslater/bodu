...
public sealed class ATS : ICurrency
{
    ...
    public static string EnglishName => "Austrian Schilling";

    /// <summary>
    /// Prevents instantiation of the <see cref="ATS" /> tag type.
    /// </summary>
    private ATS()
    {
    }
