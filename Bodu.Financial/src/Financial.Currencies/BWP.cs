...
public sealed class BWP : ICurrency
{
    ...
    public static string EnglishName => "Pula";

    /// <summary>
    /// Prevents instantiation of the <see cref="BWP" /> tag type.
    /// </summary>
    private BWP()
    {
    }
