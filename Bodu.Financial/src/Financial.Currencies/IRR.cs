...
public sealed class IRR : ICurrency
{
    ...
    public static string EnglishName => "Iranian Rial";

    /// <summary>
    /// Prevents instantiation of the <see cref="IRR" /> tag type.
    /// </summary>
    private IRR()
    {
    }
