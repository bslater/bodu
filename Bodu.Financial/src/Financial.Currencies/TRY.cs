...
public sealed class TRY : ICurrency
{
    ...
    public static string EnglishName => "Turkish Lira";

    /// <summary>
    /// Prevents instantiation of the <see cref="TRY" /> tag type.
    /// </summary>
    private TRY()
    {
    }
