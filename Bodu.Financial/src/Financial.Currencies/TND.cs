...
public sealed class TND : ICurrency
{
    ...
    public static string EnglishName => "Tunisian Dinar";

    /// <summary>
    /// Prevents instantiation of the <see cref="TND" /> tag type.
    /// </summary>
    private TND()
    {
    }
