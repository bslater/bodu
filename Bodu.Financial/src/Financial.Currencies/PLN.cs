...
public sealed class PLN : ICurrency
{
    ...
    public static string EnglishName => "Zloty";

    /// <summary>
    /// Prevents instantiation of the <see cref="PLN" /> tag type.
    /// </summary>
    private PLN()
    {
    }
