...
public sealed class KHR : ICurrency
{
    ...
    public static string EnglishName => "Riel";

    /// <summary>
    /// Prevents instantiation of the <see cref="KHR" /> tag type.
    /// </summary>
    private KHR()
    {
    }
