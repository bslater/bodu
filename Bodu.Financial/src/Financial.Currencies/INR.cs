...
public sealed class INR : ICurrency
{
    ...
    public static string EnglishName => "Indian Rupee";

    /// <summary>
    /// Prevents instantiation of the <see cref="INR" /> tag type.
    /// </summary>
    private INR()
    {
    }
