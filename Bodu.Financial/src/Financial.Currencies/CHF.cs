...
/// </summary>
/// <remarks>
/// ISO 4217 numeric code <c>756</c>; minor-unit precision <c>2</c>.
/// </remarks>
public sealed class CHF : ICurrency
{
    ...
    public static int NumericCode => 756;
    ...
    public static string EnglishName => "Swiss Franc";

    /// <summary>
    /// Prevents instantiation of the <see cref="CHF" /> tag type.
    /// </summary>
    private CHF()
    {
    }
