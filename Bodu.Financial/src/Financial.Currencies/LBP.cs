...
public sealed class LBP : ICurrency
{
    ...
    public static string EnglishName => "Lebanese Pound";

    /// <summary>
    /// Prevents instantiation of the <see cref="LBP" /> tag type.
    /// </summary>
    private LBP()
    {
    }
