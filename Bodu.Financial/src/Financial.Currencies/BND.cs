...
public sealed class BND : ICurrency
{
    ...
    public static string EnglishName => "Brunei Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="BND" /> tag type.
    /// </summary>
    private BND()
    {
    }
