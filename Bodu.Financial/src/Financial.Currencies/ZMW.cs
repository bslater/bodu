...
public sealed class ZMW : ICurrency
{
    ...
    public static string EnglishName => "Zambian Kwacha";

    /// <summary>
    /// Prevents instantiation of the <see cref="ZMW" /> tag type.
    /// </summary>
    private ZMW()
    {
    }
