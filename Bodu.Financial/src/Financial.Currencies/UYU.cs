...
public sealed class UYU : ICurrency
{
    ...
    public static string EnglishName => "Peso Uruguayo";

    /// <summary>
    /// Prevents instantiation of the <see cref="UYU" /> tag type.
    /// </summary>
    private UYU()
    {
    }
