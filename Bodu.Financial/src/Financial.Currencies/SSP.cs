...
public sealed class SSP : ICurrency
{
    ...
    public static string EnglishName => "South Sudanese Pound";

    /// <summary>
    /// Prevents instantiation of the <see cref="SSP" /> tag type.
    /// </summary>
    private SSP()
    {
    }
