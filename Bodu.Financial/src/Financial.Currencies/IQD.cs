...
public sealed class IQD : ICurrency
{
    ...
    public static string EnglishName => "Iraqi Dinar";

    /// <summary>
    /// Prevents instantiation of the <see cref="IQD" /> tag type.
    /// </summary>
    private IQD()
    {
    }
