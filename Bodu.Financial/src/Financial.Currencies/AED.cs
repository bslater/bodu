...
public sealed class AED : ICurrency
{
    ...
    public static string EnglishName => "United Arab Emirates Dirham";

    /// <summary>
    /// Prevents instantiation of the <see cref="AED" /> tag type.
    /// </summary>
    private AED()
    {
    }
