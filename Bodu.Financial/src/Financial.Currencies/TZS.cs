...
public sealed class TZS : ICurrency
{
    ...
    public static string EnglishName => "Tanzanian Shilling";

    /// <summary>
    /// Prevents instantiation of the <see cref="TZS" /> tag type.
    /// </summary>
    private TZS()
    {
    }
