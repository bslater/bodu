...
public sealed class BGN : ICurrency
{
    ...
    public static string EnglishName => "Bulgarian Lev";

    /// <summary>
    /// Prevents instantiation of the <see cref="BGN" /> tag type.
    /// </summary>
    private BGN()
    {
    }
