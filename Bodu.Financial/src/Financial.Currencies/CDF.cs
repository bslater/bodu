...
public sealed class CDF : ICurrency
{
    ...
    public static string EnglishName => "Congolese Franc";

    /// <summary>
    /// Prevents instantiation of the <see cref="CDF" /> tag type.
    /// </summary>
    private CDF()
    {
    }
