...
public sealed class SGD : ICurrency
{
    ...
    public static string EnglishName => "Singapore Dollar";

    /// <summary>
    /// Prevents instantiation of the <see cref="SGD" /> tag type.
    /// </summary>
    private SGD()
    {
    }
