...
public readonly partial struct Money<TCurrency>
{
    ...
    /// <summary>
    /// Converts this amount to an exact <see cref="Bodu.Numerics.Fraction{T}" /> over <see cref="BigInteger" /> for arithmetic
    /// that must not round at each step.
    /// </summary>
    /// <returns>The amount as an exact rational value.</returns>
    /// <remarks>
    /// Use <see cref="ToFraction" /> together with <see cref="FromFraction(Bodu.Numerics.Fraction{BigInteger}, MidpointRounding)" />
    ...
    /// behaviour of <see cref="FromFraction(Bodu.Numerics.Fraction{BigInteger}, MidpointRounding)" />.
    /// </remarks>
