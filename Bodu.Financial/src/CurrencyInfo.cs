...
/// <summary>
/// Carries the runtime metadata of a currency: ISO 4217 code, minor-unit precision, cash-rounding increment,
/// and historicity / successor information.
/// </summary>
...
/// The smallest physical cash denomination in the major unit, or <c>0m</c> when no special cash rounding is
/// required beyond <paramref name="MinorUnits" />.
/// </param>
...
/// <remarks>
/// This record is the runtime counterpart of an <see cref="ICurrency" /> tag type. The runtime-tagged
/// <c>MoneyValue</c> and the <c>MoneyBag</c> aggregate operate against <see cref="CurrencyRegistry" /> entries
/// of this shape so they can handle currencies the consumer learns about at runtime (for example, from a
