...
namespace Bodu.Numerics.Benchmarks;

/// <summary>
/// Measures the throughput of <see cref="Bodu.Numerics.ExchangeRateSeries" /> against a
...
public class ExchangeRateSeriesBenchmarks
{
    ...
    private Bodu.Numerics.ExchangeRateSeries _series = null!;
    ...
    public void Setup()
    {
        ...
        _series = new Bodu.Numerics.ExchangeRateSeries(s_pair, "Bench", rates);
