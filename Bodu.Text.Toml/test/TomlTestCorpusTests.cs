...
public sealed class TomlTestCorpusTests
{
    ...
    private static void AssertValidCase(CorpusKat kat)
    {
        ...
        using JsonDocument expected = JsonDocument.Parse(File.ReadAllBytes(expectationPath));
    ...
    private static void AssertLeaf(string type, string text, object actual, string path)
    {
        ...
        switch (type)
        {
            ...
            case "datetime":
                ...
                DateTimeOffset expectedOffset = DateTimeOffset.Parse(TruncateFraction(text), CultureInfo.InvariantCulture, DateTimeStyles.None);
            ...
            case "datetime-local":
                ...
                DateTime expectedLocal = DateTime.Parse(TruncateFraction(text), CultureInfo.InvariantCulture, DateTimeStyles.None);
            ...
            case "time-local":
                ...
                TimeOnly expectedTime = TimeOnly.Parse(TruncateFraction(text), CultureInfo.InvariantCulture);
