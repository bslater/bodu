...
/// <summary>
/// Serves as the base for the nodes of the intermediate value tree produced by <see cref="TomlDocumentParser" />.
/// </summary>
/// <remarks>
/// TOML cannot be tokenized in a single forward pass, because out-of-line <c>[table]</c> and <c>[[array-of-tables]]</c>
/// headers contribute to structure defined elsewhere in the document. The parser therefore materializes the whole
...
internal abstract class TomlReaderNode
{
    ...
    /// </summary>
    /// <param name="offset">The zero-based source character offset at which the node begins.</param>
    ...
    /// <summary>
    /// Gets the zero-based source character offset at which the node begins.
    /// </summary>
