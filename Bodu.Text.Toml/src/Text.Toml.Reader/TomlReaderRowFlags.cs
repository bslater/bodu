...
internal enum TomlReaderRowFlags
{
    ...
    /// <summary>
    /// The table was explicitly defined by a <c>[table]</c> header.
    /// </summary>
    HeaderDefined = 1,

    /// <summary>
    /// The table was created as an intermediate of a dotted key.
    /// </summary>
    Dotted = 2,

    /// <summary>
    /// The table is an inline table, closed to further extension once defined.
    /// </summary>
    Inline = 4,

    /// <summary>
    /// The table is an implicit super-table created by a header path, which a later header may promote.
    /// </summary>
    ImplicitSuper = 8,

    /// <summary>
    /// The array was created by an array-of-tables header and may have further elements appended.
    /// </summary>
    TableArray = 16,
}
