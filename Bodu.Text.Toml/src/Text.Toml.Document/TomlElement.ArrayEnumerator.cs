// ---------------------------------------------------------------------------------------------------------------
// <copyright file="TomlElement.ArrayEnumerator.cs" company="Bodu Pty. Ltd.">
...
public readonly partial struct TomlElement
{
        ...
        : IEnumerable<TomlElement>, IEnumerator<TomlElement>
    {
        ...
        internal ArrayEnumerator(TomlDocument document, int arrayIndex, int count)
        {
            _document = document;
        ...
        /// </summary>
        /// <returns>This enumerator positioned before the first element.</returns>
        readonly IEnumerator<TomlElement> IEnumerable<TomlElement>.GetEnumerator() =>
            GetEnumerator();
