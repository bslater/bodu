...
public sealed partial class TomlDocument
{
    ...
    /// </para>
    /// <para>
    /// Because the underlying <see cref="Reader.TomlDocumentReader" /> decodes every scalar to its concrete CLR type
    /// during parsing, a scalar row stores that decoded value directly in <see cref="Value" /> — for example a
