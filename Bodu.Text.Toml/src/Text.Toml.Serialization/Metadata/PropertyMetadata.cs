...
internal sealed class PropertyMetadata
{
    ...
    /// setter opted in by <see cref="TomlIncludeAttribute" />; otherwise <see langword="false" />. A property exposed
    /// only through a non-public setter is therefore not assigned on read unless it carries that attribute.
    /// </returns>
