...
/// <see cref="char" /> — the key types whose text form round-trips cleanly through a TOML table key. A dictionary with
/// any other key type is not claimed by this factory and falls through to the later converters.
/// </remarks>
