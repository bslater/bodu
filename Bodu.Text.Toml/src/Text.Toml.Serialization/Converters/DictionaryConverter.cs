...
/// <summary>
/// Converts a string-keyed dictionary of <typeparamref name="TValue" /> to and from a TOML table, where each entry
/// becomes a key/value pair whose key is the dictionary key.
/// </summary>
    ...
    where TDictionary : class
{
    ...
    /// </exception>
    public DictionaryConverter(TomlConverter valueConverter, bool concrete)
    {
