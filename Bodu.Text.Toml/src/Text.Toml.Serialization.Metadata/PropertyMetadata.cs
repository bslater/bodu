...
/// <see cref="TomlSerializerOptions.IncludeFields" /> or <see cref="TomlIncludeAttribute" />) of a type: its wire name,
...
internal sealed class PropertyMetadata
{
    ...
    /// <summary>Whether the member is opted into binding through non-public accessors by <see cref="TomlIncludeAttribute" />.</summary>
    ...
    /// </param>
    /// <param name="included">
    /// Whether the member is opted into binding through non-public accessors by <see cref="TomlIncludeAttribute" />.
    /// </param>
    ...
    /// <see cref="TomlObjectCreationHandlingAttribute" /> on the member, or <see langword="null" /> when the member
    /// declares none.
    /// </summary>
    ...
    /// <see cref="TomlIgnoreCondition.WhenWritingDefault" />.
    /// </summary>
    ...
    /// non-public setter opted in by <see cref="TomlIncludeAttribute" />; a property exposed only through a non-public
