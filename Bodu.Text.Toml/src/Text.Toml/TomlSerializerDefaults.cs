// ---------------------------------------------------------------------------------------------------------------
// <copyright file="TomlSerializerDefaults.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Specifies a base set of defaults applied when a <see cref="TomlSerializerOptions" /> instance is created for a
/// particular usage scenario.
/// </summary>
public enum TomlSerializerDefaults
{
    /// <summary>
