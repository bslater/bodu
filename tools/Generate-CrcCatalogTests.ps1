...
[void]$sb.AppendLine('        /// </returns>')
[void]$sb.AppendLine('        private static string GetDisplayName(object[] dataRow) =>')
[void]$sb.AppendLine('            dataRow[0] as string ?? "Unknown Standard";')
[void]$sb.AppendLine()
[void]$sb.AppendLine('        /// <summary>')
...
[void]$sb.AppendLine('        [DynamicData(nameof(CatalogCheckVectors), DynamicDataDisplayName = nameof(GetDisplayName))]')
