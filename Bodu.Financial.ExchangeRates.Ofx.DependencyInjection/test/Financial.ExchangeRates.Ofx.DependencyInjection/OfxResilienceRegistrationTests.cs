// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OfxResilienceRegistrationTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the HTTP resilience pipeline attached to the OFX exchange-rate provider's named client.
/// </summary>
[TestClass]
public partial class OfxResilienceRegistrationTests
{
    ...
    /// </summary>
    private const string ResilienceOptionsName = OfxFinancialServiceBuilderExtensions.HttpClientName + "-standard";
