// ---------------------------------------------------------------------------------------------------------------
// <copyright file="WebRateProviderExtensions.cs" company="Bodu Pty. Ltd.">
...
public static class WebRateProviderExtensions
{
    ...
    /// </example>
    /// </remarks>
    public static IFinancialServiceBuilder AddWebRateProvider<TProvider, TOptions>(
        ...
        where TProvider : WebRateProvider
        where TOptions : WebRateProviderOptions
        => AddWebRateProviderCore(
            builder,
            httpClientName,
            configuration,
            sectionName,
    ...
    /// <returns>The builder, for chaining.</returns>
    private static IFinancialServiceBuilder AddWebRateProviderCore<TProvider, TOptions>(
