...
/// <summary>
/// Represents a known-answer test row for resolving a file path against a parsed configuration
/// document, asserting the value the resolver hands back for a probed key.
/// </summary>
...
/// <param name="ExpectedValue">The expected string value after resolution; <see langword="null" /> when the key is absent.</param>
