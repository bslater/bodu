...
/// <summary>
/// Represents a known-answer test row for one of <see cref="ConfigurationView" />'s typed getters
/// (<c>GetBoolean</c>, <c>GetInt32</c>, <c>GetString</c>, …). A row carries the source configuration
/// text, the key to probe, and the expected strongly-typed value the view must return.
/// </summary>
