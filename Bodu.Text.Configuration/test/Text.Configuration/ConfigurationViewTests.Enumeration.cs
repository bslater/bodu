// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ConfigurationViewTests.Enumeration.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Verifies that <see cref="ConfigurationView" /> enumerates every resolved entry.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that <see cref="ConfigurationView.Keys" /> exposes every resolved key.
    /// </summary>
    [TestMethod]
