...
/// <see cref="BoduConfigurationDocument.Parse(string, BoduConfigurationParseOptions?)" /> useful end-to-end without
...
public enum BoduConfigurationMissingPathRootMode
{
    ...
    /// root of the supplied target path. This is the default for the <see cref="BoduConfigurationProfile.Bodu" />
    /// profile.
    /// </summary>
    UseEmptyRoot = 0,
    ...
    /// <see cref="BoduConfigurationProfile.EditorConfigCompatible" /> profile.
    /// </summary>
    Throw = 1,
}
