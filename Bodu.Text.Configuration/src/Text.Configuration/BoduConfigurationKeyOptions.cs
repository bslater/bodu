...
/// <summary>
/// Controls how raw configuration keys are split into segments and mapped to the colon-delimited logical key
/// shape used by the resolved view and the Microsoft.Extensions.Configuration bridge.
/// </summary>
/// <remarks>
...
public sealed class BoduConfigurationKeyOptions
{
    ...
    /// <summary>
    /// Gets the default key options: <see cref="BoduConfigurationKeyMapping.DotToColon" /> mapping,
    /// case-insensitive comparison, and <c>.</c> / <c>:</c> separators recognised by parser input.
    /// </summary>
    ...
    /// <summary>
    /// Gets a value indicating whether the parser permits empty segments in a raw key (for example
    /// <c>a..b</c>). The default rejects empty segments.
    /// </summary>
