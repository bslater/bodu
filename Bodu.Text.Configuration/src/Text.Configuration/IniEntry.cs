...
/// before writing the document back out.
/// </summary>
/// <remarks>
/// <para>
...
{
    /// <summary>The comments that immediately precede this entry in source order.</summary>
    ...
    /// </summary>
    /// <value>
    /// A read-only view onto the entry's mutable leading-comment list. The list is empty when no comments precede the
    /// entry.
    /// </value>
