...
/// <remarks>
/// <para>
/// A profile is the single source of truth for an option set. Each <see cref="BoduConfigurationParseOptions" />,
/// <see cref="BoduConfigurationResolveOptions" />, and <see cref="BoduConfigurationWriteOptions" /> exposes a
