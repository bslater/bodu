// ---------------------------------------------------------------------------------------------------------------
// <copyright file="CircularBuffer{T}.cs" company="Bodu Pty. Ltd.">
    ...
    : RingBackedCollection<T>
{
    ...
    private static T[] MaterializeWithOverflowPolicy(IEnumerable<T> collection, int capacity, bool allowOverwrite)
    {
        ...
        return items.Length > capacity ? throw new InvalidOperationException(CollectionsResourceStrings.Arg_Invalid_ArrayLengthExceedsCapacity) : items;
    }
    ...
    /// </exception>
    public T Dequeue() => Count == 0 ? throw new InvalidOperationException(CollectionsResourceStrings.Op_Invalid_EmptySequence) : RemoveHead();
    ...
    /// </exception>
    public T Peek() => Count == 0 ? throw new InvalidOperationException(CollectionsResourceStrings.Op_Invalid_CollectionEmpty) : PeekHead();
