// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Range{T}.cs" company="Bodu Pty. Ltd.">
    ...
    where T : IComparable<T>
{
    ...
    internal static void ValidateRange(T startInclusive, T endExclusive, IComparer<T> comparer)
    {
        ...
        if (comparer.Compare(startInclusive, endExclusive) >= 0) throw new ArgumentException(CollectionsResourceStrings.Arg_Invalid_RangeStartNotLessThanEnd, nameof(startInclusive));
    }
}
