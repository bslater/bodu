...
internal static class CollectionCapacity
{
    ...
    /// The current backing-array length. A length of zero selects <paramref name="defaultCapacity" />.
    /// </param>
    ...
    /// <returns>
    /// The chosen capacity, never below <paramref name="minimum" /> and never above <see cref="Array.MaxLength" />.
    /// </returns>
