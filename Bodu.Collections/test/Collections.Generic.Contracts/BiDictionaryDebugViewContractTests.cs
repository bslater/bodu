// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BiDictionaryDebugViewContractTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Drives <see cref="DebugViewContractTests{TCollection}" /> against <see cref="BiDictionary{TKey, TValue}" />.
...
/// </summary>
[TestClass]
public sealed class BiDictionaryDebugViewContractTests
    : DebugViewContractTests<BiDictionary<int, string>>
{
    /// <inheritdoc />
