...
public sealed class EnumeratorImmutabilityReflectionTests
{
    ...
    /// <summary>
    /// Provides all value types in the Bodu.Collections assembly that implement IEnumerator or IEnumerator&lt;T&gt;.
    /// </summary>
    public static IEnumerable<object[]> GetEnumeratorStructTypes()
    {
        Assembly assembly = typeof(Bodu.Collections.Generic.Trees.Trie).Assembly;
