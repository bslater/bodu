// ---------------------------------------------------------------------------------------------------------------
// <copyright file="CalendarCachingSqliteMeter.cs" company="Bodu Pty. Ltd.">
...
/// <c>Bodu.Globalization.Calendar.Caching.Sqlite</c>: swallowed best-effort storage failures, tagged by operation.
/// </summary>
/// <remarks>
...
/// </remarks>
internal static class CalendarCachingSqliteMeter
{
    /// <summary>The meter name listeners subscribe to.</summary>
    public const string MeterName = "Bodu.Globalization.Calendar.Caching.Sqlite";
