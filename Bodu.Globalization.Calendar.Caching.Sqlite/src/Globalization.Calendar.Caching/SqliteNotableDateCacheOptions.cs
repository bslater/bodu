    ...
    : NotableDateCacheOptions
{
    ...
    /// shared in-memory database (<c>Data Source=name;Mode=Memory;Cache=Shared</c>). A supplied value's presence is
    /// checked but its contents are not parsed until connect time.
    /// </remarks>
    ...
    /// </summary>
    /// <value>
    /// <see langword="true" /> to switch a file database to WAL journal mode on open; defaults to
    /// <see langword="true" />.
    /// </value>
    /// <remarks>
    ...
    /// </summary>
    /// <value>
    /// The busy-wait duration applied as the SQLite <c>busy_timeout</c> pragma; defaults to five seconds.
    /// </value>
