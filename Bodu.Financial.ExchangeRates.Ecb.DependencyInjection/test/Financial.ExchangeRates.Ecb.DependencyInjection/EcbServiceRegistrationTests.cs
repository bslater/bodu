// ---------------------------------------------------------------------------------------------------------------
// <copyright file="EcbServiceRegistrationTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the dependency-injection registration of the ECB euro reference-rate provider.
/// </summary>
[TestClass]
public class EcbServiceRegistrationTests
{
    /// <summary>
    ...
    public void AddEcbReferenceRates_ShouldRegisterProviderAsSingleton()
    {
        ...
        var concrete = provider.GetService<EcbExchangeRateProvider>();
