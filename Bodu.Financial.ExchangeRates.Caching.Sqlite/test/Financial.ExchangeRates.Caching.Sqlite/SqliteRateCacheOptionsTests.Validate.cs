// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SqliteRateCacheOptionsTests.Validate.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class SqliteRateCacheOptionsTests
{
    ...
    {
        var options = new SqliteRateCacheOptions { Provider = "  ", DatabaseFilePath = "cache.db" };
    ...
    {
        var options = new SqliteRateCacheOptions { Provider = "RBA" };
    ...
    {
        var options = new SqliteRateCacheOptions { Provider = "RBA", DatabaseFilePath = "cache.db" };
    ...
    {
        var options = new SqliteRateCacheOptions { Provider = "RBA", ConnectionString = "Data Source=cache.db" };
    ...
    {
        var options = new SqliteRateCacheOptions { Provider = "RBA", DatabaseFilePath = "cache.db", BusyTimeout = TimeSpan.FromSeconds(-1) };
    ...
    {
        var options = new SqliteRateCacheOptions { Provider = "RBA", DatabaseFilePath = "cache.db", BusyTimeout = TimeSpan.Zero };
