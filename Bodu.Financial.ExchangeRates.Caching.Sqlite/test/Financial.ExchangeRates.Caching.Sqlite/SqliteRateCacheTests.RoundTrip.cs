// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SqliteRateCacheTests.RoundTrip.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies that <see cref="SqliteRateCache" /> round-trips decimals and dates losslessly through its invariant
...
public sealed partial class SqliteRateCacheTests
{
    ...
    /// <see cref="CachedRate.ObservedAtUtc" /> across a reopen, so a missing instant survives as null.
    /// </summary>
    [TestMethod]
