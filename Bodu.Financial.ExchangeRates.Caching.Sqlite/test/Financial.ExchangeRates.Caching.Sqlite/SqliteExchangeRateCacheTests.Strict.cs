// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SqliteExchangeRateCacheTests.Strict.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the opt-in strict-failure behaviour of <see cref="SqliteExchangeRateCache" />: when
/// <see cref="ExchangeRateCacheOptions.ValidateStorageOnStart" /> or
/// <see cref="ExchangeRateCacheOptions.ThrowOnStorageFailure" /> is set, a database that cannot be opened or initialized
...
public sealed partial class SqliteExchangeRateCacheTests
{
    ...
    public void Constructor_WhenDatabaseUnusableAndValidateStorageOnStart_ShouldThrow()
    {
        ...
        {
            _ = new SqliteExchangeRateCache(new SqliteExchangeRateCacheOptions
            {
                Provider = Provider,
