// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SqliteRateCacheTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the SQLite-specific behaviour of <see cref="SqliteRateCache" /> beyond the shared cache contract:
...
public sealed partial class SqliteRateCacheTests
{
    ...
    [TestMethod]
    [TestCategory("Smoke")]
    public void SqliteRateCache_WhenStoredAndReadBack_ShouldServeRate()
    {
    ...
    private SqliteRateCache CreateFileCache() =>
    ...
    private SqliteRateCache CreateFileCache(string path)
    {
