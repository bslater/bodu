...
/// <summary>
/// Provides the source-generated, allocation-free logging messages emitted by <see cref="SqliteExchangeRateCache" />
...
internal static partial class Log
{
    ...
    /// the degradation operators would otherwise not see, with the count of similar failures suppressed since the
    /// previous warning so a sustained outage does not flood the log.
    /// </summary>
    ...
    [LoggerMessage(
        ...
        Message = "SQLite exchange-rate cache for provider '{provider}' degraded: a storage {operation} failed and was swallowed as best-effort; {suppressedSinceLastWarning} further failure(s) suppressed since the previous warning")]
