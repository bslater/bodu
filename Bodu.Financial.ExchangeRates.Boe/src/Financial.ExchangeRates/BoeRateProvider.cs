    ...
    : WebRateProvider
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BoeRateProvider" /> class backed by an
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BoeRateProvider" /> class backed by the IADB CSV endpoint,
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BoeRateProvider" /> class backed by an explicit table
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BoeRateProvider" /> class from an owned client, building
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BoeRateProvider" /> class, the shared core all public and
