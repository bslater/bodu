// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IBoeRateTableSource.cs" company="Bodu Pty. Ltd.">
...
/// provider.
/// </remarks>
internal interface IBoeRateTableSource
{
    /// <summary>
    ...
    /// <returns>A task that yields the parsed <see cref="BoeRateTable" />.</returns>
    ValueTask<BoeRateTable> GetTableAsync(DateOnly startDate, DateOnly endDate, CancellationToken cancellationToken = default);
}
