...
/// <summary>
/// Configures how the <see cref="BoeRateProvider" /> downloads, caches, and interprets Bank of England daily spot
/// exchange-rate data.
/// </summary>
/// <remarks>
/// <para>
...
public sealed class BoeRateProviderOptions
{
    ...
    /// <see langword="false" /> and warm the store with <see cref="BoeRateProvider.LoadRangeAsync" /> at startup; set
    /// it to <see langword="true" /> only to opt in to a blocking on-demand fetch from the synchronous lookup path.
    /// </remarks>
