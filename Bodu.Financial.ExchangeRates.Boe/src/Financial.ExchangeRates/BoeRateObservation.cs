// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BoeRateObservation.cs" company="Bodu Pty. Ltd.">
...
internal readonly record struct BoeRateObservation(DateOnly Date, string CurrencyCode, decimal Rate);
