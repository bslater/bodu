// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BoeRateProviderTests.SingleFlight.cs" company="Bodu Pty. Ltd.">
...
public partial class BoeRateProviderTests
{
    ...
    {
        BoeRateProviderOptions options = new() { EnableDiskCache = false };
        GatedBoeRateTableSource source = new(options);
        BoeRateProvider provider = new(source, options);
