// ---------------------------------------------------------------------------------------------------------------
// <copyright file="FileSystemBoeResponseCacheTests.Store.cs" company="Bodu Pty. Ltd.">
...
public partial class FileSystemBoeResponseCacheTests
{
    ...
    /// directory path is occupied by a file, <see cref="FileSystemBoeResponseCache.Store" /> reports the I/O failure as
