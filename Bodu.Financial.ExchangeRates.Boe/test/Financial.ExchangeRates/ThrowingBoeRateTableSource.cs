// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ThrowingBoeRateTableSource.cs" company="Bodu Pty. Ltd.">
...
/// </summary>
internal sealed class ThrowingBoeRateTableSource
    : IBoeRateTableSource
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ThrowingBoeRateTableSource" /> class.
    /// </summary>
    /// <param name="exception">The exception to throw from every fetch.</param>
    public ThrowingBoeRateTableSource(Exception exception)
    {
