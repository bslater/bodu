// ---------------------------------------------------------------------------------------------------------------
// <copyright file="GatedBoeExchangeRateTableSource.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// An <see cref="IBoeExchangeRateTableSource" /> whose fetch blocks until released, so a test can hold several
/// concurrent callers inside the source at once and prove the provider coalesces them into a single fetch.
/// </summary>
internal sealed class GatedBoeExchangeRateTableSource
    : IBoeExchangeRateTableSource
{
    /// <summary>
    /// The options used when parsing the response fixture once the gate opens.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GatedBoeExchangeRateTableSource" /> class.
    /// </summary>
    ...
    public GatedBoeExchangeRateTableSource(BoeExchangeRateOptions options, string fileName = BoeFixtures.Sample)
    {
        _options = options;
        _fileName = fileName;
    }
