...
{
    /// <summary>
    /// Returns the notable dates that contain the supplied <paramref name="date" /> — including multi-day spans whose
    /// anchor lies on a previous day — using the ambient <see cref="NotableDateContext.Default" /> service.
    /// </summary>
