// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NotableDateRuleMerger.cs" company="Bodu Pty. Ltd.">
    ...
    private static NotableDateRule ApplyStrategyOverride(NotableDateRule rule, DateResolutionStrategy strategy, NotableDateRuleOverrideBody body) =>
        strategy switch
        {
            DateResolutionStrategy.Fixed => rule with
            {
                ...
                DayOfWeek = null,
                WeekOrdinal = null,
                WeekdayProximity = null,
                RelativeDayOfWeek = null,
                AnchorRuleName = null,
                AnchorRuleVariant = null,
                AnchorTerritoryCode = null,
                AnchorCalendarType = null,
                OffsetDays = null,
                AlgorithmKey = null,
                AlgorithmType = null,
                AlgorithmMonth = null,
            ...
            DateResolutionStrategy.OffsetFromAnchor => rule with
            {
                ...
                AnchorRuleVariant = body.AnchorRuleVariant,
                AnchorTerritoryCode = body.AnchorTerritoryCode,
                AnchorCalendarType = body.AnchorCalendarType,
            ...
            DateResolutionStrategy.WeekdayNearDate => rule with
            {
                ...
                Day = body.Day,
                DayOfWeek = body.DayOfWeek,
                WeekdayProximity = body.WeekdayProximity,
                WeekOrdinal = null,
                RelativeDayOfWeek = null,
                AnchorRuleName = null,
                AnchorRuleVariant = null,
            ...
            DateResolutionStrategy.RelativeWeekdayInMonth => rule with
            {
                ...
                DayOfWeek = body.DayOfWeek,
                WeekOrdinal = body.WeekOrdinal,
                RelativeDayOfWeek = body.RelativeDayOfWeek,
                WeekdayProximity = body.WeekdayProximity,
                AnchorRuleName = null,
                AnchorRuleVariant = null,
                AnchorTerritoryCode = null,
