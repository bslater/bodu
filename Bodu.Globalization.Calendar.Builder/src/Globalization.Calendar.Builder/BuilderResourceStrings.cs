// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BuilderResourceStrings.cs" company="PlaceholderCompany">
...
/// <summary>
/// Centralizes the diagnostic and exception message templates used by the notable-date builder pipeline so that
/// wording remains consistent across <see cref="NotableDateBuilder" />, <see cref="NotableDateRuleBuilder" /> and
...
/// builder API does not currently require localized diagnostics; if localization is later added, callers can
...
{
    /// <summary>An adjustment action was not set before <c>Build()</c> was invoked.</summary>
    ...
    /// <summary>An adjustment action was not set before serialisation.</summary>
    ...
    /// <summary>An adjustment trigger was not set before <c>Build()</c> was invoked.</summary>
    ...
    /// <summary>An adjustment trigger was not set before serialisation.</summary>
    ...
    /// <summary>A notable date entry contained no rules at <c>Build()</c> time.</summary>
    internal const string Op_Invalid_NotableDateRulesEmpty = "At least one rule must be added to the notable date entry '{0}'.";

    /// <summary>Two strategies were configured on the same rule.</summary>
    ...
    /// <summary>No resolution strategy was selected before <c>Build()</c> was invoked.</summary>
    ...
    /// <summary>No resolution strategy was selected before serialisation.</summary>
    ...
    /// <summary>A strategy value was not recognised by the builder.</summary>
