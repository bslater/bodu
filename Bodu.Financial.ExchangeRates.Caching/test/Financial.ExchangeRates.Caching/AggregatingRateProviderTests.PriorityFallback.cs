// ---------------------------------------------------------------------------------------------------------------
// <copyright file="AggregatingRateProviderTests.PriorityFallback.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class AggregatingRateProviderTests
{
    ...
    {
        AggregatingRateProvider agg = new(new[] { Named("First"), Named("Second") });
    ...
    {
        AggregatingRateProvider agg = new(new[] { Named("First") });
