// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ExchangeRateCacheFileLayoutTests.ResolveDirectory.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class ExchangeRateCacheFileLayoutTests
{
    ...
    public void ResolveDirectory_ForSingleFile_ShouldBeProviderFolder() =>
        Assert.AreEqual(
            ...
            ExchangeRateCacheFileLayout.SingleFile.ResolveDirectory("root", "RBA", Pair));
    ...
    public void ResolveDirectory_ForPartitioned_ShouldBePerPairFolder() =>
        Assert.AreEqual(
            ...
            ExchangeRateCacheFileLayout.Monthly.ResolveDirectory("root", "RBA", Pair));
    ...
    public void ResolveDirectory_WhenProviderHasIllegalCharacter_ShouldSanitizeSegment() =>
        Assert.AreEqual(
            ...
            ExchangeRateCacheFileLayout.SingleFile.ResolveDirectory("root", "a/b", Pair));
}
