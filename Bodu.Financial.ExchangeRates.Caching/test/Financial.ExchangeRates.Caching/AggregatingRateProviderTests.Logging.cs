// ---------------------------------------------------------------------------------------------------------------
// <copyright file="AggregatingRateProviderTests.Logging.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies that <see cref="AggregatingRateProvider" /> emits routing and aggregation diagnostics through a
/// supplied logger.
/// </summary>
public sealed partial class AggregatingRateProviderTests
{
    ...
    public void TryGetRate_WhenResolvedAndLoggerSupplied_ShouldLogAggregated()
    {
        ...
        AggregatingRateProvider agg = new(new[] { Named("RBA", ("USD", "AUD", D1, 1.5m)) }, options: null, timeProvider: null, logger: logger);
    ...
    {
        CapturingLogger logger = new();
        AggregatingRateProvider agg = new(new[] { Named("RBA") }, options: null, timeProvider: null, logger: logger);
