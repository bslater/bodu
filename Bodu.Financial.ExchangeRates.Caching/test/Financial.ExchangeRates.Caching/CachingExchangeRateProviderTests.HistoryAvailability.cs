...
public partial class CachingExchangeRateProviderTests
{
    ...
    /// <summary>
    /// Verifies that disabling <see cref="CachingExchangeRateOptions.RespectHistoryAvailability" /> forwards a
    ...
    /// <summary>
    /// Verifies that disabling <see cref="CachingExchangeRateOptions.RespectHistoryAvailability" /> fetches the full
