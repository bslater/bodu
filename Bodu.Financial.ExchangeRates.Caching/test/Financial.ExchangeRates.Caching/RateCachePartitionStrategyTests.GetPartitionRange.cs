// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateCachePartitionStrategyTests.GetPartitionRange.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class RateCachePartitionStrategyTests
{
    ...
    {
        (DateOnly start, DateOnly end) = RateCachePartitionStrategy.Single.GetPartitionRange(new DateOnly(2023, 6, 15));
    ...
    {
        (DateOnly start, DateOnly end) = RateCachePartitionStrategy.Yearly.GetPartitionRange(new DateOnly(2023, 6, 15));
    ...
    {
        (DateOnly start, DateOnly end) = RateCachePartitionStrategy.Monthly.GetPartitionRange(new DateOnly(2023, 2, 15));
    ...
    {
        (DateOnly start, DateOnly end) = RateCachePartitionStrategy.Monthly.GetPartitionRange(new DateOnly(2024, 2, 10));
    ...
    public void GetPartitionRange_ForDaily_ShouldSpanSingleDay()
    {
        ...
        (DateOnly start, DateOnly end) = RateCachePartitionStrategy.Daily.GetPartitionRange(date);
