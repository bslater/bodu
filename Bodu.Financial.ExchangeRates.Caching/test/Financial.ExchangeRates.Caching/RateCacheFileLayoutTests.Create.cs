// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateCacheFileLayoutTests.Create.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class RateCacheFileLayoutTests
{
    ...
    {
        var layout = RateCacheFileLayout.Create(RateCachePartitionStrategy.Yearly);
    ...
    public void Create_WhenStrategyIsNull_ShouldThrowArgumentNullException()
    {
        ...
        {
            _ = RateCacheFileLayout.Create(null!);
        });
