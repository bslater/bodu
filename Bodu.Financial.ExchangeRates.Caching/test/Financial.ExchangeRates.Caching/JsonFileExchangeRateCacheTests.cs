// ---------------------------------------------------------------------------------------------------------------
// <copyright file="JsonFileExchangeRateCacheTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies <see cref="JsonFileExchangeRateCache" /> construction and the round-trip of cached rates through JSON files,
/// including the self-describing header and partitioned layouts.
/// </summary>
[TestClass]
public sealed partial class JsonFileExchangeRateCacheTests
{
    ...
    private JsonFileExchangeRateCache CreateCache() =>
    ...
    {
        JsonFileExchangeRateCache cache = CreateCache();
    ...
    {
        var cache = new JsonFileExchangeRateCache(new FileExchangeRateCacheOptions
        {
            Provider = Provider,
