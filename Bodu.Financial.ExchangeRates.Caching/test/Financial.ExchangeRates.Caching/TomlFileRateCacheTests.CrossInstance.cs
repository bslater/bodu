// ---------------------------------------------------------------------------------------------------------------
// <copyright file="TomlFileRateCacheTests.CrossInstance.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class TomlFileRateCacheTests
{
    ...
    {
        var cacheA = new TomlFileRateCache(new FileRateCacheOptions { Provider = Provider, CacheDirectory = _directory });
        var cacheB = new TomlFileRateCache(new FileRateCacheOptions { Provider = Provider, CacheDirectory = _directory });
        ...
        for (int i = 0; i < 50; i++)
        {
            TomlFileRateCache cache = (i % 2 == 0) ? cacheA : cacheB;
        ...
        var reader = new TomlFileRateCache(new FileRateCacheOptions { Provider = Provider, CacheDirectory = _directory });
