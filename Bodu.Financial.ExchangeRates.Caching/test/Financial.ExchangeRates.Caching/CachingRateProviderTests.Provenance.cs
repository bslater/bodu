// ---------------------------------------------------------------------------------------------------------------
// <copyright file="CachingRateProviderTests.Provenance.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies that <see cref="CachingRateProvider" /> emits a provenance diagnostic at each serve point that
...
public sealed partial class CachingRateProviderTests
{
    ...
    /// </summary>
    private const string Backend = nameof(InMemoryRateCache);
    ...
    /// <summary>
    /// Verifies that setting <see cref="CachingRateOptions.RateProvenanceLogLevel" /> to
