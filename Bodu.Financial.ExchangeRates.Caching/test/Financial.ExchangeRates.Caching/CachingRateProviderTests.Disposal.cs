// ---------------------------------------------------------------------------------------------------------------
// <copyright file="CachingRateProviderTests.Disposal.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies that <see cref="CachingRateProvider" /> disposes its inner provider only when constructed to own it.
/// </summary>
public sealed partial class CachingRateProviderTests
{
    ...
    public void Dispose_WhenOwnsInnerTrue_ShouldDisposeInner()
    {
        ...
        var sut = new CachingRateProvider(inner, _cache, _options, _clock, ownsInner: true);
    ...
    {
        DisposableProbeProvider inner = new();
        var sut = new CachingRateProvider(inner, _cache, _options, _clock);
