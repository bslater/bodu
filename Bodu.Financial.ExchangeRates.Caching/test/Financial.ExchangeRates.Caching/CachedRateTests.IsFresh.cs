// ---------------------------------------------------------------------------------------------------------------
// <copyright file="CachedRateTests.IsFresh.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the freshness contract of <see cref="CachedRate.IsFresh(DateTimeOffset, TimeSpan)" />.
/// </summary>
[TestClass]
public sealed class CachedRateTests
{
    /// <summary>
    ...
    public void IsFresh_WhenAgeComparedToDuration_ShouldUseStrictLessThan(int ageHours, bool expectedFresh)
    {
        ...
        CachedRate rate = new(new DateOnly(2023, 1, 3), 0.5m, asOf - TimeSpan.FromHours(ageHours));
