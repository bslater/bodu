// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RateCacheFileLayoutTests.Sanitize.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class RateCacheFileLayoutTests
{
    ...
    public void Sanitize_WhenSegmentIsClean_ShouldReturnUnchanged() =>
        Assert.AreEqual("AUDUSD", RateCacheFileLayout.Sanitize("AUDUSD"));
    ...
    public void Sanitize_WhenSegmentHasIllegalCharacters_ShouldReplaceWithUnderscore() =>
        Assert.AreEqual("a_b", RateCacheFileLayout.Sanitize("a" + new string(Path.GetInvalidFileNameChars()[0], 1) + "b"));
    ...
    public void Sanitize_WhenSegmentIsNull_ShouldThrowArgumentNullException() =>
        ...
        {
            _ = RateCacheFileLayout.Sanitize(null!);
        });
}
