...
/// </summary>
/// <remarks>
/// Passed to the file-name delegate of an <see cref="RateCacheFileLayout" />. For a single-file layout the
...
public readonly record struct RateCacheFileContext
{
    ...
    /// </param>
    public RateCacheFileContext(string provider, CurrencyPair pair, string partitionKey, string fileExtension)
    {
        Provider = provider;
        Pair = pair;
