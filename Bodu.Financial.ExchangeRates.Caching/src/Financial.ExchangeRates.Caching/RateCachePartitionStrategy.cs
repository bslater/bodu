...
/// </para>
/// </remarks>
public sealed class RateCachePartitionStrategy
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RateCachePartitionStrategy" /> class.
    /// </summary>
    ...
    private RateCachePartitionStrategy(
        bool isPartitioned,
    ...
    public static RateCachePartitionStrategy Single { get; } =
    ...
    public static RateCachePartitionStrategy Yearly { get; } =
        new(
            true,
    ...
    public static RateCachePartitionStrategy Monthly { get; } =
        new(
            true,
    ...
    public static RateCachePartitionStrategy Daily { get; } =
        new(
            true,
    ...
    /// </remarks>
    public static RateCachePartitionStrategy Custom(
        Func<DateOnly, string> keySelector,
        Func<DateOnly, (DateOnly Start, DateOnly End)> rangeSelector)
    {
        ...
        return new RateCachePartitionStrategy(true, keySelector, rangeSelector);
    }
