// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IRateCache.cs" company="Bodu Pty. Ltd.">
...
public interface IRateCache
{
    ...
    /// </param>
    /// <returns>
    /// <see cref="RateCacheWriteStatus.Stored" /> when both halves were persisted;
    /// <see cref="RateCacheWriteStatus.Failed" /> when a storage error was swallowed and nothing was persisted;
    /// <see cref="RateCacheWriteStatus.Skipped" /> for a cache that intentionally stores nothing.
    /// </returns>
