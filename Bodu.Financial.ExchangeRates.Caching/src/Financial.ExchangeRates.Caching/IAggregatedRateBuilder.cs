// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IAggregatedRateBuilder.cs" company="Bodu Pty. Ltd.">
...
/// </example>
/// </remarks>
public interface IAggregatedRateBuilder
{
    /// <summary>
    ...
    IAggregatedRateBuilder AddCachedChild<TProvider>(
        string name,
    ...
    /// </exception>
    /// <exception cref="ArgumentException">Thrown when <paramref name="name" /> is empty or white space.</exception>
    IAggregatedRateBuilder AddCachedChild(
        string name,
    ...
    /// </exception>
    IAggregatedRateBuilder UseDefaultStrategy(IRateAggregationStrategy strategy);
    ...
    /// </exception>
    IAggregatedRateBuilder MapPair(CurrencyPair pair, params string[] providerOrder);
    ...
    /// </exception>
    IAggregatedRateBuilder MapPair(CurrencyPair pair, IRateAggregationStrategy strategy, params string[] providerOrder);
}
