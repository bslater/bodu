// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ExchangeRateCacheFileConverter.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Maps between the internal <see cref="CachePairState" /> and the <see cref="ExchangeRateCacheFile" /> serialization
...
/// </summary>
internal static class ExchangeRateCacheFileConverter
{
    /// <summary>
    ...
    /// </returns>
    public static CachePairState ToState(ExchangeRateCacheFile? file)
    {
        if (file is null)
