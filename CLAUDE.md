...
- **Bodu.Formats.Excel.Binary** (namespace `Bodu.Formats.Excel.Binary`): `Biff8WorkbookReader`, `Biff8WorksheetReader`, `Biff8Record` / `Biff8RecordReader` / `Biff8RecordType`, `Biff8SharedStringTable`, `Biff8SheetInfo` / `Biff8SheetDimensions`, `ExcelCell` / `ExcelCellKind` / `ExcelErrorCode`, `ExcelSerialDate`.
