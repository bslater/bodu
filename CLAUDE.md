...
- **Bodu.Collections.Concurrent**: `ConcurrentCircularBuffer<T>`, `ConcurrentHashSet<T>`, `ConcurrentEvictingDictionary<TKey,TValue>`, `ConcurrentLruCache<TKey,TValue>` — the thread-safe variants, split from `Bodu.Collections`.
