...
public static partial class IniSerializer
{
    ...
    private sealed class Member
    {
        ...
        /// <summary>
        /// Gets the serialized key or section name.
        /// </summary>
        /// <value>The serialized name.</value>
        ...
        private static string ResolveName(MemberInfo member, string clrName, IniSerializerOptions options) =>
