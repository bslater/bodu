// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ExchangeRateHostFixtures.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Loads embedded exchangerate.host fixtures used by the <c>Bodu.Financial.ExchangeRates.ExchangeRateHost</c> test
/// suite.
/// </summary>
internal static class ExchangeRateHostFixtures
{
    /// <summary>The prefix under which fixtures are embedded.</summary>
    private const string ResourcePrefix = "Bodu.Financial.ExchangeRates.ExchangeRateHost.Fixtures.";
    ...
    private static Stream OpenResource(string fileName) =>
        typeof(ExchangeRateHostFixtures).Assembly.GetManifestResourceStream(ResourcePrefix + fileName)
