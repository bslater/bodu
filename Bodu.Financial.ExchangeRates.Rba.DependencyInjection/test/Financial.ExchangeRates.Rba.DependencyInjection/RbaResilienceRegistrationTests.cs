// ---------------------------------------------------------------------------------------------------------------
// <copyright file="RbaResilienceRegistrationTests.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Verifies the HTTP resilience pipeline attached to the RBA historical exchange-rate provider's named client.
/// </summary>
[TestClass]
public class RbaResilienceRegistrationTests
{
    /// <summary>
    /// The internal options name under which the standard resilience handler registers its options for the named client.
    /// </summary>
    private const string ResilienceOptionsName = RbaFinancialServiceBuilderExtensions.HttpClientName + "-standard";
