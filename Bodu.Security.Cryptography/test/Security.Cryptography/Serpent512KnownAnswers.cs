// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Serpent512KnownAnswers.cs" company="PlaceholderCompany">
...
/// <summary>
/// Holds the curated <see cref="Serpent512Cipher" /> known-answer test vectors used by
/// <see cref="Serpent512CipherTests" />. Each row pins a (key, tweak, plaintext, ciphertext) tuple so the
...
/// <remarks>
/// <para>
/// Serpent-512 is a non-standard tweakable Serpent construction developed for this library — it has no
...
/// </para>
/// </remarks>
internal static class Serpent512KnownAnswers
{
    /// <summary>
