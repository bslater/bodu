// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ThreefishCipherTests{T,T}.1024.KnownAnswers.cs" company="Bodu Pty. Ltd.">
...
internal sealed partial class Threefish1024CipherTests
{
    ...
    private static readonly KatProvenance ProfileCryptoPpMirror = KatProvenance.ReferenceImplementation("Crypto++ threefish.txt (Skein golden KAT, Test Vector 10); little-endian word64 decode, verified byte-for-byte");
