// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Serpent256KnownAnswers.cs" company="PlaceholderCompany">
...
/// <summary>
/// Holds the curated <see cref="Serpent256Cipher" /> known-answer test vectors used by
/// <see cref="Serpent256CipherTests" />. Each row pins a (key, tweak, plaintext, ciphertext) tuple so the
...
/// <remarks>
/// <para>
/// Serpent-256 is a non-standard tweakable Serpent construction developed for this library — it has no
...
/// </para>
/// </remarks>
internal static class Serpent256KnownAnswers
{
    /// <summary>
