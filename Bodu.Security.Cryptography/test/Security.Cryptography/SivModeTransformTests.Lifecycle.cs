// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SivModeTransformTests.Lifecycle.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class SivModeTransformTests
{
    ...
    public void Encrypt_SamePlaintextAndAad_DifferentSuppliedIVs_ShouldProduceIdenticalOutput()
    {
        ...
        byte[] alphaOut = new byte[plaintext.Length + (transformAlpha.TagSize / 8)];
        ...
        byte[] betaOut = new byte[plaintext.Length + (transformBeta.TagSize / 8)];
