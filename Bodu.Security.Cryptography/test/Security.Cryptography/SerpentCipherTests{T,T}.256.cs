// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SerpentCipherTests{T,T}.256.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Concrete test class exercising the wide-block tweakable <see cref="Serpent256Cipher" /> engine through the
    ...
    : SerpentCipherTests<Serpent256CipherTests, Serpent256Cipher>
{
    ...
    /// <inheritdoc />
    protected override Serpent256Cipher CreateCipher(byte[] key, byte[] tweak) =>
        new(key, tweak);
