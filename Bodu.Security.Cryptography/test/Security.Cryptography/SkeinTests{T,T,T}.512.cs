// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SkeinTests{T,T,T}.512.cs" company="Bodu Pty. Ltd.">
    ...
    : Security.Cryptography.SkeinTests<Skein512Tests, Skein512, Skein512TestVariant>
{
    ...
    protected override HashAlgorithmSpecification GetSpecification(Skein512TestVariant variant) =>
        new KeyedAlgorithmSpecification
        {
            ...
            KnownAnswers = variant == Skein512TestVariant.Hash_512
                ? [MessageDigestKnownAnswer.Empty(Skein512_512_EmptyHash)]
                : [],
        };

    /// <inheritdoc />
    protected override IReadOnlyList<MessageDigestKnownAnswer> GetKeyedKnownAnswers(Skein512TestVariant variant) =>
        Skein512KnownAnswers.For(variant);
