// ---------------------------------------------------------------------------------------------------------------
// <copyright file="HashAlgorithmKnownAnswers.cs" company="PlaceholderCompany">
...
/// declared in <see cref="HashAlgorithmSharedInputs" />. A <see langword="null" /> slot signals that no
...
/// reference suite — live on the <see cref="Additional" /> list and are driven by the same data-driven test
/// harness, avoiding bespoke <c>[DataRow]</c> definitions.
/// </para>
/// </remarks>
