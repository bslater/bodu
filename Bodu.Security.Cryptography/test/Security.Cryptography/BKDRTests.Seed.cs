...
{
    /// <summary>
    /// Verifies that a new instance of <see cref="BKDR" /> has a default seed hashValue of zero.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that setting <see cref="BKDR.Seed" /> after a algorithm computation has begun throws a <see cref="CryptographicException" />.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Verifies that setting <see cref="BKDR.Seed" /> after a algorithm computation has started does not throw a <see cref="CryptographicException" />.
    /// </summary>
    [TestMethod]
