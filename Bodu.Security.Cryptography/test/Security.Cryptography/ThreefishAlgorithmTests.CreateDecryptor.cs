// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ThreefishAlgorithmTests.CreateDecryptor.cs" company="PlaceholderCompany">
...
public abstract partial class ThreefishAlgorithmTests<TTest, TAlgorithm>
{
    ...
    [DataRow(17)]
    [DataRow(32)]
    public void CreateDecryptor_WhenTweakLengthIsInvalid_ShouldThrowCryptographicException(int tweakLength)
    {
        using TAlgorithm algorithm = CreateAlgorithm();

        Assert.ThrowsExactly<CryptographicException>(() =>
        {
            _ = algorithm.CreateDecryptor(new byte[algorithm.KeySize / 8], new byte[algorithm.BlockSize / 8], new byte[tweakLength]);
        });
    }
}
