...
internal static class Skein512KnownAnswers
{
    ...
    /// </summary>
    public static IReadOnlyList<MessageDigestKnownAnswer> For(Skein512TestVariant variant) => variant switch
    {
    ...
    [
        new MessageDigestKnownAnswer
        {
            ...
            Digest = Hex("7D59D23FCF38FF54710F0D38D3A0ACCE7B8D64F6"),
        },
    ];
    ...
    [
        new MessageDigestKnownAnswer
        {
            ...
            Provenance = NistCd,
            Message = Hex(Mac1024BitsSkein512),
            Key = Hex(
            ...
            Digest = Hex("5670B226156570DFF3EFE16661AB86EB24982CDF"),
        },
    ];
    ...
    [
        new MessageDigestKnownAnswer
        {
            ...
            Provenance = NistCd,
            Message = Hex(Incrementing1024Bits),
            Digest = Hex("21521B15C8A9F05D5958F997008E95C50C4EEE35FB30BA81D5831856"),
        },
    ];
    ...
    [
        new MessageDigestKnownAnswer
        {
            ...
            Digest = Hex("C41B9FF9753E6C0F8ED88866E320535E927FE4DA552C289841A920DB"),
        },
    ];
    ...
    [
        new MessageDigestKnownAnswer
        {
            ...
            Provenance = NistCd,
            Message = Hex(Incrementing1024Bits),
            Digest = Hex("1A6A5BA08E74A864B5CB052CFB9B2FA128203230A4D9923A329F5427C477A4DB"),
        },
    ];
    ...
    [
        new MessageDigestKnownAnswer
        {
            ...
            Message = Hex(Mac1024BitsSkein512),
            Key = [],
            Digest = Hex("AA703B798B6F472BAA9D1E1689FA0F70F8DCA25A6046BB2C8FB7F34407934AE4"),
        },
    ];

    private static readonly MessageDigestKnownAnswer[] Hash384 =
    [
        new MessageDigestKnownAnswer
        {
            Name = "Hash_NistKat1024",
    ...
    private static readonly MessageDigestKnownAnswer[] Mac384 =
    [
        new MessageDigestKnownAnswer
        {
            Name = "Mac_NistKat1024",
    ...
    private static readonly MessageDigestKnownAnswer[] Hash512 =
    [
        new MessageDigestKnownAnswer
        {
            Name = "Hash_Empty",
        ...
        new MessageDigestKnownAnswer
        {
            Name = "Hash_OneBlock",
            Provenance = NistCd,
            Message = Hex(IncrementingOneBlockSkein512),
            Digest = Hex(
        ...
        new MessageDigestKnownAnswer
        {
            Name = "Hash_TwoBlocks",
            Provenance = NistCd,
            Message = Hex(IncrementingTwoBlocksSkein512),
            Digest = Hex(
    ...
    private static readonly MessageDigestKnownAnswer[] Mac512 =
    [
        new MessageDigestKnownAnswer
        {
            Name = "Mac_OneBlock",
            Provenance = NistCd,
            Message = Hex(MacOneBlockSkein512),
            Key = Hex(
                "CB41F1706CDE09651203C2D0EFBADDF847A0D315CB2E53FF8BAC41DA0002672E" +
                "920244C66E02D5F0DAD3E94C42BB65F0D14157DECF4105EF5609D5B0984457C1" +
                "935DF3061FF06E9F204192BA11E5BB2CAC0430C1C370CB3D113FEA5EC1021EB8" +
        ...
        new MessageDigestKnownAnswer
        {
            Name = "Mac_TwoBlocks",
            Provenance = NistCd,
            Message = Hex(MacTwoBlocksSkein512),
            Key = Hex(
                "CB41F1706CDE09651203C2D0EFBADDF847A0D315CB2E53FF8BAC41DA0002672E" +
                "920244C66E02D5F0DAD3E94C42BB65F0D14157DECF4105EF5609D5B0984457C1"),
            Digest = Hex(
