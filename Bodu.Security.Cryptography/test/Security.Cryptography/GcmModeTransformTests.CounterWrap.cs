// ---------------------------------------------------------------------------------------------------------------
// <copyright file="GcmModeTransformTests.CounterWrap.cs" company="PlaceholderCompany">
...
public sealed partial class GcmModeTransformTests
{
    ...
    public void Encrypt_WhenCounterWouldWrapPast0xFFFFFFFF_ShouldThrowCryptographicException()
    {
        ...
        using GcmModeTransform transform = GcmModeTransform.CreateForTesting(cipher, j0);
