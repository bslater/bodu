// ---------------------------------------------------------------------------------------------------------------
// <copyright file="XSalsa20Poly1305Tests.Ctors.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Verifies that the <see cref="XSalsa20Poly1305(byte[], byte[])" /> constructor throws
    ...
    public void Ctor_WhenKeyIsNull_ShouldThrowExactly()
    {
        ...
        {
            _ = new XSalsa20Poly1305(null!, s_validNonce);
        });
    }
    ...
    public void Ctor_WhenNonceIsNull_ShouldThrowExactly()
    {
        Assert.ThrowsExactly<ArgumentNullException>(() =>
        {
            _ = new XSalsa20Poly1305(s_validKey, null!);
        });
    }

    /// <summary>
    /// Verifies that the <see cref="XSalsa20Poly1305(ReadOnlySpan{byte}, ReadOnlySpan{byte})" /> constructor throws
    ...
    public void Ctor_WhenKeyIsWrongSize_ShouldThrowExactly()
    {
        ...
        {
            _ = new XSalsa20Poly1305(new byte[31], s_validNonce);
        });
    }
    ...
    public void Ctor_WhenNonceIsWrongSize_ShouldThrowExactly()
    {
        Assert.ThrowsExactly<ArgumentException>(() =>
        {
            _ = new XSalsa20Poly1305(s_validKey, new byte[23]);
        });
    }
}
