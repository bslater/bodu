...
public partial class AsconCxof128Tests
{
    ...
    //
    // IMPORTANT: Expected hex values must be verified against the ascon-c reference
    // implementation before being used as a regression baseline. Until verification is
    // complete, these tests exercise output-length correctness and determinism only.
