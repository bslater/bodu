...
public sealed partial class Pkcs7PaddingTests
{
    ...
    private static SymmetricAlgorithm CreateConfiguredAlgorithm(System.Type algorithmType, PaddingMode padding)
    {
        var algorithm = (SymmetricAlgorithm)System.Activator.CreateInstance(algorithmType)!;
