// ---------------------------------------------------------------------------------------------------------------
// <copyright file="KeyedBlockHashAlgorithmTests.ComputeHash.cs" company="PlaceholderCompany">
...
public abstract partial class KeyedBlockHashAlgorithmTests<TTest, TAlgorithm, TVariant>
{
    ...
    public void ComputeHash_WhenKeyIsSet_ShouldDifferFromUnkeyedHashOfSameInput(TVariant variant)
    {
        ...
        byte[] macHash;
        var key = TestHelpers.GenerateRandomNonZeroBytes(Math.Max(1, specification.MinKeyLength));
    ...
    public void ComputeHash_WhenSameKeyAndInputUsed_ShouldReturnIdenticalResults(TVariant variant)
    {
        ...
        var hash1 = algorithm1.ComputeHash(data);
    ...
    public void ComputeHash_WhenValidKeysHaveDifferentLengths_ShouldProduceDifferentDigests(TVariant variant)
    {
        ...
        var shortKey = TestHelpers.GenerateRepeatingIncrementalByteSequence(1, keyLength);
        var longerKey = TestHelpers.GenerateRepeatingIncrementalByteSequence(1, keyLength + 1);
