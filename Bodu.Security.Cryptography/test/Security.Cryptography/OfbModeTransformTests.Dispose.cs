// ---------------------------------------------------------------------------------------------------------------
// <copyright file="OfbModeTransformTests.Dispose.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class OfbModeTransformTests
{
    ...
    /// <summary>
    /// Verifies that <see cref="OfbModeTransform.Transform" /> throws <see cref="ObjectDisposedException" /> after
    /// disposal, so a disposed transform cannot silently produce keystream from its zeroed feedback state.
    /// </summary>
    [TestMethod]
