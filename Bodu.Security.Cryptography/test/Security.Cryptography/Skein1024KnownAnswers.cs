...
internal static class Skein1024KnownAnswers
{
    ...
    /// </summary>
    public static IReadOnlyList<MessageDigestKnownAnswer> For(Skein1024TestVariant variant) => variant switch
    {
    ...
    [
        new MessageDigestKnownAnswer
        {
            ...
            Provenance = NistCd,
            Message = Hex(Mac1024BitsSkein1024),
            Key = Hex(
    ...
    private static readonly MessageDigestKnownAnswer[] Hash1024 =
    [
        new MessageDigestKnownAnswer
        {
            Name = "Hash_Empty",
        ...
        new MessageDigestKnownAnswer
        {
            Name = "Hash_OneBlock",
            Provenance = NistCd,
            Message = Hex(IncrementingOneBlockSkein1024),
            Digest = Hex(
        ...
        new MessageDigestKnownAnswer
        {
            Name = "Hash_TwoBlocks",
            Provenance = NistCd,
            Message = Hex(IncrementingTwoBlocksSkein1024),
            Digest = Hex(
    ...
    private static readonly MessageDigestKnownAnswer[] Mac1024 =
    [
        new MessageDigestKnownAnswer
        {
            Name = "Mac_OneBlock",
            Provenance = NistCd,
            Message = Hex(MacOneBlockSkein1024),
            Key = Hex(
                "CB41F1706CDE09651203C2D0EFBADDF847A0D315CB2E53FF8BAC41DA0002672E" +
                "920244C66E02D5F0DAD3E94C42BB65F0D14157DECF4105EF5609D5B0984457C1"),
            Digest = Hex(
        ...
        new MessageDigestKnownAnswer
        {
            Name = "Mac_TwoBlocks",
            Provenance = NistCd,
            Message = Hex(MacTwoBlocksSkein1024),
            Key = Hex(
                "CB41F1706CDE09651203C2D0EFBADDF847A0D315CB2E53FF8BAC41DA0002672E" +
                "920244C66E02D5F0DAD3E94C42BB65F0D14157DECF4105EF5609D5B0984457C1" +
                "935DF3061FF06E9F204192BA11E5BB2CAC0430C1C370CB3D113FEA5EC1021EB8" +
