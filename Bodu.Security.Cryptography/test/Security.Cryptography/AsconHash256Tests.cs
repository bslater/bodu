// ---------------------------------------------------------------------------------------------------------------
// <copyright file="AsconHash256Tests.cs" company="Bodu Pty. Ltd.">
    ...
    : BlockHashAlgorithmTests<AsconHash256Tests, AsconHash256, SingleTestVariant>
{
    private static readonly HashAlgorithmSpecification Specification = new()
    {
        ...
        KnownAnswers =
        [
            MessageDigestKnownAnswer.Empty("0B3BE5850F2F6B98CAF29F8FDEA89B64A1FA70AA249B8F839BD53BAA304D92B2"),
            MessageDigestKnownAnswer.Abc("AF5724830636A475C9843106DC4EE6414DC893635A45A9DE95805C36F8596DB2"),
            MessageDigestKnownAnswer.QuickBrownFox("23414503BF4BDE7AD0E85AEC94C22AE2D7CD807996B537F9564FC2974053F139"),
            MessageDigestKnownAnswer.Zeros16("2AD51185719429533DACA898C69BA9D682088B18D2D0C8AB780FBDFA3D6EA56B"),
            MessageDigestKnownAnswer.Sequential0To255("ADA496E2C0ADE829F37832A8BA34CF6059DFFBB3BEBA88CA5DED3363914EA69A"),
        ],
    };
    ...
    /// <inheritdoc />
    protected override AsconHash256 CreateAlgorithm(SingleTestVariant variant) => new();
