// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SkipjackTests.Mode.cs" company="Bodu Pty. Ltd.">
...
public sealed partial class SkipjackTests
{
    ...
    /// <see cref="Skipjack.BlockMode" />, so the mode actually used by encryptor / decryptor creation matches the
    ...
    /// <summary>
    /// Verifies that assigning <see cref="Skipjack.BlockMode" /> to a value with a standard <see cref="CipherMode" />
