    ...
    private static IEnumerable<object[]> Rfc8032KnownAnswers()
    {
        yield return new object[]
        {
            new SignatureKnownAnswer
            {
                ...
                ExpectedValid = true,
                PrivateKey = Convert.FromHexString("9d61b19deffd5a60ba844af492ec2cc44449c5697b326919703bac031cae7f60"),
            },
        };
        ...
        yield return new object[]
        {
            new SignatureKnownAnswer
            {
                ...
                ExpectedValid = true,
                PrivateKey = Convert.FromHexString("4ccd089b28ff96da9db6c346ec114e0f5b8a319f35aba624da8cf6ed4fb8a6fb"),
            },
        };
        ...
        yield return new object[]
        {
            new SignatureKnownAnswer
            {
                ...
                ExpectedValid = true,
                PrivateKey = Convert.FromHexString("c5aa8df43f9f837bedb7442f31dcb7b166d38535076f094b85ce3a2e0b4458f7"),
            },
        };
