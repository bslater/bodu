...
/// </summary>
/// <remarks>
/// Each helper returns a mutated copy so the original vector remains intact for subsequent assertions. The helpers only
/// mutate; the tamper test itself keeps its <c>Assert.ThrowsExactly</c> (or fixed-time comparison) explicit at the call
/// site.
/// </remarks>
internal static class Tamper
{
    ...
    /// <param name="bitIndex">
    /// The zero-based index of the bit to flip, counted least-significant-bit first within each byte.
    /// </param>
