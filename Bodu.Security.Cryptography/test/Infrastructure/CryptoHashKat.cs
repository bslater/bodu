...
/// the expected digest, an explicit output length (so XOFs that can be requested at multiple lengths share the same
/// record shape), and optional key / personalisation strings consumed by keyed variants such as BLAKE2 and Skein.
/// </summary>
...
/// <param name="OutputLengthBytes">
/// The requested digest length in bytes; for fixed-output algorithms this matches the natural digest length.
/// </param>
...
/// An optional personalisation / customisation string used by Skein / BLAKE2 / SHAKE customisation modes.
/// </param>
