// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Threefish.1024.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Provides a managed implementation of the <c>Threefish-1024</c> tweakable symmetric block cipher, which operates on
...
/// </para>
/// <para>
/// For other block sizes, see <see cref="Threefish256" /> and <see cref="Threefish512" />.
/// </para>
/// <para>
...
/// <list type="bullet">
/// <item>
/// <description>Block size: 1024 bits (128 bytes).</description>
/// </item>
/// <item>
/// <description>Key size: 1024 bits (128 bytes).</description>
/// </item>
/// <item>
...
/// <seealso cref="Threefish256"/> <seealso cref="Threefish512"/> <seealso cref="Threefish1024Cipher"/>
/// <seealso cref="Skein1024"/>
public sealed class Threefish1024
    : Threefish
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Threefish1024" /> class using a 1024-bit block size, 1024-bit key,
    /// and 128-bit tweak.
    /// </summary>
