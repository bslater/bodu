...
/// <summary>
/// Computes a 256-bit (32-byte) hash using the <c>Snefru</c> hash algorithm by Ralph Merkle. This class cannot be
/// inherited.
/// </summary>
/// <remarks>
/// <para>
/// <see cref="Snefru256" /> maintains an 8-word internal state and absorbs input in 32-byte blocks into a 512-bit
...
/// 256-bit hashing use SHA-256 or <see cref="Blake2b" />; for fingerprinting use a 256-bit non-cryptographic hash from
/// <c>Bodu.IO.Hashing</c>.
/// </para>
...
/// </remarks>
/// <example>
/// <code language="csharp"> using Bodu.Security.Cryptography; using var snefru = new Snefru256(); byte[] digest =
/// snefru.ComputeHash(legacyMessage); </code>
/// </example>
/// <seealso cref="Snefru{T}"/> <seealso cref="Snefru128"/>
