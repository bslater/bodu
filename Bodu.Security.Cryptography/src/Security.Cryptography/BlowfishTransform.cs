// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BlowfishTransform.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Performs a cryptographic transformation of data using the <see cref="Blowfish" /> algorithm. This class cannot be
/// inherited.
/// </summary>
/// <remarks>
/// <para>
...
/// <see cref="Blowfish" /> with a <see cref="System.Security.Cryptography.CryptoStream" />, which handles padding and
/// block alignment automatically.
/// </para>
/// </remarks>
