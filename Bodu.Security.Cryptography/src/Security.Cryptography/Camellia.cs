...
/// <see cref="CamelliaBlockCipher" /> engine through the standard <see cref="SymmetricAlgorithm" /> framework. This
/// class cannot be inherited.
/// </summary>
/// <remarks>
/// <para>
/// Camellia is a symmetric-key block cipher jointly developed by NTT and Mitsubishi Electric and specified by RFC 3713.
/// It operates on a fixed 128-bit block size and accepts 128-bit, 192-bit, and 256-bit keys. The 128-bit key variant
/// applies 18 Feistel rounds; the 192-bit and 256-bit key variants apply 24 rounds. Camellia has been evaluated and
/// approved by ISO/IEC, CRYPTREC, and NESSIE.
/// </para>
/// <para>
...
/// <see cref="CipherModeKind.CBC" /> with <see cref="PaddingMode.PKCS7" /> padding and a default key size of 256 bits.
/// </para>
/// <para>
    ...
    : ExtendedSymmetricAlgorithm
{
    ...
    /// </param>
    /// <param name="rgbIV">
    /// The initialization vector. Must be exactly 16 bytes (128 bits) in length. Must not be <see langword="null" />.
    /// </param>
    /// <returns>
    /// A symmetric <see cref="Camellia" /> decryptor object implementing <see cref="ICryptoTransform" />.
    /// </returns>
    ...
    /// <paramref name="rgbKey" /> is not 16, 24, or 32 bytes in length, or <paramref name="rgbIV" /> is not exactly 16
    /// bytes in length.
    /// </exception>
    ...
    /// </param>
    /// <returns>
    /// A symmetric <see cref="Camellia" /> encryptor object implementing <see cref="ICryptoTransform" />.
    /// </returns>
    /// <exception cref="ObjectDisposedException">The current instance has been disposed.</exception>
    /// <exception cref="ArgumentNullException">
    /// <paramref name="rgbKey" /> or <paramref name="rgbIV" /> is <see langword="null" />.
    ...
    /// use with the Camellia algorithm.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// <remarks>
    /// <para>
    /// The generated key length is determined by <see cref="SymmetricAlgorithm.KeySize" />, which defaults to 256 bits.
    /// The generated key is assigned directly to <see cref="SymmetricAlgorithm.Key" />.
    /// </para>
    /// </remarks>
    /// <exception cref="ObjectDisposedException">The current instance has been disposed.</exception>
