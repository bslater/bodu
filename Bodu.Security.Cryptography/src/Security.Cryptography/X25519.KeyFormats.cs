...
/// <summary>
/// Surfaces the X25519 algorithm semantics and deliberately rejects the inherited PKCS#8 / SubjectPublicKeyInfo / PEM /
...
public sealed partial class X25519
{
    ...
    private static NotSupportedException KeyFormatNotSupported() =>
        new(string.Format(CultureInfo.CurrentCulture, CryptoResourceStrings.Op_NotSupported_RawKeyFormatOnly, "X25519"));
}
