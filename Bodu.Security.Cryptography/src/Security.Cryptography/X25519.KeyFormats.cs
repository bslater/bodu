// ---------------------------------------------------------------------------------------------------------------
// <copyright file="X25519.KeyFormats.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Surfaces the X25519 algorithm semantics, implements the RFC 8410 PKCS#8 / SubjectPublicKeyInfo (and PEM) key formats
/// over the inherited members, and deliberately rejects the unsupported XML and encrypted-PKCS#8 formats.
/// </summary>
public sealed partial class X25519
{
    /// <summary>The RFC 8410 object identifier for X25519.</summary>
    private const string KeyFormatOid = "1.3.101.110";

    /// <summary>
    /// Gets the algorithm name <c>"X25519"</c>.
    /// </summary>
    /// <value>The constant string <c>"X25519"</c>.</value>
    ...
    public override void ImportSubjectPublicKeyInfo(ReadOnlySpan<byte> source, out int bytesRead)
    {
        ...
        if (publicKey.Length != KeySizeInBytes)
    ...
    private static NotSupportedException KeyFormatNotSupported() =>
        new(string.Format(CultureInfo.CurrentCulture, CryptoResourceStrings.Op_NotSupported_XmlAndEncryptedKeyFormat, "X25519"));
}
