    ...
    : IBlockCipher
{
    ...
    public void Encrypt(ReadOnlySpan<byte> input, Span<byte> output)
    {
        ...
        var r1 = BinaryPrimitives.ReadUInt32LittleEndian(input.Slice(4));
        var r2 = BinaryPrimitives.ReadUInt32LittleEndian(input.Slice(8));
        var r3 = BinaryPrimitives.ReadUInt32LittleEndian(input.Slice(12));
    ...
    public void Decrypt(ReadOnlySpan<byte> input, Span<byte> output)
    {
        ...
        var r3 = BinaryPrimitives.ReadUInt32LittleEndian(input.Slice(4));
        var r0 = BinaryPrimitives.ReadUInt32LittleEndian(input.Slice(8));
        var r1 = BinaryPrimitives.ReadUInt32LittleEndian(input.Slice(12));
