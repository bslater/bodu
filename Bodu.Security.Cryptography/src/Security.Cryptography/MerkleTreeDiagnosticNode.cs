...
/// and the hash value produced as output.
/// </summary>
/// <param name="Level">
/// The zero-based level of this node within the tree. Level 0 contains leaf nodes derived directly from input blocks;
/// higher levels contain internal nodes derived by combining groups of child hashes.
/// </param>
/// <param name="Index">The zero-based position of this node within its level.</param>
/// <param name="IsLeaf">
/// <see langword="true" /> if this node is a leaf; <see langword="false" /> if it is an internal node. Leaf nodes have
/// no child hashes.
/// </param>
