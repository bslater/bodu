// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Tiger.SBoxConstants.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>The first Tiger substitution table (S-box 1) used by the round function.</summary>
    ...
    /// <summary>The second Tiger substitution table (S-box 2) used by the round function.</summary>
    ...
    /// <summary>The third Tiger substitution table (S-box 3) used by the round function.</summary>
    ...
    /// <summary>The fourth Tiger substitution table (S-box 4) used by the round function.</summary>
