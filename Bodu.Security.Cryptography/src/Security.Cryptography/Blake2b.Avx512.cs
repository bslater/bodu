...
{
    /// <summary>The broadcast vector for the 16-bit right rotation in the BLAKE2b <c>G</c> function.</summary>
    /// <remarks>
    ...
    /// <summary>The broadcast vector for the 24-bit right rotation in the BLAKE2b <c>G</c> function.</summary>
    private static readonly Vector256<ulong> s_ror24 = Vector256.Create(24UL);

    /// <summary>The broadcast vector for the 32-bit right rotation in the BLAKE2b <c>G</c> function.</summary>
    private static readonly Vector256<ulong> s_ror32 = Vector256.Create(32UL);

    /// <summary>The broadcast vector for the 63-bit right rotation in the BLAKE2b <c>G</c> function.</summary>
