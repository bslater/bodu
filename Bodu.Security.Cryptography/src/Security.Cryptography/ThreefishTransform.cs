...
/// concrete <see cref="Threefish"/> algorithm with a <see cref="System.Security.Cryptography.CryptoStream"/>.
/// </para>
/// </remarks>
    ...
    : BlockCipherTransform
{
    ...
    public ThreefishTransform(IBlockCipher cipher, CipherBlockMode cipherMode, BlockPaddingMode paddingMode, byte[] iv, bool encrypt)
