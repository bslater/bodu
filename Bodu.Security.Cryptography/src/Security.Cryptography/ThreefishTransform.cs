// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ThreefishTransform.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Performs a cryptographic transformation of data using a <see cref="Threefish" /> block cipher engine. This class
/// cannot be inherited.
/// </summary>
/// <remarks>
/// <para>
/// Instances of this class are returned by <see cref="Threefish.CreateEncryptor(byte[], byte[], byte[])" /> and
/// <see cref="Threefish.CreateDecryptor(byte[], byte[], byte[])" />. Using this class directly is not recommended;
/// prefer using a concrete <see cref="Threefish" /> algorithm with a <see cref="CryptoStream" />.
/// </para>
/// </remarks>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ThreefishTransform" /> class using the specified cipher, mode,
