...
/// <see cref="Camellia"/> with a <see cref="System.Security.Cryptography.CryptoStream"/>.
/// </para>
/// </remarks>
    ...
    : BlockCipherTransform
{
    ...
    internal CamelliaTransform(IBlockCipher cipher, CipherBlockMode cipherMode, BlockPaddingMode paddingMode, byte[]? iv, bool encrypt)
