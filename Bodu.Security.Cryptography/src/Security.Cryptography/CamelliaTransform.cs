// ---------------------------------------------------------------------------------------------------------------
// <copyright file="CamelliaTransform.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Performs a cryptographic transformation of data using the <see cref="Camellia" /> algorithm. This class cannot be
/// inherited.
/// </summary>
/// <remarks>
/// <para>
    ...
    : BlockCipherTransform
{
    ...
    /// </param>
    internal CamelliaTransform(IBlockCipher cipher, CipherModeKind cipherMode, PaddingModeKind paddingMode, byte[]? iv, bool encrypt)
