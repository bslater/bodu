// ---------------------------------------------------------------------------------------------------------------
// <copyright file="MLKem.KeyFormats.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Surfaces the ML-KEM parameter-set semantics and deliberately rejects the inherited PKCS#8 / SubjectPublicKeyInfo /
/// PEM / XML key-format members. ML-KEM exposes only its FIPS 203 raw key encodings; the standardized ASN.1 containers
...
public abstract partial class MLKem
{
    ...
    /// <summary>
    /// Gets the claimed security strength of the selected parameter set, in bits (128, 192, or 256 for ML-KEM-512,
    /// ML-KEM-768, and ML-KEM-1024 respectively, corresponding to NIST security categories 1, 3, and 5).
    /// </summary>
    /// <value>The security strength in bits.</value>
    public int SecurityStrengthBits =>
        _parameters.K switch
        {
            2 => 128,
            3 => 192,
            _ => 256,
