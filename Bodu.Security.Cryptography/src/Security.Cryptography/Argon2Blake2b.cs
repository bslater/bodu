...
internal static class Argon2Blake2b
{
    ...
    /// <summary>
    /// Computes the unkeyed BLAKE2b digest of <paramref name="input" /> with an arbitrary output length and writes it to
    ...
    /// <param name="counter">The total number of input bytes processed so far (low 64 bits; high word is zero here).</param>
    /// <param name="last">
    /// <see langword="true" /> when this is the final block, applying the finalization flag.
    /// </param>
