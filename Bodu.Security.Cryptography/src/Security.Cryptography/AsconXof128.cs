...
/// </remarks>
/// <example>
/// <code language="csharp"> using var xof = new AsconXof128(); xof.Absorb(message); byte[] output = xof.GetHash(64); //
/// Produce 64 bytes of output </code>
/// </example>
/// <seealso cref="AsconCxof128"/> <seealso cref="AsconHash256"/>
