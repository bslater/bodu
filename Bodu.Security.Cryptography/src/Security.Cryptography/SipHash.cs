...
/// parameter set. <code language="csharp"> using var sipHash = new SipHash64 { Key = myKey, CompressionRounds = 4,
/// FinalizationRounds = 8, }; byte[] tag = sipHash.ComputeHash(message); </code>
/// </example>
...
#pragma warning restore SA1132 // Do not combine fields
    ...
    /// <item>
    /// <description>
    /// <c>c</c>: compression rounds
    /// </description>
    /// </item>
    /// <item>
    /// <description>
    /// <c>d</c>: finalization rounds
    /// </description>
    /// </item>
    /// <item>
    /// <description>
    /// <c>x</c>: output hash size in bits
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
