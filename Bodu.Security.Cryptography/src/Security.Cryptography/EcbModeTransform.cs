// ---------------------------------------------------------------------------------------------------------------
// <copyright file="EcbModeTransform.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Applies the Electronic Codebook (ECB) mode transformation to an underlying <see cref="IBlockCipher" />, encrypting
/// or decrypting each block independently with no chaining.
/// </summary>
/// <remarks>
/// <para>
...
/// panel 1</b> of the diagram above: each column is entirely self-contained, so the three cells carry no arrows between
/// them.
/// </para>
/// <para>
