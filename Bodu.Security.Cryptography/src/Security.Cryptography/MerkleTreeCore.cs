...
/// Nothing here reads a resource file, so argument failures throw without a message; the facades perform the
/// message-bearing validation before delegating, and the guards that remain here are backstops against a caller that
