// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Serpent.256.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Provides a managed implementation of the non-standard wide-block tweakable <c>Serpent-256</c> symmetric block
/// cipher, which operates on 256-bit (32-byte) blocks using a 256-bit key and a 128-bit tweak. This class cannot be
/// inherited.
/// </summary>
/// <remarks>
/// <para>
/// This variant runs the Serpent round function over an eight-word state for 48 rounds, injecting a tweak subkey every
...
/// </list>
/// <para>
/// <strong>When to choose Serpent-256.</strong> Pick the wide-block Serpent variants only for experimental work where a
/// tweakable wide-block cipher with Serpent's round function is wanted. <see cref="Threefish256" /> is a better-studied
/// alternative for the same role. Use <see cref="Serpent128" /> for any production scenario that requires interoperable
/// Serpent.
/// </para>
/// <note type="important"> Serpent-256 (this type) is a <strong>non-standard Serpent-derived construction</strong> and
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Serpent256" /> class using a 256-bit block size, 256-bit key, and
    /// 128-bit tweak.
    /// </summary>
    public Serpent256()
        : base(256, 128) { }
    ...
    /// </remarks>
    public static new Serpent256 Create() => new();
