// ---------------------------------------------------------------------------------------------------------------
// <copyright file="X25519KeyMaterial.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Holds an immutable X25519 key pair or public-only key. Bundling the public key with its optional private key makes
...
/// </summary>
internal sealed class X25519KeyMaterial
{
    /// <summary>
    /// Initializes a new instance of the <see cref="X25519KeyMaterial" /> class taking ownership of the supplied
    /// arrays.
    /// </summary>
    ...
    private X25519KeyMaterial(byte[] publicKey, byte[]? privateKey)
    {
        PublicKey = publicKey;
    ...
    /// </summary>
    /// <value>The 32-byte private key, or <see langword="null" /> for a public-only instance.</value>
    ...
    internal static X25519KeyMaterial ForKeyPair(byte[] publicKey, byte[] privateKey) =>
    ...
    internal static X25519KeyMaterial ForPublicKey(byte[] publicKey) =>
        new(publicKey, null);
