// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Threefish.512.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Provides a managed implementation of the <c>Threefish-512</c> tweakable symmetric block cipher, which operates on
...
/// </para>
/// <para>
/// For other block sizes, see <see cref="Threefish256" /> and <see cref="Threefish1024" />.
/// </para>
/// <para>
...
/// <list type="bullet">
/// <item>
/// <description>Block size: 512 bits (64 bytes).</description>
/// </item>
/// <item>
/// <description>Key size: 512 bits (64 bytes).</description>
/// </item>
/// <item>
...
/// surrounding scheme; use <see cref="Threefish1024" /> when even more block width is required.
/// </para>
/// </remarks>
/// <example>
...
/// </code>
/// </example>
/// <seealso href="../guides/cryptography/threefish-512.html">Using Threefish-512 (guide with full encrypt / decrypt
...
/// <seealso cref="Threefish256"/> <seealso cref="Threefish1024"/> <seealso cref="Threefish512Cipher"/>
/// <seealso cref="Skein512"/>
public sealed class Threefish512
    : Threefish
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Threefish512" /> class using a 512-bit block size, 512-bit key, and
    /// 128-bit tweak.
    /// </summary>
    public Threefish512()
        : base(512, 128) { }
