...
/// <see cref="Skipjack"/> with a <see cref="System.Security.Cryptography.CryptoStream"/>, which handles padding and block
    ...
    : BlockCipherTransform
{
    ...
    public SkipjackTransform(IBlockCipher cipher, CipherBlockMode cipherMode, BlockPaddingMode paddingMode, byte[]? iv, bool encrypt)
