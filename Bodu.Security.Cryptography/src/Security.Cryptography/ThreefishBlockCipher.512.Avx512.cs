...
public sealed partial class Threefish512Cipher
{
    ...
    /// <summary>Packs the four spec-defined MIX rotation amounts for the second round into a single vector.</summary>
    private static readonly Vector256<ulong> s_rotVec1 = Vector256.Create((ulong)R4, R5, R6, R7);

    /// <summary>Packs the four spec-defined MIX rotation amounts for the third round into a single vector.</summary>
    private static readonly Vector256<ulong> s_rotVec2 = Vector256.Create((ulong)R8, R9, R10, R11);

    /// <summary>Packs the four spec-defined MIX rotation amounts for the fourth round into a single vector.</summary>
    private static readonly Vector256<ulong> s_rotVec3 = Vector256.Create((ulong)R12, R13, R14, R15);

    /// <summary>Packs the four spec-defined MIX rotation amounts for the fifth round into a single vector.</summary>
    private static readonly Vector256<ulong> s_rotVec4 = Vector256.Create((ulong)R16, R17, R18, R19);

    /// <summary>Packs the four spec-defined MIX rotation amounts for the sixth round into a single vector.</summary>
    private static readonly Vector256<ulong> s_rotVec5 = Vector256.Create((ulong)R20, R21, R22, R23);

    /// <summary>Packs the four spec-defined MIX rotation amounts for the seventh round into a single vector.</summary>
