// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Blake2s.Avx512.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>The broadcast rotation amount of 12 used by the BLAKE2s <c>G</c> mixing function.</summary>
    /// <remarks>
    ...
    /// <summary>The broadcast rotation amount of 16 used by the BLAKE2s <c>G</c> mixing function.</summary>
    private static readonly Vector128<uint> s_ror16 = Vector128.Create(16U);

    /// <summary>The broadcast rotation amount of 7 used by the BLAKE2s <c>G</c> mixing function.</summary>
    private static readonly Vector128<uint> s_ror7 = Vector128.Create(7U);

    /// <summary>The broadcast rotation amount of 8 used by the BLAKE2s <c>G</c> mixing function.</summary>
