// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ICryptoTransformExtensions.TransformAsync.cs" company="Bodu Pty. Ltd.">
...
public static partial class ICryptoTransformExtensions
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            // Guard against cancellation between the write and finalization.
            cancellationToken.ThrowIfCancellationRequested();
        ...
        finally
        {
            ...
            // any secondary CryptographicException from DisposeAsync-triggered finalization when
