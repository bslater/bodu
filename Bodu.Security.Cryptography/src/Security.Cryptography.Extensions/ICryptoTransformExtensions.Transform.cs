// --------------------------------------------------------------------------------------------------------------- //
// <copyright file="ICryptoTransformExtensions_Transform.cs" company="PlaceholderCompany">
...
namespace Bodu.Security.Cryptography.Extensions
{
    public static partial class ICryptoTransformExtensions
    {
        ...
        public static int Transform(this ICryptoTransform transform, ReadOnlySpan<byte> input, Span<byte> destination)
        {
            ...
            using MemoryStream ms = new MemoryStream(input.Length + transform.OutputBlockSize);
            using CryptoStream cryptoStream = new CryptoStream(ms, transform, CryptoStreamMode.Write, leaveOpen: true);
