...
{
    /// <summary>
    /// Encrypts the entire contents of a byte array using the specified stream cipher.
    /// </summary>
    ...
    /// </remarks>
    public static byte[] Encrypt(this SymmetricStreamAlgorithm algorithm, byte[] array)
    {
    ...
    /// </exception>
    public static byte[] Encrypt(this SymmetricStreamAlgorithm algorithm, byte[] array, int offset)
    {
        ThrowHelper.ThrowIfNull(algorithm);
        ThrowHelper.ThrowIfNull(array);
    ...
    /// <summary>
    /// Encrypts a contiguous region of a byte array using the specified stream cipher.
    /// </summary>
    /// <param name="algorithm">The stream cipher to use. Must not be <see langword="null" />.</param>
    /// <param name="array">The input byte array to encrypt. Must not be <see langword="null" />.</param>
    /// <param name="offset">The zero-based byte offset in <paramref name="array" /> at which to begin reading.</param>
    ...
    /// </exception>
    public static byte[] Encrypt(this SymmetricStreamAlgorithm algorithm, byte[] array, int offset, int count)
    {
        ThrowHelper.ThrowIfNull(algorithm);
        ThrowHelper.ThrowIfNull(array);
    ...
    /// <summary>
    /// Encrypts a read-only span of bytes using the specified stream cipher.
    /// </summary>
    /// <param name="algorithm">The stream cipher to use. Must not be <see langword="null" />.</param>
    ...
    public static byte[] Encrypt(this SymmetricStreamAlgorithm algorithm, ReadOnlySpan<byte> input)
    {
        ThrowHelper.ThrowIfNull(algorithm);
    ...
    /// <summary>
    /// Encrypts a read-only memory region using the specified stream cipher.
    /// </summary>
    /// <param name="algorithm">The stream cipher to use. Must not be <see langword="null" />.</param>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="algorithm" /> is <see langword="null" />.</exception>
    /// <remarks>
    /// Delegates to <see cref="Encrypt(SymmetricStreamAlgorithm, ReadOnlySpan{byte})" />.
    /// </remarks>
    public static byte[] Encrypt(this SymmetricStreamAlgorithm algorithm, ReadOnlyMemory<byte> input) =>
    ...
    /// <see langword="null" />.
    /// </exception>
    public static int Encrypt(this SymmetricStreamAlgorithm algorithm, Stream sourceStream, Stream targetStream) =>
        algorithm.Encrypt(sourceStream, targetStream, SymmetricAlgorithmExtensions.DefaultBufferSize);
