// --------------------------------------------------------------------------------------------------------------- //
// <copyright file="HashAlgorithmExtensions_VerifyHash.cs" company="PlaceholderCompany">
...
namespace Bodu.Security.Cryptography.Extensions
{
    ...
    public static partial class HashAlgorithmExtensions
    {
        ...
        public static bool VerifyHash(this HashAlgorithm algorithm, ReadOnlySpan<byte> input, ReadOnlySpan<byte> expectedHash)
        {
            ...
            try
            {
                if (!algorithm.TryComputeHash(input, actualBuffer.AsSpan(0, hashLength), out int bytesWritten))
                    return false;
