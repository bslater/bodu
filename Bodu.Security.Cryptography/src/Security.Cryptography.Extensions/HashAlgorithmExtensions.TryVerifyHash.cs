// ---------------------------------------------------------------------------------------------------------------
// <copyright file="HashAlgorithmExtensions.TryVerifyHash.cs" company="PlaceholderCompany">
...
public static partial class HashAlgorithmExtensions
{
    ...
    /// The expected hash value to compare against. A <see langword="null"/> value causes the method to return <see langword="false"/>.
    /// </param>
    /// <returns>
    ...
    /// The expected hash as a hexadecimal string. A <see langword="null"/> value causes the method to return <see langword="false"/>.
    /// </param>
    /// <returns>
    ...
    /// </param>
    /// <param name="input">
    /// The plain-text string to encode and hash. A <see langword="null"/> value causes the method to return <see langword="false"/>.
    /// </param>
    /// <param name="encoding">
    /// The encoding used to convert <paramref name="input"/> to bytes. A <see langword="null"/> value causes the method to return
    /// <see langword="false"/>.
    /// </param>
    /// <param name="expectedHash">
    ...
    /// </param>
    /// <param name="expectedHex">
    /// The expected hash value as a hexadecimal string. A <see langword="null"/> value causes the method to return <see langword="false"/>.
    /// </param>
    /// <returns>
