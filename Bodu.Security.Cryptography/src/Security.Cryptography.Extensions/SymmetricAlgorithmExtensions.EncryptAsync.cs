// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SymmetricAlgorithmExtensions.EncryptAsync.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Asynchronously encrypts data read from a source stream and writes the encrypted output to a target stream, using
