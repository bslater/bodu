// ---------------------------------------------------------------------------------------------------------------
// <copyright file="SymmetricAlgorithmExtensions.Decrypt.cs" company="Bodu Pty. Ltd.">
...
public static partial class SymmetricAlgorithmExtensions
{
    ...
    /// </exception>
    /// <remarks>
    /// Equivalent to calling <c>Decrypt(array, 0, array.Length)</c>.
    /// </remarks>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="algorithm" /> is <see langword="null" />.</exception>
    /// <remarks>
    /// Delegates to <see cref="Decrypt(SymmetricAlgorithm, ReadOnlySpan{byte})" />.
    /// </remarks>
