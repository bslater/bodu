...
public sealed class SchemaValidationTests
{
    ...
    [TestMethod]
    [DataRow("invalid-bad-territory.xml", "BODU-CAL2-SCHEMA")]
    [DataRow("invalid-bad-emission.xml", "BODU-CAL2-SCHEMA")]
    [DataRow("invalid-impossible-date.xml", "BODU-CAL2-DAY")]
    [DataRow("invalid-duplicate-rule-id.xml", "BODU-CAL2-DUP-RULE")]
    [DataRow("invalid-duplicate-notable-id.xml", "BODU-CAL2-DUP-ND")]
    [DataRow("invalid-unknown-policy-ref.xml", "BODU-CAL2-ADJREF")]
    [DataRow("invalid-offset-missing.xml", "BODU-CAL2-OFFSET-MISSING")]
