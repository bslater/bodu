...
public sealed class ParserValidationTests
{
    ...
    // -----------------------------------------------------------------------------------------
    // Schema violations (XSD-expressible faults surfaced as BODU-CAL2-SCHEMA)
    // -----------------------------------------------------------------------------------------
    ...
    {
        AssertFixtureFailsWith("invalid-no-strategy.xml", "BODU-CAL2-SCHEMA");
    }
    ...
    {
        AssertFixtureFailsWith("invalid-multiple-strategies.xml", "BODU-CAL2-SCHEMA");
    }
    ...
    {
        AssertFixtureFailsWith("invalid-unknown-category.xml", "BODU-CAL2-SCHEMA");
    }
    ...
    {
        AssertFixtureFailsWith("invalid-unknown-trigger.xml", "BODU-CAL2-SCHEMA");
    }
    ...
    {
        AssertFixtureFailsWith("invalid-unknown-action.xml", "BODU-CAL2-SCHEMA");
    }
    ...
    /// <summary>
    /// Verifies that an impossible fixed Gregorian date (30 February) is rejected with the <c>BODU-CAL2-DAY</c>
    /// diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenFixedDateIsImpossible_ShouldThrowDayDiagnostic()
    {
        AssertFixtureFailsWith("invalid-impossible-date.xml", "BODU-CAL2-DAY");
    }

    /// <summary>
    /// Verifies that a duplicate rule identifier within a concept is rejected with the <c>BODU-CAL2-DUP-RULE</c>
    /// diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenRuleIdsCollide_ShouldThrowDuplicateRuleDiagnostic()
    {
        AssertFixtureFailsWith("invalid-duplicate-rule-id.xml", "BODU-CAL2-DUP-RULE");
    }

    /// <summary>
    /// Verifies that a duplicate concept identifier is rejected with the <c>BODU-CAL2-DUP-ND</c> diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenNotableDateIdsCollide_ShouldThrowDuplicateNotableDateDiagnostic()
    {
        AssertFixtureFailsWith("invalid-duplicate-notable-id.xml", "BODU-CAL2-DUP-ND");
    }

    /// <summary>
    /// Verifies that a duplicate adjustment-policy identifier is rejected with the <c>BODU-CAL2-DUP-POLICY</c>
    /// diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenPolicyIdsCollide_ShouldThrowDuplicatePolicyDiagnostic()
    {
        AssertFixtureFailsWith("invalid-duplicate-policy-id.xml", "BODU-CAL2-DUP-POLICY");
    }

    /// <summary>
    /// Verifies that a rule referencing an unknown adjustment policy is rejected with the <c>BODU-CAL2-ADJREF</c>
    /// diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenAdjustmentReferenceIsUnresolved_ShouldThrowAdjustmentRefDiagnostic()
    {
        AssertFixtureFailsWith("invalid-unknown-policy-ref.xml", "BODU-CAL2-ADJREF");
    }

    /// <summary>
    /// Verifies that an offset strategy referencing a missing rule is rejected with the
    /// <c>BODU-CAL2-OFFSET-MISSING</c> diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenOffsetReferenceIsUnresolved_ShouldThrowOffsetMissingDiagnostic()
    {
        AssertFixtureFailsWith("invalid-offset-missing.xml", "BODU-CAL2-OFFSET-MISSING");
    }

    /// <summary>
    /// Verifies that an algorithm strategy with an unrecognised key is rejected with the <c>BODU-CAL2-ALGORITHM</c>
    /// diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenAlgorithmKeyIsUnknown_ShouldThrowAlgorithmDiagnostic()
    {
        AssertFixtureFailsWith("invalid-unknown-algorithm.xml", "BODU-CAL2-ALGORITHM");
    }

    /// <summary>
    /// Verifies that an inverted applicability year range is rejected with the <c>BODU-CAL2-YEARS</c> diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenFromYearAfterToYear_ShouldThrowYearsDiagnostic()
    {
        AssertFixtureFailsWith("invalid-fromyear-after-toyear.xml", "BODU-CAL2-YEARS");
    }

    /// <summary>
    /// Verifies that a <c>Custom</c> action without a handler key is rejected with the
    /// <c>BODU-CAL2-HANDLER-MISSING</c> diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenCustomActionHasNoHandler_ShouldThrowHandlerMissingDiagnostic()
    {
        AssertFixtureFailsWith("invalid-custom-action-no-handler.xml", "BODU-CAL2-HANDLER-MISSING");
    }

    /// <summary>
    /// Verifies that a <c>Custom</c> trigger without a handler key is rejected with the
    /// <c>BODU-CAL2-TRIGGER-HANDLER-MISSING</c> diagnostic.
    /// </summary>
    [TestMethod]
    public void Load_WhenCustomTriggerHasNoHandler_ShouldThrowTriggerHandlerMissingDiagnostic()
    {
        AssertFixtureFailsWith("invalid-custom-trigger-no-handler.xml", "BODU-CAL2-TRIGGER-HANDLER-MISSING");
    }
    ...
    /// <summary>
    /// Verifies that the JSON path reports an impossible fixed date with the <c>BODU-CAL2-DAY</c> diagnostic, matching
    /// the XML path.
    /// </summary>
    [TestMethod]
    public void LoadJson_WhenFixedDateIsImpossible_ShouldThrowDayDiagnostic()
    {
        ...
        Assert.IsTrue(ex.Diagnostics.Any(d => d.Code == "BODU-CAL2-DAY"), "BODU-CAL2-DAY");
    }

    /// <summary>
    /// Verifies that the JSON path reports an unresolved offset reference with the <c>BODU-CAL2-OFFSET-MISSING</c>
    ...
    public void LoadJson_WhenOffsetReferenceIsUnresolved_ShouldThrowOffsetMissingDiagnostic()
    {
        ...
        Assert.IsTrue(ex.Diagnostics.Any(d => d.Code == "BODU-CAL2-OFFSET-MISSING"), "BODU-CAL2-OFFSET-MISSING");
    }

    /// <summary>
    /// Verifies that the JSON path reports an unknown algorithm key with the <c>BODU-CAL2-ALGORITHM</c> diagnostic,
    ...
    public void LoadJson_WhenAlgorithmKeyIsUnknown_ShouldThrowAlgorithmDiagnostic()
    {
        ...
        Assert.IsTrue(ex.Diagnostics.Any(d => d.Code == "BODU-CAL2-ALGORITHM"), "BODU-CAL2-ALGORITHM");
    }

    /// <summary>
    /// Verifies that the JSON path reports an inverted applicability year range with the <c>BODU-CAL2-YEARS</c>
    /// diagnostic, matching the XML path.
    /// </summary>
    [TestMethod]
    public void LoadJson_WhenFromYearAfterToYear_ShouldThrowYearsDiagnostic()
    {
        ...
        Assert.IsTrue(ex.Diagnostics.Any(d => d.Code == "BODU-CAL2-YEARS"), "BODU-CAL2-YEARS");
    }
    ...
    public void Load_WhenDocumentHasMultipleFaults_ShouldAggregateDiagnostics()
    {
        ...
        Assert.IsTrue(ex.Diagnostics.Any(d => d.Code == "BODU-CAL2-DAY"), "BODU-CAL2-DAY");
        Assert.IsTrue(ex.Diagnostics.Any(d => d.Code == "BODU-CAL2-ADJREF"), "BODU-CAL2-ADJREF");
        Assert.IsTrue(ex.Diagnostics.Any(d => d.Code == "BODU-CAL2-DUP-RULE"), "BODU-CAL2-DUP-RULE");
    }
}
