...
public static class NotableDateResourceLoader
{
        ...
        ICollection<NotableDateValidationDiagnostic> diagnostics)
    {
        ...
        foreach (NotableDateImport import in document.Imports)
        {
            ...
            {
                AddError(diagnostics, "BODU-CAL2-IMPORT-CYCLE", Calendar2ResourceStrings.Validation_ImportCycle, import.Resource);
                continue;
            }
            ...
            if (content is null)
            {
                AddError(diagnostics, "BODU-CAL2-IMPORT-MISSING", Calendar2ResourceStrings.Validation_ImportResourceNotFound, import.Resource);
        ...
        ICollection<NotableDateValidationDiagnostic> diagnostics)
    {
        ...
        foreach (NotableDateImportUse use in import.Uses)
        {
            ...
            if (concept is null)
            {
                AddError(diagnostics, "BODU-CAL2-IMPORT-CONCEPT", Calendar2ResourceStrings.Validation_ImportConceptNotFound, import.Resource, use.NotableDateRef);
                continue;
            }
