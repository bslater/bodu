// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NotableDateResolutionAdjustmentProcessorTests.cs" company="Bodu Pty. Ltd.">
...
public sealed class NotableDateResolutionAdjustmentProcessorTests
{
    ...
    public void Ctor_WhenWeekendDefinitionIsUndefined_ShouldThrowExactly()
    {
        ...
        {
            _ = new NotableDateResolutionAdjustmentProcessor((WorkingDaysOfWeek)999);
        });

        Assert.AreEqual("workingWeek", ex.ParamName);
    }
