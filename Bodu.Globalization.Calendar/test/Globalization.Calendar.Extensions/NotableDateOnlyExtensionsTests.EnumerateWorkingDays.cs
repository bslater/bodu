// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NotableDateOnlyExtensionsTests.EnumerateWorkingDays.cs" company="Bodu Pty. Ltd.">
...
public partial class NotableDateOnlyExtensionsTests
{
    ...
    /// </summary>
    [TestMethod]
    public void EnumerateWorkingDays_WhenServiceIsNull_ShouldThrowExactly()
    {
    ...
    public void EnumerateWorkingDays_WhenSingleDayRange_ShouldYieldExpectedCount(DateOnly day, int expected)
    {
        ...
        var actual = day.EnumerateWorkingDays(day, service).Count();
