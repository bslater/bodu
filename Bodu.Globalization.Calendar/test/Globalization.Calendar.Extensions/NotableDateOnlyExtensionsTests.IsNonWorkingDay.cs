// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NotableDateOnlyExtensionsTests.IsNonWorkingDay.cs" company="Bodu Pty. Ltd.">
...
public partial class NotableDateOnlyExtensionsTests
{
    ...
    public void IsNonWorkingDay_WhenWeekdayWithNoMatchingRule_ShouldReturnFalse()
    {
        ...
        var result = new DateOnly(2026, 1, 6).IsNonWorkingDay(service);
    ...
    public void IsNonWorkingDay_WhenSaturday_ShouldReturnTrue()
    {
        ...
        var result = new DateOnly(2026, 1, 3).IsNonWorkingDay(service);
    ...
    public void IsNonWorkingDay_WhenWeekdayMatchesNonWorkingRule_ShouldReturnTrue()
    {
        ...
        var result = new DateOnly(2026, 1, 1).IsNonWorkingDay(service);
    ...
    public void IsNonWorkingDay_WhenUsingAmbientService_ShouldDelegateToDefaultContext()
    {
        ...
        try
        {
            ...
            var result = new DateOnly(2026, 7, 14).IsNonWorkingDay();
    ...
    /// </summary>
    [TestMethod]
    public void IsNonWorkingDay_WhenServiceIsNull_ShouldThrowExactly()
    {
