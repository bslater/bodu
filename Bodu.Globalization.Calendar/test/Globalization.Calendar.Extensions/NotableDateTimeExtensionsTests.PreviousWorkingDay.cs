// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NotableDateTimeExtensionsTests.PreviousWorkingDay.cs" company="Bodu Pty. Ltd.">
...
public partial class NotableDateTimeExtensionsTests
{
    ...
    {
        NotableDateService service = BuildService();
        var input = new DateTime(2026, 1, 6, 9, 15, 30, DateTimeKind.Local);
    ...
    /// </summary>
    [TestMethod]
    public void PreviousWorkingDay_WhenServiceIsNull_ShouldThrowExactly()
    {
    ...
    /// </summary>
    [TestMethod]
    public void PreviousWorkingDay_WhenCountIsNegative_ShouldThrowExactly()
    {
        NotableDateService service = BuildService();
    ...
    /// </summary>
    [TestMethod]
    public void PreviousWorkingDay_WhenRetreatPastMinValue_ShouldThrowExactly()
    {
        NotableDateService service = BuildService();
