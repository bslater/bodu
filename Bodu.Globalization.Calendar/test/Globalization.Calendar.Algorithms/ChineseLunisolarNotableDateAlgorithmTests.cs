// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ChineseLunisolarNotableDateAlgorithmTests.cs" company="PlaceholderCompany">
...
/// <summary>
/// Verifies the correctness and boundary behaviour of <see cref="ChineseLunisolarNotableDateAlgorithm" />.
/// </summary>
[TestClass]
public sealed class ChineseLunisolarNotableDateAlgorithmTests
{
	/// <summary>
	...
	public void Constructor_WhenLunarMonthOutOfRange_ShouldThrowArgumentOutOfRangeException(int lunarMonth)
	{
		...
		{
			_ = new ChineseLunisolarNotableDateAlgorithm(lunarMonth, 1);
		});
	...
	public void Constructor_WhenLunarDayOutOfRange_ShouldThrowArgumentOutOfRangeException(int lunarDay)
	{
		var ex = Assert.ThrowsExactly<ArgumentOutOfRangeException>(() =>
		{
			_ = new ChineseLunisolarNotableDateAlgorithm(1, lunarDay);
		});
	...
	{
		var sut = new ChineseLunisolarNotableDateAlgorithm(5, 5);
	...
	{
		var sut = new ChineseLunisolarNotableDateAlgorithm(1, 15);
	...
	{
		var sut = new ChineseLunisolarNotableDateAlgorithm(8, 15);
	...
	{
		var sut = new ChineseLunisolarNotableDateAlgorithm(9, 9);
