// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IslamicNotableDateAlgorithmTests.cs" company="PlaceholderCompany">
...
/// <summary>
/// Verifies the correctness and boundary behaviour of <see cref="IslamicNotableDateAlgorithm" />.
/// </summary>
[TestClass]
public sealed class IslamicNotableDateAlgorithmTests
{
	/// <summary>
	...
	public void Constructor_WhenHijriMonthOutOfRange_ShouldThrowArgumentOutOfRangeException(int hijriMonth)
	{
		...
		{
			_ = new IslamicNotableDateAlgorithm(hijriMonth, 1);
		});
	...
	public void Constructor_WhenHijriDayOutOfRange_ShouldThrowArgumentOutOfRangeException(int hijriDay)
	{
		var ex = Assert.ThrowsExactly<ArgumentOutOfRangeException>(() =>
		{
			_ = new IslamicNotableDateAlgorithm(1, hijriDay);
		});
	...
	{
		var sut = new IslamicNotableDateAlgorithm(1, 1);
	...
	{
		var sut = new IslamicNotableDateAlgorithm(10, 1);
	...
	{
		var sut = new IslamicNotableDateAlgorithm(12, 10);
	...
	{
		var sut = new IslamicNotableDateAlgorithm(9, 1);
