...
/// <summary>
/// Marks a notable-date plugin that contributes one or more named <see cref="INotableDateAlgorithm" /> registrations to the
...
/// <see cref="INotableDateAlgorithmRegistry" /> and becomes reachable from any rule whose <see cref="NotableDateRule.Strategy" />
