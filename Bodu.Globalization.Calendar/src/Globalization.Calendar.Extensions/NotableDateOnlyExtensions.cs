...
/// <see cref="System.DateOnly" /> structure with calculations that delegate to an <see cref="INotableDateService" />,
...
/// </para>
/// <para>
/// Day-stepping inside walk and counting members is performed in calendar-day units. <see cref="DateOnly" /> values are
/// bridged to <see cref="DateTime" /> at <see cref="System.TimeOnly.MinValue" /> when calling into the service so that
/// rule-resolution semantics match those of the <c>NotableDateTimeExtensions</c> overloads. Time-of-day information is
/// therefore ignored.
/// </para>
/// <para>
