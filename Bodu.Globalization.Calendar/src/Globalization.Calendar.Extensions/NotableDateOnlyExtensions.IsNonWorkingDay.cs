...
{
    /// <summary>
    /// Returns an indication whether the specified <see cref="DateOnly" /> is a non-working day according to the
    ...
    /// <param name="calendarType">An optional calendar scope forwarded to the service for rule resolution.</param>
    /// <returns>
    /// <see langword="true" /> when <paramref name="date" />'s day-of-week is not selected in
    ...
    /// <param name="calendarType">An optional calendar scope forwarded to the service for rule resolution.</param>
    /// <returns>
    /// <see langword="true" /> when <paramref name="date" /> is not in the working week or is covered by a non-working
    /// notable date; otherwise, <see langword="false" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="service" /> is <see langword="null" />.
    /// </exception>
