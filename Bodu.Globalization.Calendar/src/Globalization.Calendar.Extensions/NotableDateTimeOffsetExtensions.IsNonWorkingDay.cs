...
{
    /// <summary>
    /// Determines whether the civil date of <paramref name="instant" /> in <paramref name="timeZone" /> is a
    /// non-working day under the supplied <paramref name="workingWeek" /> composed with the holiday catalogue.
    /// </summary>
    ...
    /// <returns>
    /// <see langword="true" /> when the civil date is non-working in <paramref name="timeZone" />; otherwise,
    /// <see langword="false" />.
    /// </returns>
