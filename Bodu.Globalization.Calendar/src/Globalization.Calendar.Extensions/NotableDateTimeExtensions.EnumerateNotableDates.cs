// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NotableDateTimeExtensions.EnumerateNotableDates.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Returns every <see cref="NotableDate" /> intersecting the inclusive range delimited by
    /// <paramref name="startDate" /> and <paramref name="endDate" />, evaluated against the ambient
    ...
    /// <summary>
    /// Returns every <see cref="NotableDate" /> matching the supplied <paramref name="filter" /> intersecting the
    /// inclusive range delimited by <paramref name="startDate" /> and <paramref name="endDate" />, evaluated against
    ...
    /// <summary>
    /// Returns every <see cref="NotableDate" /> intersecting the inclusive range delimited by
    /// <paramref name="startDate" /> and <paramref name="endDate" />, evaluated against the supplied
