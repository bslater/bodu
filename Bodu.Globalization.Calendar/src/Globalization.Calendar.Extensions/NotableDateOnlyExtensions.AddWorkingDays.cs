...
public static partial class NotableDateOnlyExtensions
{
    ...
    /// number of working days specified in <paramref name="days" />, evaluated against the ambient
    ...
    /// <paramref name="days" /> is zero, a fresh copy of <paramref name="date" /> is returned.
    /// </returns>
    /// <exception cref="ArgumentOutOfRangeException">
    /// Thrown when applying <paramref name="days" /> would overrun <see cref="DateOnly.MaxValue" /> or underrun
    ...
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> obtained by advancing or retreating <paramref name="date" /> by the signed
    /// number of working days specified in <paramref name="days" />, evaluated against the supplied
    ...
    /// </exception>
    /// <exception cref="ArgumentOutOfRangeException">
    /// Thrown when <paramref name="workingWeek" /> is <see cref="WeekPattern.Empty" /> or when applying
    /// <paramref name="days" /> would overrun the <see cref="DateOnly" /> range.
    /// </exception>
    ...
    /// <summary>
    /// Returns a new <see cref="DateOnly" /> obtained by advancing or retreating <paramref name="date" /> by the signed
    /// number of working days specified in <paramref name="days" />, under the supplied named
