...
public static partial class NotableDateTimeExtensions
{
    ...
    /// <remarks>
    /// <para>
    /// The range is interpreted using the date components of the supplied values; time-of-day information is ignored.
    /// When <paramref name="endDate" /> precedes <paramref name="startDate" /> the boundaries are swapped before
    /// counting so the result is always non-negative.
    /// </para>
    /// </remarks>
