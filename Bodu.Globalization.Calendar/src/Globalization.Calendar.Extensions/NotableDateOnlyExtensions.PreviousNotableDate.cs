...
public static partial class NotableDateOnlyExtensions
{
    ...
    /// <paramref name="date" />, evaluated against the ambient <see cref="NotableDateContext.Default" /> service.
    /// </summary>
    ...
    /// date falls strictly before <paramref name="date" />, evaluated against the ambient
    ...
    /// <summary>
    /// Returns the most recent <see cref="NotableDate" /> whose anchor date falls strictly before
    /// <paramref name="date" />, evaluated against the supplied <see cref="INotableDateService" />.
    /// </summary>
    /// <param name="date">The reference date.</param>
    /// <param name="service">
    ...
    /// <summary>
    /// Returns the most recent <see cref="NotableDate" /> matching the supplied <paramref name="filter" /> whose anchor
    /// date falls strictly before <paramref name="date" />, evaluated against the supplied
