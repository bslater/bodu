...
{
    /// <summary>
    /// Returns the most recent <see cref="NotableDate" /> whose anchor date falls strictly before
    /// <paramref name="dateTime" />, evaluated against the ambient <see cref="NotableDateContext.Default" /> service.
    /// </summary>
    ...
    /// <returns>
    /// The latest matching <see cref="NotableDate" />, or <see langword="null" /> when none is found after
    ...
    /// <summary>
    /// Returns the most recent <see cref="NotableDate" /> matching the supplied <paramref name="filter" /> whose anchor
    /// date falls strictly before <paramref name="dateTime" />, evaluated against the ambient
    ...
    /// <param name="calendarType">An optional calendar scope forwarded to the service for rule resolution.</param>
    /// <returns>
    /// The latest matching <see cref="NotableDate" />, or <see langword="null" /> when none is found.
    /// </returns>
    ...
    /// <summary>
    /// Returns the most recent <see cref="NotableDate" /> whose anchor date falls strictly before
    /// <paramref name="dateTime" />, evaluated against the supplied <see cref="INotableDateService" />.
    /// </summary>
    /// <param name="dateTime">The reference date.</param>
    /// <param name="service">
    ...
    /// <remarks>
    /// <para>
    /// The search walks each preceding year from <c>dateTime.Year</c> down to <see cref="DateTime.MinValue" />.
    /// <see cref="DateTime.Year" />, inspecting each year's resolved notable dates in reverse chronological order. The
    /// first date whose <see cref="NotableDate.Date" /> is strictly before <paramref name="dateTime" />.
    ...
    /// <summary>
    /// Returns the most recent <see cref="NotableDate" /> matching the supplied <paramref name="filter" /> whose anchor
    /// date falls strictly before <paramref name="dateTime" />, evaluated against the supplied
