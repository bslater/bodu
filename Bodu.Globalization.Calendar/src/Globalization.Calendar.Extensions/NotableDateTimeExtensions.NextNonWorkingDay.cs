// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NotableDateTimeExtensions.NextNonWorkingDay.cs" company="Bodu Pty. Ltd.">
...
public static partial class NotableDateTimeExtensions
{
    ...
    /// non-working days strictly after the supplied <paramref name="dateTime" />, evaluated against the ambient
    ...
    /// <summary>
    /// Returns a new <see cref="DateTime" /> representing the non-working day that is <paramref name="count" />
    /// non-working days strictly after the supplied <paramref name="dateTime" />, evaluated against the supplied
