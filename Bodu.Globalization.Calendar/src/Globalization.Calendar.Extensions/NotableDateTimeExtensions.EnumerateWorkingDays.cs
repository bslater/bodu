// ---------------------------------------------------------------------------------------------------------------
// <copyright file="NotableDateTimeExtensions.EnumerateWorkingDays.cs" company="Bodu Pty. Ltd.">
...
public static partial class NotableDateTimeExtensions
{
    ...
    /// <returns>
    /// An ascending sequence of <see cref="DateTime" /> values, each anchored at midnight of a working day.
    /// </returns>
    ...
    /// <see cref="EnumerateWorkingDays(DateTime, DateTime, INotableDateService, string?, Type?)" />.
    /// </summary>
