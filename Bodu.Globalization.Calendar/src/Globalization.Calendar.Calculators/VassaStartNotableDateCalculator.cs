// ---------------------------------------------------------------------------------------------------------------
// <copyright file="VassaStartNotableDateCalculator.cs" company="PlaceholderCompany">
...
/// <summary>
/// Provides a calculator for determining the Gregorian date on which Vassa (the Buddhist Rains Retreat) begins.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// This calculator delegates to <see cref="AsalhaPujaNotableDateCalculator" /> and adds one calendar day to obtain the Vassa start
/// date. The result is the first day after the Asalha Puja full moon, which in Thailand is a public holiday (Khao Phansa).
/// </para>
/// </remarks>
public sealed class VassaStartNotableDateCalculator
	: INotableDateCalculator
{
	private readonly AsalhaPujaNotableDateCalculator _asalhaPuja = new AsalhaPujaNotableDateCalculator();
