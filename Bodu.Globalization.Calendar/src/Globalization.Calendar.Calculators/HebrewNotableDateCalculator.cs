// ---------------------------------------------------------------------------------------------------------------
// <copyright file="HebrewNotableDateCalculator.cs" company="PlaceholderCompany">
...
/// <summary>
/// Provides a calculator for determining the Gregorian date of an observance defined by a fixed month and day in the Hebrew
...
/// later months to shift by one in leap years. This calculator accepts stable <see cref="HebrewMonth" /> values and resolves them to
...
/// </para>
/// <para>
/// Because the Hebrew year begins in September or October, a single Gregorian year spans parts of two Hebrew years. The calculator
/// tries both Hebrew years that overlap the requested Gregorian year and returns the first match.
/// </para>
/// </remarks>
public sealed class HebrewNotableDateCalculator
	: INotableDateCalculator
{
	...
	/// <summary>
	/// Initialises a new instance of the <see cref="HebrewNotableDateCalculator" /> class for the given Hebrew month and day.
	/// </summary>
	...
	public HebrewNotableDateCalculator(HebrewMonth month, int day)
	{
