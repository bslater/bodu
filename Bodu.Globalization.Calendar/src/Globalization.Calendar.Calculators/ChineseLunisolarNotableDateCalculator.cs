// ---------------------------------------------------------------------------------------------------------------
// <copyright file="ChineseLunisolarNotableDateCalculator.cs" company="PlaceholderCompany">
...
/// <summary>
/// Provides a calculator for determining the Gregorian date of a festival defined by a fixed month and day in the Chinese lunisolar
/// calendar.
/// </summary>
/// <remarks>
/// <para>
...
/// calendar. This calculator converts a given (lunarMonth, lunarDay) pair into the corresponding Gregorian date for a specified year
...
/// </para>
/// </remarks>
public sealed class ChineseLunisolarNotableDateCalculator
	: INotableDateCalculator
{
	...
	/// <summary>
	/// Initialises a new instance of the <see cref="ChineseLunisolarNotableDateCalculator" /> class for the given lunar month and day.
	/// </summary>
	...
	/// than 30.
	/// </exception>
	public ChineseLunisolarNotableDateCalculator(int lunarMonth, int lunarDay)
	{
