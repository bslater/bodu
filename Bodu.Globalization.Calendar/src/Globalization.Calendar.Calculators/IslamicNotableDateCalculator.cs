// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IslamicNotableDateCalculator.cs" company="PlaceholderCompany">
...
/// <summary>
/// Provides a calculator for determining the Gregorian date of an observance defined by a fixed month and day in the Islamic Hijri
/// calendar.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// This calculator uses <see cref="SysGlobal.HijriCalendar" />, which implements the tabular (algorithmic) Islamic calendar rather
...
/// </para>
/// </remarks>
public sealed class IslamicNotableDateCalculator
	: INotableDateCalculator
{
	...
	/// <summary>
	/// Initialises a new instance of the <see cref="IslamicNotableDateCalculator" /> class for the given Hijri month and day.
	/// </summary>
	...
	/// than 30.
	/// </exception>
	public IslamicNotableDateCalculator(int hijriMonth, int hijriDay)
	{
