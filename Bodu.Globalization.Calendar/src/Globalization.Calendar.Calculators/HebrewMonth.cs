...
/// <see cref="HebrewNotableDateCalculator" /> resolves them to the correct <see cref="System.Globalization.HebrewCalendar" /> month
/// number at runtime.
/// </para>
/// <para>
...
public enum HebrewMonth
{
	...
	/// <see cref="HebrewNotableDateCalculator.GetDate" /> to return <see langword="null" />.
	/// </summary>
	AdarII = 7,
