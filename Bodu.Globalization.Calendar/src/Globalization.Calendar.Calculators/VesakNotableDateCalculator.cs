// ---------------------------------------------------------------------------------------------------------------
// <copyright file="VesakNotableDateCalculator.cs" company="PlaceholderCompany">
...
/// <summary>
/// Provides a calculator for determining the Gregorian date of Vesak (Buddha Day) for a given year.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// This calculator returns the first full moon that falls on or after 1 May of the given year. This matches the Thai Visakha Bucha
...
/// Sri Lanka, Myanmar, and some other countries use slightly different rules; this calculator does not attempt to replicate them.
/// </para>
/// <para>
/// The full moon date is computed using the Meeus Chapter 49 algorithm via <see cref="LunarPhaseCalculator" />, accurate to within
/// one calendar day for years in the range 1900–2100.
/// </para>
/// </remarks>
public sealed class VesakNotableDateCalculator
	: INotableDateCalculator
{
	...
	public DateTime? GetDate(int year, SysGlobal.Calendar? calendar = null)
	{
		...
		DateTime? fullMoon = LunarPhaseCalculator.GetFullMoonOnOrAfter(new DateTime(year, 5, 1));
		if (fullMoon is null)
			return null;
