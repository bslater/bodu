// ---------------------------------------------------------------------------------------------------------------
// <copyright file="LosarNotableDateCalculator.cs" company="PlaceholderCompany">
...
/// <summary>
/// Provides a calculator for determining the approximate Gregorian date of Losar (Tibetan New Year) for a given year.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// <strong>Accuracy note:</strong> This calculator uses the first new moon on or after 20 January of the given year as an
...
/// irregularly, roughly every three to five years — this calculator may return a date that is approximately one month earlier than
...
/// </para>
/// <para>
/// The new moon date is computed using the Meeus Chapter 49 algorithm via <see cref="LunarPhaseCalculator" />, accurate to within
/// one calendar day for years in the range 1900–2100.
/// </para>
/// </remarks>
public sealed class LosarNotableDateCalculator
	: INotableDateCalculator
{
	...
	public DateTime? GetDate(int year, SysGlobal.Calendar? calendar = null)
	{
		...
		DateTime? newMoon = LunarPhaseCalculator.GetNewMoonOnOrAfter(new DateTime(year, 1, 20));
		if (newMoon is null)
			return null;
