// ---------------------------------------------------------------------------------------------------------------
// <copyright file="CalculationAnchorCacheKey.cs" company="PlaceholderCompany">
...
/// The name of the rule that provides the calculation anchor.
/// </param>
/// <param name="Year">
/// The civil year for which the calculation anchor was resolved.
/// </param>
/// <remarks>
/// <para>
