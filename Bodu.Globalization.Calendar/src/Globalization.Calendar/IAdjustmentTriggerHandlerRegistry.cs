// ---------------------------------------------------------------------------------------------------------------
// <copyright file="IAdjustmentTriggerHandlerRegistry.cs" company="Bodu Pty. Ltd.">
...
/// <summary>
/// Provides lookup of custom <see cref="IAdjustmentTriggerHandler" /> implementations by handler key, binding the
/// <see cref="AdjustmentTrigger.Custom" /> trigger to caller-supplied logic.
/// </summary>
public interface IAdjustmentTriggerHandlerRegistry
{
    /// <summary>
    ...
    bool TryGet(string key, out IAdjustmentTriggerHandler? handler);
}
