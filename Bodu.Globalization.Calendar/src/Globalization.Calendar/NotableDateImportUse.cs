...
/// <param name="As">
/// An identifier to rename the imported concept to, or <see langword="null" /> to keep its identifier.
/// </param>
/// <param name="Territory">
/// A territory to assign to every rule of the imported concept, or <see langword="null" /> to keep theirs.
/// </param>
/// <param name="Category">
/// A category to override the imported concept with, or <see langword="null" /> to keep its category.
/// </param>
