...
internal sealed class NotableDateRuleResolver
{
    ...
    /// <summary>
    /// Resolves a <see cref="DateResolutionStrategy.Fixed" /> rule against a calendar whose year boundaries do not
    /// align with the Gregorian year by checking both calendar years that overlap the requested Gregorian year.
    /// </summary>
    /// <param name="rule">The rule to resolve.</param>
    /// <param name="year">The Gregorian year.</param>
    /// <param name="cal">
    /// The calendar instance (typically <see cref="System.Globalization.HijriCalendar" /> or
    /// <see cref="System.Globalization.HebrewCalendar" />).
    /// </param>
    /// <param name="day">The day of month in the target calendar.</param>
    /// <returns>
    /// The first matching Gregorian date within the requested year, or <see langword="null" /> if none falls in that
    /// year.
    /// </returns>
