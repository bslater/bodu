...
public sealed record NotableDateRuleOverrideBody
{
    ...
    /// </remarks>
    /// <returns>The replacement notable date title, or <see langword="null" /> to inherit <see cref="NotableDateRule.Name" />.</returns>
    ...
    /// </summary>
    /// <returns>The replacement <see cref="NotableDateCategory" />, or <see langword="null" /> to inherit the source value.</returns>
    public NotableDateCategory? Category { get; init; }

    /// <summary>
    /// Gets the override for <see cref="NotableDateRule.TerritoryCode" />.
    /// </summary>
    /// <returns>The replacement comma-separated territory list, or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>The replacement civil year lower bound, or <see langword="null" /> to inherit the source value.</returns>
    public int? FirstYear { get; init; }

    /// <summary>
    /// Gets the override for <see cref="NotableDateRule.LastYear" />.
    /// </summary>
    /// <returns>The replacement civil year upper bound, or <see langword="null" /> to inherit the source value.</returns>
    public int? LastYear { get; init; }

    /// <summary>
    /// Gets the override for <see cref="NotableDateRule.OccurrenceYears" />.
    /// </summary>
    /// <returns>The replacement recurrence cadence in years, or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>The replacement integer priority (lower wins), or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>The replacement calendar <see cref="Type" />, or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>One of the defined <see cref="DateResolutionStrategy" /> values, or <see langword="null" /> to inherit.</returns>
    ...
    /// </summary>
    /// <returns>A month number in the range <c>1</c>..<c>12</c>, or <see langword="null" /> to inherit the source value.</returns>
    public int? Month { get; init; }

    /// <summary>
    /// Gets the day-of-month used by <see cref="DateResolutionStrategy.Fixed" />.
    /// </summary>
    /// <returns>A day-of-month in the range <c>1</c>..<c>31</c>, or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>A <see cref="System.DayOfWeek" /> value, or <see langword="null" /> to inherit the source value.</returns>
    public DayOfWeek? DayOfWeek { get; init; }

    /// <summary>
    /// Gets the week ordinal used by <see cref="DateResolutionStrategy.DayOfWeekInMonth" />.
    /// </summary>
    /// <returns>One of the defined <see cref="WeekOfMonthOrdinal" /> values, or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>The anchor rule's <see cref="NotableDateRule.Name" />, or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>The replacement algorithm registry key, or <see langword="null" /> to inherit the source value.</returns>
    public string? AlgorithmKey { get; init; }

    /// <summary>
    /// Gets the algorithm CLR type used by <see cref="DateResolutionStrategy.Algorithm" />.
    /// </summary>
    /// <returns>The replacement algorithm <see cref="Type" />, or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>The replacement month token forwarded to the algorithm constructor, or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>The replacement day-of-month forwarded to the algorithm constructor, or <see langword="null" /> to inherit the source value.</returns>
    ...
    /// </summary>
    /// <returns>An immutable array of additive tag values. Empty when no override tags are authored; never <see langword="default" />.</returns>
    ...
    /// </summary>
    /// <returns>An immutable array of <see cref="ObservanceAdjustment" /> entries merged into the inherited list. Empty when no override adjustments are authored.</returns>
