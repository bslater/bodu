...
public sealed record NotableDate
{
	...
	/// </summary>
	/// <returns>The final <see cref="DateTime" /> of the span. Equal to <see cref="Date" /> for single-day occurrences.</returns>
	...
	/// </summary>
	/// <returns>An <see cref="AdjustmentReason" /> describing the shift, or <see langword="null" /> when the occurrence was not adjusted.</returns>
	...
	/// </summary>
	/// <returns><see langword="true" /> when an adjustment fired and produced this occurrence; otherwise <see langword="false" />.</returns>
	...
	/// </summary>
	/// <returns><see langword="true" /> when the resolved occurrence is non-working; otherwise <see langword="false" />.</returns>
	...
	/// </summary>
	/// <returns>The CLR <see cref="Type" /> of the associated calendar, or <see langword="null" /> when the occurrence is calendar-agnostic.</returns>
	...
	/// global.
	/// </summary>
	/// <returns>The ISO 3166-style territory code, or <see langword="null" /> when the occurrence applies globally.</returns>
	...
	/// </summary>
	/// <returns>An immutable hash set of tag values. Empty when the originating rule carries none; never <see langword="null" />.</returns>
	...
	/// </summary>
	/// <returns>The free-form comment text, or <see langword="null" /> when the originating rule did not author one.</returns>
