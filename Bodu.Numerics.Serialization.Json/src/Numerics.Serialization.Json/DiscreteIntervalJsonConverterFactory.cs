// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DiscreteIntervalJsonConverterFactory.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>The policy passed to every <see cref="DiscreteIntervalJsonConverter{T}" /> produced by this factory.</summary>
    private readonly NumericsJsonPolicy _policy;

    /// <summary>
    /// Initializes a new instance of the <see cref="DiscreteIntervalJsonConverterFactory" /> class configured for the
    /// <see cref="NumericsJsonPolicy.Strict" /> shape.
    /// </summary>
    public DiscreteIntervalJsonConverterFactory()
    ...
    /// </exception>
    public DiscreteIntervalJsonConverterFactory(NumericsJsonPolicy policy)
    {
    ...
    public override bool CanConvert(Type typeToConvert) =>
        ...
        && typeToConvert.GetGenericTypeDefinition() == typeof(DiscreteInterval<>);

    /// <summary>
    /// Creates a converter for the specified closed <see cref="DiscreteInterval{T}" /> type.
    /// </summary>
    /// <param name="typeToConvert">The closed <see cref="DiscreteInterval{T}" /> type to convert.</param>
    ...
    public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        Type converterType = typeof(DiscreteIntervalJsonConverter<>).MakeGenericType(componentType);
