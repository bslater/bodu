    ...
    : IList<FormatConverter>
{
    ...
    internal ConverterList(FormatOptions owner) =>
        _owner = owner;
    ...
    /// </exception>
    /// <exception cref="InvalidOperationException">Thrown when the owning options are read-only.</exception>
    public void Add(FormatConverter item)
    {
        _owner.VerifyMutable();
    ...
    public void CopyTo(FormatConverter[] array, int arrayIndex) =>
    ...
    public IEnumerator<FormatConverter> GetEnumerator() =>
    ...
    public int IndexOf(FormatConverter item) =>
        _items.IndexOf(item);
    ...
    /// </exception>
    /// <exception cref="InvalidOperationException">Thrown when the owning options are read-only.</exception>
    public void Insert(int index, FormatConverter item)
    {
        _owner.VerifyMutable();
        ThrowHelper.ThrowIfNull(item);
    ...
    /// <exception cref="InvalidOperationException">Thrown when the owning options are read-only.</exception>
    public bool Remove(FormatConverter item)
    {
        _owner.VerifyMutable();
