// ---------------------------------------------------------------------------------------------------------------
// <copyright file="PropertyOrderAttribute.cs" company="Bodu Pty. Ltd.">
...
/// and otherwise keep their declaration order. When the target format re-sorts entries into a canonical order, this
/// order governs the sequence in which members are presented to the writer rather than the final on-the-wire order.
/// </remarks>
/// <example>
...
/// }
///
/// // Version is presented to the writer before Name.
///]]>
/// </code>
/// </example>
[AttributeUsage(AttributeTargets.Property | AttributeTargets.Field, AllowMultiple = false, Inherited = true)]
public sealed class PropertyOrderAttribute
