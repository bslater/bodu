...
/// <summary>
/// Represents one rule from libical's recurrence test corpus, pairing it with the occurrence count that reference
/// implementation asserts for it.
/// </summary>
...
/// <param name="ExceptionDate">
/// The single exception date the block excludes, or <see langword="null" /> for none.
/// </param>
/// <param name="Flags">The space-separated scope flags recorded in the corpus.</param>
/// <remarks>
/// A count is a weaker oracle than a date list, but it is the one that catches the two defects that matter most in an
/// occurrence engine: emitting an instant twice, and dropping one.
/// </remarks>
