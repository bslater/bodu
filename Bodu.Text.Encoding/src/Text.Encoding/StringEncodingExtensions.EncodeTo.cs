// ---------------------------------------------------------------------------------------------------------------
// <copyright file="StringEncodingExtensions.EncodeTo.cs" company="Bodu Pty. Ltd.">
...
{
    /// <summary>
    /// Encodes <paramref name="text" /> into <paramref name="destination" /> using <paramref name="encoding" /> and
