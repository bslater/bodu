// ---------------------------------------------------------------------------------------------------------------
// <copyright file="Base64.BufferWriter.cs" company="PlaceholderCompany">
...
public static partial class Base64
{
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="options" /> contains an unsupported flag.</exception>
    ...
    /// <summary>
    /// Encodes <paramref name="source" /> as UTF-8 Base64 bytes into <paramref name="writer" />, suitable for use in
    /// pipelines and other <see cref="IBufferWriter{T}" />-based scenarios.
    /// </summary>
    /// <param name="source">The bytes to encode.</param>
