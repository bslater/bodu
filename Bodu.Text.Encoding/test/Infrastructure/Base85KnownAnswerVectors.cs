...
public static class Base85KnownAnswerVectors
{
    ...
    {
        yield return new object[] { EncodingKnownAnswerVector.FromHex("Empty input", "", "", "Adobe Ascii85") };
    ...
    {
        yield return new object[] { EncodingKnownAnswerVector.FromHex("Empty input", "", "", "RFC 32 (ZeroMQ Z85)") };
