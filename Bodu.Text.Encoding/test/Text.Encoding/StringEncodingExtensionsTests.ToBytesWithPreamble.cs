// ---------------------------------------------------------------------------------------------------------------
// <copyright file="StringEncodingExtensionsTests.ToBytesWithPreamble.cs" company="PlaceholderCompany">
...
public sealed partial class StringEncodingExtensionsTests
{
    ...
    /// </summary>
    [TestMethod]
    public void ToBytesWithPreamble_WhenTextIsNull_ShouldThrowArgumentNullException()
    {
    ...
    /// </summary>
    [TestMethod]
    public void ToBytesWithPreamble_WhenEncodingIsNull_ShouldThrowArgumentNullException()
    {
        ArgumentNullException ex = Assert.ThrowsExactly<ArgumentNullException>(() =>
        {
