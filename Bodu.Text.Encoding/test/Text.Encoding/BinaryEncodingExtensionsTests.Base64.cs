// ---------------------------------------------------------------------------------------------------------------
// <copyright file="BinaryEncodingExtensionsTests.Base64.cs" company="PlaceholderCompany">
...
public sealed partial class BinaryEncodingExtensionsTests
{
    ...
    {
        var actual = ((ReadOnlySpan<byte>)Payload).GetBase64EncodedLength();
    ...
    public void TryEncodeBase64ToUtf8_WhenDestinationFits_ShouldWriteUtf8BytesEqualToBase64String()
    {
        ...
        var ok = ((ReadOnlySpan<byte>)Payload).TryEncodeBase64ToUtf8(destination, out var written);

        Assert.IsTrue(ok);
        var asAscii = System.Text.Encoding.ASCII.GetString(destination.Slice(0, written));
    ...
    public void TryEncodeBase64ToUtf8_WhenDestinationIsTooSmall_ShouldReturnFalse()
    {
        ...
        var ok = ((ReadOnlySpan<byte>)Payload).TryEncodeBase64ToUtf8(backing, out var written);
    ...
    {
        var utf8 = System.Text.Encoding.ASCII.GetBytes(Convert.ToBase64String(Payload));
        Span<byte> destination = new byte[Payload.Length];

        var ok = ((ReadOnlySpan<byte>)utf8).TryDecodeBase64FromUtf8(destination, out var written);
    ...
    public void TryDecodeBase64FromUtf8_WhenDestinationIsTooSmall_ShouldReturnFalse()
    {
        ...
        var ok = ((ReadOnlySpan<byte>)utf8).TryDecodeBase64FromUtf8(backing, out var written);
    ...
    {
        var actual = ((ReadOnlySpan<byte>)Payload).ToBase64UrlString();
    ...
    public void TryEncodeBase64UrlToUtf8_WhenDestinationFits_ShouldWriteUtf8BytesEqualToCanonicalEncoder()
    {
        ...
        var ok = ((ReadOnlySpan<byte>)Payload).TryEncodeBase64UrlToUtf8(destination, out var written);
    ...
    public void TryEncodeBase64UrlToUtf8_WhenDestinationIsTooSmall_ShouldReturnFalse()
    {
        ...
        var ok = ((ReadOnlySpan<byte>)Payload).TryEncodeBase64UrlToUtf8(backing, out var written);
    ...
    public void TryDecodeBase64UrlFromUtf8_WhenInputIsValid_ShouldRoundTrip()
    {
        ...
        var ok = ((ReadOnlySpan<byte>)utf8).TryDecodeBase64UrlFromUtf8(destination, out var written);
    ...
    public void TryDecodeBase64UrlFromUtf8_WhenDestinationIsTooSmall_ShouldReturnFalse()
    {
        ...
        var ok = ((ReadOnlySpan<byte>)utf8).TryDecodeBase64UrlFromUtf8(backing, out var written);
    ...
    {
        var invalid = System.Text.Encoding.ASCII.GetBytes("not^valid^base64");
        var backing = new byte[64];

        var ok = ((ReadOnlySpan<byte>)invalid).TryDecodeBase64FromUtf8(backing, out var written);
